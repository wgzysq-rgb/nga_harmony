...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-multi-tab-practice`  |  **DocID**: `c3b19ab2a403444083696f1bbbba0b4d`  |  **NodeID**: `000201775546825968248ab474709909`
...
```
 实现导航条布局，通过offset控制中心图标与两侧图标的位置。```
@Builder
...
使用[SideBarContainer组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-sidebarcontainer#示例)实现侧边导航，并且通过设置该组件的showSideBar控制显示隐藏。在SideBarContainer实现左侧导航样式和右侧内容区。controlButton属性控制侧边导航按钮位置。```
