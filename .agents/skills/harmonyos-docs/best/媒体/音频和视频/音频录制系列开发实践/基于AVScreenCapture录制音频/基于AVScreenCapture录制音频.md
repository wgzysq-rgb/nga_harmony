...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-audio-record-base-on-avscreencapture`  |  **DocID**: `81408a1493fe453d836e477842073976`  |  **NodeID**: `0002017755469036683965667e4827ef`
...
1.在CMake脚本中链接动态库libnative_avscreen_capture.so、libnative_media_core.so等。
 ...
 target_link_libraries(entry PUBLIC libace_napi.z.so libace_ndk.z.so libjsvm.so libhilog_ndk.z.so libnative_avscreen_capture.so libuv.so libnative_media_core.so) 2.配置音频录制相关参数。
