...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-surface-encoder`  |  **DocID**: `1c8c88c7d4b24dadafb8e3dfaaa69c89`  |  **NodeID**: `000201775546903668362f66f59a41e9`
...
- 初始化视频封装器，创建并配置视频封装器。
- 初始化视频编码器，创建并配置视频编码器，从编码器中获取NativeWindow对象。从NativeWindow对象获取对应的surfaceId。
