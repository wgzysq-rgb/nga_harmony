...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-page-brightness-settings`  |  **DocID**: `9fdf7234e04544d6ba90c395390d7477`  |  **NodeID**: `0002017755468369123632a4bcde6a38`
...
返回首页，恢复屏幕默认亮度，重新进入视频播放页，恢复最后一次在视频播放页设置的亮度。
...
监听页面切换事件，进入付款码页面，设置高亮，返回首页，恢复屏幕默认亮度。
