...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-dialog-encapsulation`  |  **DocID**: `07b4325ff5a04a71bcfcc6eb19ebb0ca`  |  **NodeID**: `0002017755468196491779e93744688e`
...
提供方通过promptAction对象封装弹窗工具类的步骤如下：
