...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-multi-window-practice`  |  **DocID**: `1477224995df474aaa7ab264296ed3ea`  |  **NodeID**: `000201775546863906648020c342fd51`
...
```
 preferMultiWindowOrientation属性主要标识当前UIAbility多窗布局方向，具体可以参考[声明支持悬浮窗](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/multi-window-support#section14646185913211)中关于preferMultiWindowOrientation的属性的描述**。**当设置preferMultiWindowOrientation属性为“landscape_auto”表示多窗布局动态可变为横向，需要配合API（[enableLandscapeMultiWindow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#enablelandscapemultiwindow12) / [disableLandscapeMultiWindow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#disablelandscapemultiwindow12)）使用，建议视频类应用配置，视频播放界面适配横屏悬浮窗效果图如下，具体使用可以参考：[横向悬浮窗适配问题](#section4595191593711)。
