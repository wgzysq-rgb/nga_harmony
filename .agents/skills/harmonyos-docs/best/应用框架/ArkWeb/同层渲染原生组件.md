...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-render-web-using-same-layer-render`  |  **DocID**: `18e1df4d2e104ce9bc84ad3c19c14721`  |  **NodeID**: `000201775546863906655bc3ebd26c09`
...
makeNode()方法触发后，NodeContainer组件获取到BuilderNode对象，页面出现原生组件。```
