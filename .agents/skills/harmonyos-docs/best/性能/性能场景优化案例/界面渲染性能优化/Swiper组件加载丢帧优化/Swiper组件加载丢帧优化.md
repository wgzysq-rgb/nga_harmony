...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-swiper_high_performance_development_guide`  |  **DocID**: `0025c97a46384dfab5bd1d27de93632e`  |  **NodeID**: `0002017755471118138470e5cdeb6ea4`
...
**表1 **当总题量为1000时，ForEach与LazyForEach的性能对比加载方式
...
**表2 **不同cachedCount数量下的性能数据对比缓存数量
