...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-ui-component-performance-optimization`  |  **DocID**: `a3e006f8c1cf48628a0b73f31f78df69`  |  **NodeID**: `000201775547111813838ba35226c0da`
...
**表2 **静态注册属性和动态注册属性在不同属性数量下耗时|     静态注册属性
