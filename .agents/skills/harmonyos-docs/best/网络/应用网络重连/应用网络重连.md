...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-network-reconnection`  |  **DocID**: `f48f0bbfcf8a4580ba010d2a66ead892`  |  **NodeID**: `00020177554686712769820496096ebb`
...
```
 ...
 @StorageProp('netAvailable') @Watch('onSocketUpdated') netAvailable: boolean = true; 使用@Watch监听状态变量的变化，并根据对应的变化和实际应用场景重新连接网络。
