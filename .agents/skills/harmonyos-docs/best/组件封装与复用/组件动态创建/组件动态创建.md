...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-ui-dynamic-operations`  |  **DocID**: `a42694c447f749fabf975174f2242e55`  |  **NodeID**: `000201775546785344790e3842087929`
...
更新自定义节点更新自定义节点，可参考BuilderNode的[update()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-buildernode#update)方法。
...
广告占位节点逻辑：实现占位结点AdNodeController，它继承自NodeController，其中的initAd()方法通过this.adNode.build()接口将广告组件添加到rootNode上。当NodeContainer进行绘制时，会调用makeNode()方法，将构建好的rootNode返回实现组件上树。
