...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-configure-adapts-to-harmonyos`  |  **DocID**: `e74598c52ad44afa9a8c25be7e08d14e`  |  **NodeID**: `000201775547138833512b4acecf8985`
...
- 获取三方库源码（“/mnt/e/configure”中configure表示创建的文件夹名称，用于存放三方库源码文件，开发者可自行选择创建与否）。```
