...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-fuzzy-scene-performance-optimization`  |  **DocID**: `b6f220ca8cb54c1f88d5c65850c38346`  |  **NodeID**: `000201775546908196457fc6d51e1295`
...
通过Filter图像效果类中的blur，为Image添加模糊效果。```
