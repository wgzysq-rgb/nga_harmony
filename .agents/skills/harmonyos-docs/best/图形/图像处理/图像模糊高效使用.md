...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-background-blur`  |  **DocID**: `e8f626ad39554c0995b35c5b3933967a`  |  **NodeID**: `0002017755469081964603798af952e3`
...
层次类型
 ...
 背景模糊
  ...
  通过枚举值的方式封装了不同的模糊半径、亮度、饱和度、蒙版颜色。

 适用场景：通过设置枚举值来使用系统已经封装好的效果。
 ...
 [.backgroundEffect()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-background#backgroundeffect11)
  ...
  可以自定义模糊半径、亮度、饱和度、蒙版颜色、取色方式以及灰阶参数。
