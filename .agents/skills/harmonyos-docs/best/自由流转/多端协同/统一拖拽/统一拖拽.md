...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-unified-drag-and-drop`  |  **DocID**: `aa3f5349cf7d49c9b3124efea76ee28e`  |  **NodeID**: `0002017755470344737017f3c64bfae3`
...
```
   只有监听了[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)事件，拖拽在组件范围内移动时，才会触发[onDragMove()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondragmove)事件。
...
将拖出方Image组件的[draggable()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-drag-drop#draggable)属性设置为true。```
Image($rawfile('river.png'))
  // ...
  .draggable(true)
```
 在拖出对象的[onDragStart()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondragstart)接口中，获取图像信息并将其转换成[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)。```
Image($rawfile('river.png'))
  // ...
...
```
 将图片绘制到[Canvas](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-components-canvas-canvas)画布上，并获取拖拽时间作为水印绘制到画布上的指定位置，得到添加水印的图像。```
Image($rawfile('river.png'))
  // ...
  .onDragStart((event: DragEvent) => {
    // ...
...
```
 将图像打包保存在文件中，调用[DragEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#dragevent7)的[setData()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#setdata10)接口将水印图像设置为拖拽数据。```
Image($rawfile('river.png'))
  // ...
  .onDragStart((event: DragEvent) => {
    // ...
...
```
  由于[CustomBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#custombuilder8)需要离线渲染之后才能使用，存在一定的性能开销和时延，因此推荐开发者优先使用[DragItemInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#dragiteminfo)中的[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)方式返回背板图。

  在拖出对象的[onPreDrag()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#onpredrag12)接口中，预先创建背板图。```
Image($r('app.media.mount'))
// ...
...
```
 在拖出对象的[onDragStart()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondragstart)接口中，将回调的PixelMap作为拖拽过程中的背板图。```
Image($r('app.media.mount'))
// ...
  .onDragStart(() => {
    let dragItemInfo: DragItemInfo = {
...
// ...
```
 在拖入对象的[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)接口中，调用[DragEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#dragevent7)的[getData()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#getdata10)接口获取拖拽数据。```
Column() {
  Text(this.textContent)
  // ...
}
...
```
 将拖拽数据转换成颜色数据格式为BGRA_8888的[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)类型的视觉信息。```
Column() {
  Text(this.textContent)
  // ...
}
...
```
 设置拖出方Image组件的[draggable()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-drag-drop#draggable)属性为true。```
Image('https://www-file.huawei.com/-/media/corp2020/home/banner/12/pura-x-1.jpg')
// ...
  .draggable(true)
  // ...
```
 在落入方Image组件的[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)回调中获取图片的uri，绑定到落入方组件上，触发UI刷新。```
Column() {
...
```
 在落入方Image组件的[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)回调里调用[request](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-request#导入模块)的[downloadFile()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-request#requestdownloadfile9)方法下载图片资源。```
Column() {
  Image(this.targetImage)
  // ...
}
...
设置拖出方Video组件的[draggable()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-drag-drop#draggable)属性为true。```
Video({
  ...
  .draggable(true)
    // ...
```
 在拖出视频的[onDragStart()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondragstart)回调中，将视频文件复制到沙箱目录。构造[uniformDataStruct.FileUri](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-uniformdatastruct#fileuri15)类型的数据，将oriUri设置为沙箱路径下视频文件的uri。```
Video({
  src: $rawfile('video.mp4'),
  controller: new VideoController()
})
...
```
 在拖入方Video组件的[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)回调里调用[startDataLoading()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#startdataloading15)接口获取拖拽的数据，提取uri并绑定到落入方Video组件上。同时由于设置了[datasyncoptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#datasyncoptions15)中的destUri参数，UDMF会将视频保存到本地的沙箱路径中。```
Column() {
...
```
   使用RichEditor组件时，需要在[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)回调里手动调用[DragEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#dragevent7)的[setResult()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#setdata10)接口设置拖拽结果，否则会执行系统默认的[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)接口导致文字落入两次。参见[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)接口。

  #### [h2]基于UDMF多Entry的图文混排拖拽
...
在拖出方RichEditor组件的[onDragStart()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondragstart)回调中，根据选中的内容构造拖拽数据。```
RichEditor({ controller: this.sourceController })
// ...
  ...
  // ...
```
 封装buildUnifiedRecords()函数，构造图片和文字内容的拖拽数据。```
...
```
 封装getOriginImageUri()函数，getOriginPixelMap()函数，和getSelectedText()函数。```
...
```
 在落入方[onDrop()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-drag-drop#ondrop)回调里获取拖拽数据，调用[getEntry()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-unifieddatachannel#getentry15)接口读取所需要格式的数据。```
 ...
 **使用说明**
 ...
 需要应用[声明支持分屏](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/multi-window-support#section2205081316)，并根据需求自定义拖拽响应。
 ...
 **使用说明**
 ...
 需要满足跨设备拖拽开发指导中的[使用限制条件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/distributed-drag-guide#section17575828642)，并根据需求自定义拖拽响应。
...
模拟器不支持[textRecognition](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-vision-text-recognition)接口的调用，建议使用真机进行调试，详细请参见[通用文字识别约束与限制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-vision-text-recognition#section2020122517405)。

  #### [h2]拖拽的触发手势长按浮起与长按手势之间存在冲突
