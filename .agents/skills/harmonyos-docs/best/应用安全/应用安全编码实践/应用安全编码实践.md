...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-harmony-application-security`  |  **DocID**: `c19b2230e6b0418d892634cb250c184c`  |  **NodeID**: `0002017755470833442715994029822e`
...
onSslErrorEventReceive()回调函数用于通知用户加载资源时发生SSL错误。
 ...
 当Web组件通过SSL协议进行网络请求时，默认情况下，��果底层Web组件校验服务端返回的证书或协议出错，则应取消请求，以避免中间人攻击风险。
