...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-stability-ubsan-detection`  |  **DocID**: `5d90194220304e5eb47c96f8a1adc3e5`  |  **NodeID**: `000201775547135509428bed3a711b10`
 ...
 **流水线场景**
 ...
 hvigorw [taskNames...]  <options>   方式一的勾选操作会覆盖app.json5中的配置项，因此即使设置为false，UBSan仍会生效。
