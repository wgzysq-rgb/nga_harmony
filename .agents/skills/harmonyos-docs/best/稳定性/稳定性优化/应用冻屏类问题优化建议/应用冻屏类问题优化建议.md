...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-stability-app-freeze-opt`  |  **DocID**: `7ac5882ace214a85a0bdb44b6a9e1164`  |  **NodeID**: `0002017755471355093991309a91b918`
...
- 不要在主线程中提交大量重复或耗时操作，需要合理控制页面刷新的范围，考虑大量组件、频繁刷新等场景。
- 请求云测数据需进行无网/弱网等边界场景测试，避免在生命周期函数中执行耗时操作。
