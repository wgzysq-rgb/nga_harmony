...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-multi-device-start`  |  **DocID**: `e6e9787c95284cbab563b9cccdd90cc8`  |  **NodeID**: `0002017755470123214742a30443185e`
...
编号
 ...
 2
  ...
  Row和Column组件，并指定其子组件按照主轴起始方向对齐或居中对齐。
 ...
 5
  ...
  Canvas画布组件绘制空气质量图，并使用Row组件和Column组件控制内部元素的布局。
