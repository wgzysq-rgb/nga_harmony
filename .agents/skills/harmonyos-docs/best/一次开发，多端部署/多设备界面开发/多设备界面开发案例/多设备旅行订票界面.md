...
> **分区**: 最佳实践  |  **Slug**: `multi-travel-accommodation`  |  **DocID**: `bbd9159e52b346b5b6500cf340dc9e5c`
...
将已支付订单页划分为三个部分，效果图如下： 示意图
  ...
  lg
    ...
    效果图
      ...
      对其中各个区域的分析使用的能力及实现方案如下表所示： 区域编号
...
将低价日历划分为两个部分，效果图如下： 示意图
  ...
  lg
    ...
    效果图
      ...
      对其中的各个区域分析使用的一多能力，实现方案如下表： 区域编号
