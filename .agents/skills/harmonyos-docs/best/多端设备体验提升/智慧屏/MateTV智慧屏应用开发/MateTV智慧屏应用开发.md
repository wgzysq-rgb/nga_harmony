...
> **分区**: 最佳实践  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bpta-matetv-guide`  |  **DocID**: `ad816942fe9247e2ae95421803387f2a`  |  **NodeID**: `000201775547069118094c558bd78124`
...
- Mate TV仅配备一枚位于设备前方的摄像头，其[CameraPosition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-e#cameraposition)参数显示为CAMERA_POSITION_BACK，开发者在适配时需注意这一设备差异，避免因位置判断错误导致功能异常。
...
使用马达振动前，通过[vibrator.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-vibrator#vibratoron19)监听马达热插拔事件上报。
- 使用[vibrator.getVibratorInfoSync()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-vibrator#vibratorgetvibratorinfosync19)查询设备的马达信息列表，获得马达信息。
- 设备准备完全后，使用[vibrator.startVibration()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-vibrator#vibratorstartvibration9)和[vibrator.stopVibration()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-vibrator#vibratorstopvibration19)接口控制马达振动的启动和关闭。
