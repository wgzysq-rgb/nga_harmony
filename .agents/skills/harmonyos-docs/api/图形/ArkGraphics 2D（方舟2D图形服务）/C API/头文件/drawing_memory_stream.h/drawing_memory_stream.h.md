...
**DocID**: `951e9214edcb4b21a7d035a6bbbd0ef3`

**NodeID**: `000201775795874920154523d0c8c5f1`
...
[h2]OH_Drawing_MemoryStreamCreate()
...
是否拷贝数据。true表示内存流对象会拷贝一份数据段数据，false表示内存流对象直接使用数据段数据，不拷贝。
