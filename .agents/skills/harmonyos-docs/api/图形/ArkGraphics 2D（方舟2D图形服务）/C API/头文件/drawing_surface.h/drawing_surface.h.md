...
**Slug**: `capi-drawing-surface-h`

**DocID**: `7febdad2645143f8bada3bf93b2e1b2a`

**NodeID**: `00020177579587492018783ea46a5f9c`
...
用于控制内存分配是否计入缓存预算。true则计入高速缓存预算，false则不计入高速缓存预算。
