...
**DocID**: `ad24ac549ad344a7a19f0ee55a810e9c`

**NodeID**: `0002017757958749201059a9d772a8ae`
...
函数会返回一个指针，指针指向创建的画刷对象副本
OH_Drawing_Brush
。如果对象返回NULL，表示创建失败；可能的原因是可用内存为空，或者是brush为NULL。

[h2]OH_Drawing_BrushDestroy()
...
[h2]OH_Drawing_BrushIsAntiAlias()
...
[h2]OH_Drawing_BrushSetAntiAlias()
...
[h2]OH_Drawing_BrushSetShaderEffect()
...
表示指向着色器对象的指针，为NULL表示清空画刷的着色器效果。

[h2]OH_Drawing_BrushSetShadowLayer()
...
表示指向阴影层的指针，为NULL表示清空画刷的阴影层效果。

[h2]OH_Drawing_BrushSetFilter()
...
表示指向滤波器对象的指针，为NULL表示清空画刷滤波器。

[h2]OH_Drawing_BrushGetFilter()
...
[h2]OH_Drawing_BrushSetBlendMode()
...
[h2]OH_Drawing_BrushGetAlphaFloat()
...
[h2]OH_Drawing_BrushGetRedFloat()
...
[h2]OH_Drawing_BrushGetGreenFloat()
...
[h2]OH_Drawing_BrushGetBlueFloat()
