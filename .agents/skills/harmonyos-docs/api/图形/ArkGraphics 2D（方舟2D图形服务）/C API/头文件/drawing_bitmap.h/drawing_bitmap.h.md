...
**DocID**: `f016ea2c1d8e47c5a4737eab80953af6`

**NodeID**: `0002017757958749200964749aab8ad0`
...
目标像素数据每行的字节数，应大于或等于图片信息对象中的最小每行字节数。

int32_t srcX

源位图中读取像素数据的起始x轴坐标，应小于源位图的宽度。

int32_t srcY

源位图中读取像素数据的起始y轴坐标，应小于源位图的高度。
