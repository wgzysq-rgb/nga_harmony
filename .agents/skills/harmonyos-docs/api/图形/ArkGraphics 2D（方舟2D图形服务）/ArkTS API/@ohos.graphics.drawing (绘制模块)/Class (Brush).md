...
**Slug**: `arkts-apis-graphics-drawing-brush`

**DocID**: `7b5c2165ae4d4491865c7f12ddc31bc1`

**NodeID**: `0002017757958749200789538cddf0db`
...
返回画刷的颜色，以16进制ARGB格式的32位无符号整数表示。
...
返回画刷是否开启抗锯齿属性，true表示开启，false表示关闭。
