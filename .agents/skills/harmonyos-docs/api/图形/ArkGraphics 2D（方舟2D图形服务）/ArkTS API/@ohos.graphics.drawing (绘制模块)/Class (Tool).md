...
**Slug**: `arkts-apis-graphics-drawing-tool`

**DocID**: `0d0f44905c31434584c4393481bef91f`

**NodeID**: `000201775795874920153d9803e6221c`

---

Class (Tool)

本模块定义的工具类，仅提供静态的方法，主要完成其他模块和
common2D
中定义的数据结构的转换功能等操作。
...
ResourceColor格式的颜色值（支持所有的4种输入，示例中提供13个示例输入）。其中第4种类型
Resource
只接受$r('belonging.type.name')构造方法，需要确保该资源在main/resources/base/element目录下已定义(app支持color、string和integer，sys只支持color)。
...
转换后的common2D.Color颜色对象，若转换失败则返回空指针。
