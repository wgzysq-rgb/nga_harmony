...
**Slug**: `arkts-apis-graphics-drawing-textblob`

**DocID**: `f5032fae5bc344c9a13a7ff20d069a1e`

**NodeID**: `000201775795874920152120dffffe64`
...
编码类型，默认值为TEXT_ENCODING_UTF8。当前只有TEXT_ENCODING_UTF8生效，其余编码类型也会被视为TEXT_ENCODING_UTF8。
