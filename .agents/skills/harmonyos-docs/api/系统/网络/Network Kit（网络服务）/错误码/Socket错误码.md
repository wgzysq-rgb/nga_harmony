...
> **分区**: API参考  |  **Slug**: `errorcode-net-socket`  |  **DocID**: `7595f53a2c1b488fb5cc0364b60be2e9`
...
# Socket错误码
     ...
     **可能原因**
     ...
     当[Tlssocket.connect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-socket#connect9)未调用或者[Tlssocket.connect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-socket#connect9)执行未成功时发生该错误。
