...
**DocID**: `55868dc09e124d7580aa47547b4b78e4`

**NodeID**: `000201775796341684602885304e97d0`
...
policy.showAppNetPolicySettings
22+
...
设备行为差异
：该接口在Phone、2in1、Tablet设备中可正常调用，在其他设备调用不生效。
...
Stage模型的应用上下文（仅支持UIAbilityContext和ExtensionContext）。
