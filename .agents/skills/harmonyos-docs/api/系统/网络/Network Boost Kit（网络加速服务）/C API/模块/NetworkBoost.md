...
**DocID**: `804facd5f8334e378ef96deccb9c2f7c`

**NodeID**: `000201775796341684756ce1f61e0d3d`
...
typedef void(* HMS_NetworkBoost_NetQosChange) (
NetworkBoost_NetworkQosArray
 *networkQosArray)
...
typedef void(* HMS_NetworkBoost_NetSceneChange) (
NetworkBoost_NetworkScene
 *networkScene)
...
typedef void(* HMS_NetworkBoost_OnHandoverComplete) (
NetworkBoost_HandoverComplete
 *handoverComplete)
...
typedef void(* HMS_NetworkBoost_OnHandoverStart) (
NetworkBoost_HandoverStart
 *handoverStart)
...
int32_t HMS_NetworkBoost_ReportQoe (
NetworkBoost_ServiceType
 serviceType, 
NetworkBoost_QoeType
 qoeType )
...
int32_t HMS_NetworkBoost_SetHandoverMode (
NetworkBoost_HandoverMode
 mode)
...
int32_t HMS_NetworkBoost_RequestMultiPath(
HMS_NetworkBoost_OnMultiPathRequestResult
 result)
...
int32_t HMS_NetworkBoost_SetSceneDesc(
NetworkBoost_SceneDesc
 sceneDesc)
