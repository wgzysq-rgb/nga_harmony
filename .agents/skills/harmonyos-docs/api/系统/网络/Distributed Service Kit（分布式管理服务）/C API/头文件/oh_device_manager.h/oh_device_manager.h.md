...
**DocID**: `d55e880c140843419997beb8ec4779c4`

**NodeID**: `00020177579634168469353e23418517`
...
[h2]OH_DeviceManager_GetLocalDeviceName()
...
char **localDeviceName

表示本地设备显示名字符串的地址指针。使用后需要手动释放空间资源。应用具备 ohos.permission.READ_LOCAL_DEVICE_NAME 权限，返回设备显示名称；否则返回设备默认名称。
...
，表示函数执行失败。
 ...
 返回
DM_ERR_OBTAIN_SERVICE
，表示获取设备管理服务失败。

 返回
DM_ERR_OBTAIN_BUNDLE_NAME
，表示获取bundleName失败。
