# @ohos.distributedsched.abilityConnectionManager (应���多端协同管理)

> **分区**: API参考  |  **API级别**: API 23 (HarmonyOS 6.0)

**Slug**: `js-apis-distributed-abilityconnectionmanager`

**DocID**: `c142497f57ea4f4e8b3d3f22fa87d186`

**NodeID**: `000201775796341684488b4f338538d0`
...
需要权限
：ohos.permission.INTERNET、ohos.permission.GET_NETWORK_INFO、ohos.permission.SET_NETWORK_INFO和ohos.permission.DISTRIBUTED_DATASYNC
...
若存在对应PeerInfo，则返回接收端的协作应用信息。若sessionId未找到，则查询失败，返回undefined。
...
事件回调类型，支持的事件为'receiveMessage'，完成
...
ohos.collaboration.key.peerInfo
...
ohos.collaboration.key.abilityCollaborateType
...
ohos.collaboration.value.abilityCollab

表示默认的协作类型。

ABILITY_COLLABORATION_TYPE_CONNECT_PROXY

ohos.collaboration.value.connectProxy

表示连接代理的协作类型。

---
*2026-04-22T15:55:02.860Z*