...
**DocID**: `da73a55ccae94718b2b8f1908c662ecc`

**NodeID**: `000201775796341684765f4981ca7da8`
...
typedef struct SecurityAudit_AuthClient_Impl 
SecurityAudit_AuthClient

定义阻断事件客户端。

typedef struct SecurityAudit_Client_Impl 
...
[h2]SecurityAudit_Handler

typedef void(* SecurityAudit_Handler) (const 
SecurityAudit_Event
 *events, uint64_t count)
...
[h2]HMS_SecurityAudit_AddAuthEventFilter()

int32_t HMS_SecurityAudit_AddAuthEventFilter (const 
SecurityAudit_AuthClient
 * client, 
SecurityAudit_Auth_Event
 event, const 
...
[h2]HMS_SecurityAudit_AddFilter()

int32_t HMS_SecurityAudit_AddFilter (const 
SecurityAudit_Client
 * client, 
SecurityAudit_Notify_Event
 event, const 
...
函数执行结果。 返回值说明： 如果操作成功，则返回0。 如果权限验证失败，则返回201。 如果发生内部错误，则返回1012000001。 如果过滤器数量超过上限，则返回1012000004。 如果事件不支持过���条件，则返回1012000005。

[h2]HMS_SecurityAudit_Auth()

int32_t HMS_SecurityAudit_Auth (const 
SecurityAudit_AuthClient
 * client, const 
SecurityAudit_Event
 * event, 
...
[h2]HMS_SecurityAudit_DeleteAuthClient()

int32_t HMS_SecurityAudit_DeleteAuthClient (
SecurityAudit_AuthClient
 * client)
...
[h2]HMS_SecurityAudit_DeleteClient()
...
[h2]HMS_SecurityAudit_NewAuthClient()

int32_t HMS_SecurityAudit_NewAuthClient (
SecurityAudit_AuthClient
 ** client, 
SecurityAudit_Handler
 handler )
...
[h2]HMS_SecurityAudit_NewClient()

int32_t HMS_SecurityAudit_NewClient (
SecurityAudit_Client
 ** client, 
SecurityAudit_Handler
 handler )
...
[h2]HMS_SecurityAudit_RemoveAuthEventFilter()

int32_t HMS_SecurityAudit_RemoveAuthEventFilter (const 
SecurityAudit_AuthClient
 * client, 
SecurityAudit_Auth_Event
 event, const 
...
[h2]HMS_SecurityAudit_RemoveFilter()

int32_t HMS_SecurityAudit_RemoveFilter (const 
SecurityAudit_Client
 * client, 
SecurityAudit_Notify_Event
 event, const 
...
[h2]HMS_SecurityAudit_Subscribe()

int32_t HMS_SecurityAudit_Subscribe (const 
SecurityAudit_Client
 * client, const 
SecurityAudit_Notify_Event
 * events, uint64_t count )
...
[h2]HMS_SecurityAudit_SubscribeAuthEvent()

int32_t HMS_SecurityAudit_SubscribeAuthEvent (const 
SecurityAudit_AuthClient
 * client, const 
SecurityAudit_Auth_Event
 * events, uint64_t count )
...
[h2]HMS_SecurityAudit_Unsubscribe()

int32_t HMS_SecurityAudit_Unsubscribe (const 
SecurityAudit_Client
 * client, const 
SecurityAudit_Notify_Event
 * events, uint64_t count )
...
[h2]HMS_SecurityAudit_UnsubscribeAuthEvent()

int32_t HMS_SecurityAudit_UnsubscribeAuthEvent (const 
SecurityAudit_AuthClient
 * client, const 
SecurityAudit_Auth_Event
 * events, uint64_t count )
...
[h2]HMS_SecurityAudit_QueryAllProcesses()
...
[h2]HMS_SecurityAudit_QueryProcesses()
