...
**DocID**: `4887c300d587436bbc49d946350826ed`

**NodeID**: `00020177579634168440149deb269e00`
...
设置icon的高度，宽高比1:1，默认64fp，不支持百分比字符串。
...
设置icon的颜色，默认值：$r('sys.color.ohos_id_color_activated')。
...
调用onAuthResult可能会抛出错误码，错误码详细介绍请参见
通用错误码
和
用户认证错误码
。
