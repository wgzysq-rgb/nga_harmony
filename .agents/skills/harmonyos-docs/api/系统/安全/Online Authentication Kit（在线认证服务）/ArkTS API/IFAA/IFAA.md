...
**Slug**: `onlineauthentication-ifaa-api`

**DocID**: `5ef1d06f35e641d99ad4ac300bab4764`

**NodeID**: `00020177579634168448904a64d8902e`
...

{
 ...
 console.info("Succeeded in doing 
getAnonymousId
.");
...
返回IFAA免密认证的开通状态。true代表已开通，false代表未开通。
...
Promise对象，true代表已开通，false代表未开通。
...
回调函数，用于获取开通状态，true代表已开通，false代表未开通。
...
返回IFAA免密认证的预认证参数，其中存在用于后续进行生物认证时所需的挑战值（challenge）。
