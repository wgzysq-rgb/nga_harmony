...
**DocID**: `1943b3fc6e6f4cb1b9630649d607579f`

**NodeID**: `00020177579634168472413000e90f69`
...
FIDO2_CredentialCreationOptions
 options, const 
FIDO2_TokenBinding
 tokenBinding, const char *origin, 
FIDO2_PublicKeyAttestationCredential
...
[h2]FIDO2_AttestationConveyancePreference
...
[h2]FIDO2_AttestationFormatsArray
...
[h2]FIDO2_AuthenticatorAttachment
...
[h2]FIDO2_AuthenticatorAttestationResponse
...
[h2]FIDO2_AuthenticatorMetadata
...
[h2]FIDO2_AuthenticatorMetadataArray
...
[h2]FIDO2_AuthenticatorResponse
...
[h2]FIDO2_AuthenticatorSelectionCriteria
...
[h2]FIDO2_AuthenticatorTransport
...
[h2]FIDO2_AuthenticatorTransportArray
...
[h2]FIDO2_CredentialCreationOptionArray
...
[h2]FIDO2_CredentialCreationOptions
...
[h2]FIDO2_CredentialRequestOptions
...
[h2]FIDO2_PublicKeyAssertionCredential
...
[h2]FIDO2_PublicKeyAttestationCredential
...
[h2]FIDO2_PublicKeyCredentialCreationOptions
...
[h2]FIDO2_PublicKeyCredentialDescriptor
...
[h2]FIDO2_PublicKeyCredentialDescriptorArray
...
[h2]FIDO2_PublicKeyCredentialHintArray
...
[h2]FIDO2_PublicKeyCredentialParameters
...
[h2]FIDO2_PublicKeyCredentialRequestOptions
...
[h2]FIDO2_PublicKeyCredentialRpEntity
...
[h2]FIDO2_PublicKeyCredentialType
...
[h2]FIDO2_PublicKeyCredentialUserEntity
...
[h2]FIDO2_UserVerificationRequirement
...
[h2]HMS_FIDO2_authenticate()

FIDO2_ErrorCode
 HMS_FIDO2_authenticate (const 
FIDO2_CredentialRequestOptions
 options, const 
FIDO2_TokenBinding
 tokenBinding, const char * origin, 
...
如果函数执行成功，则返回FIDO2_SUCCESS；如果函数执行失败，则返回特定的错误代码。详细信息请参见
FIDO2_ErrorCode
。
...
[h2]HMS_FIDO2_CapabilityArray_Destroy()

void HMS_FIDO2_CapabilityArray_Destroy (
FIDO2_CapabilityArray
 * capability)
...
[h2]HMS_FIDO2_getClientCapability()
...
如果函数执行成功，则返回FIDO2_SUCCESS； 如果函数执行失败，则返回错误代码。详细信息请参见
FIDO2_ErrorCode
。
...
[h2]HMS_FIDO2_initRequestOptions()

void HMS_FIDO2_initRequestOptions (
FIDO2_CredentialRequestOptions
 * options)
...
[h2]HMS_FIDO2_initTokenBinding()

void HMS_FIDO2_initTokenBinding (
FIDO2_TokenBinding
 * tokenBinding)
...
[h2]HMS_FIDO2_PublicKeyAssertionCredential_Destroy()

void HMS_FIDO2_PublicKeyAssertionCredential_Destroy (
FIDO2_PublicKeyAssertionCredential
 * publicKeyAssertionCredential)
...
[h2]HMS_FIDO2_PublicKeyAttestationCredential_Destroy()

void HMS_FIDO2_PublicKeyAttestationCredential_Destroy (
FIDO2_PublicKeyAttestationCredential
 * publicKeyAttestationCredential)
...
[h2]HMS_FIDO2_register()

FIDO2_ErrorCode
 HMS_FIDO2_register (const 
FIDO2_CredentialCreationOptions
 options, const 
FIDO2_TokenBinding
 tokenBinding, const char * origin, 
