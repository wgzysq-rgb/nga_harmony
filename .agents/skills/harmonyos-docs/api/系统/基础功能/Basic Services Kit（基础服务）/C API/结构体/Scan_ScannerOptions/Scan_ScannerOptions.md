...
> **分区**: API参考  |  **Slug**: `capi-oh-scan-scan-scanneroptions`  |  **DocID**: `a1c3438b20c346dba46e8cda56daf185`
 ...
 **所在头文件：** [ohscan.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohscan-h)
 ...
 名称 描述   char** titles 选项标题  char** descriptions 选项描述  char** ranges 选项可设置的范围  int32_t optionCount 可设置的参数选项数量
