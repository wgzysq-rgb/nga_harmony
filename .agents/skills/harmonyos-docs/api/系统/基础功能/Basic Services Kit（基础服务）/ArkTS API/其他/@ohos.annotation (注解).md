...
> **分区**: API参考  |  **Slug**: `js-apis-annotation`  |  **DocID**: `3b16dd6d949949d38818af2624404bbf`
 ...
 **系统能力：** SystemCapability.Base
  ...
  名称 类型 只读 可选 说明   minApiVersion string 否 否 minApiVersion用于标识最低可用版本，由两部分组成：系统类型+版本号。例如：'HarmonyOS 6.0.2'。     **示例：**
 ...
 **系统能力：** SystemCapability.Base
  ...
  名称 类型 只读 可选 说明   rules Array<[SuppressWarningsType](#suppresswarningstype23)> 否 否 支持告警消除的规则集合     **注解使用示例：**
 ...
 **系统能力：** SystemCapability.Base
  ...
  名称 值 说明   COMPATIBILITY compatibility 支持消除兼容性告警。  SYSCAP syscap 支持消除多设备告警。
