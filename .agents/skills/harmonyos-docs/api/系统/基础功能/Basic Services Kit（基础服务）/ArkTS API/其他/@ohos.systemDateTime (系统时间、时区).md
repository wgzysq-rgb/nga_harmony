...
**Slug**: `js-apis-date-time`

**DocID**: `3c17f4adf2224c25bab4f01d6f95f64e`

**NodeID**: `000201775796341684949ec8936e869e`
...
回调函数，返回自系统启动以来经过的时间（ms），但不包括深度睡眠时间。
...
回调函数，返回自系统启动以来经过的时间（ms），包括深度睡眠时间。
...
中的new Date()方法替代，new Date()返回Date实例对象。
...
Parameter error. Possible causes: 1.System error.
...
systemDateTime.getAutoTimeStatus
21+
...
Network connection error or OS error. Possible causes: 1.System memory is insufficient; 2.Calls the underlying system interface failed.
