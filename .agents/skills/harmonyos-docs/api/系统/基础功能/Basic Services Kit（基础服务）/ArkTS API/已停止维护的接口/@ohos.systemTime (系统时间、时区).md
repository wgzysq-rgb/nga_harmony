...
**Slug**: `js-apis-system-time`

**DocID**: `5104cb482ac34a6797c6f526a4acb24f`

**NodeID**: `0002017757963416849852159072bb84`
...
从API Version 9 开始，该模块接口不再维护，推荐使用新模块接口
...
回调函数，返回自系统启动以来经过的时间（ms），不包括深度睡眠时间。
