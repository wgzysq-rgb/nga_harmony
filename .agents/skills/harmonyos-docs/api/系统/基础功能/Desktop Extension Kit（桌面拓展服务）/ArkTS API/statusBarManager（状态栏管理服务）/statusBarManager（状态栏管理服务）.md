...
**DocID**: `54b143c52a1847718310d1210ebda017`

**NodeID**: `0002017757963416843912df5e264ea4`
...
- iconClickType：点击事件类型，当前仅支持左键(leftClick)。
...
取消事件回调类型，支持的事件为'statusBarIconClick'
...
取消事件回调类型，支持的事件为'rightMenuClick'。
