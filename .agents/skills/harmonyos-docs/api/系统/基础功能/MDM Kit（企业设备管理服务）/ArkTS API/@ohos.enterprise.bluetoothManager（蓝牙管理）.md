...
**Slug**: `js-apis-enterprise-bluetoothmanager`

**DocID**: `dbc762a05a6e461d8a9badf44330a66c`

**NodeID**: `0002017757963416845801260e0fa59a`
...
蓝牙设备MAC地址的数组。蓝牙设备允许名单数组长度上限为1000，若当前允许名单中已有300个蓝牙设备MAC地址，则只允许再添加700个。
...
bluetoothManager.addDisallowedBluetoothDevices
20+
...
蓝牙设备MAC地址的数组。蓝牙设备禁用名单数组长度上限为1000，若当前禁用名单中已有300个蓝牙设备MAC地址，则只允许再添加700个。
...
bluetoothManager.removeDisallowedBluetoothDevices
20+
