...
**Slug**: `js-apis-enterprise-browser`

**DocID**: `01943f8a2253465f837d918f721e7331`

**NodeID**: `000201775796341684594147c06ce902`
...
浏览器子策略名。当此值为空字符串时，表示设置应用ID对应的浏览器策略。
...
浏览器子策略值。当此值为空字符串时，表示取消浏览器策略名对应浏览器子策略。
...
browser.setManagedBrowserPolicy
15+
...
浏览器策略值。当此值为空字符串时，表示取消浏览器策略名对应浏览器子策略。
...
browser.getManagedBrowserPolicy
15+
...
browser.getSelfManagedBrowserPolicyVersion
15+
...
browser.getSelfManagedBrowserPolicy
15+
