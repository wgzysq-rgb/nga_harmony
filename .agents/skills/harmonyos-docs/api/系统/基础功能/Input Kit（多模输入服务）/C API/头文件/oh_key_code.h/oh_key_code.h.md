...
> **分区**: API参考  |  **Slug**: `capi-oh-key-code-h`  |  **DocID**: `3689439cd0924c57a1bc6c77061321ea`
 ...
 **相关模块：** [input](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input)
 ...
 名称 typedef关键字 描述   [Input_KeyCode](#input_keycode) Input_KeyCode 键值。       #### 枚举类型说明

  #### [h2]Input_KeyCode

enum Input_KeyCode **描述**

 键值。

 **起始版本：** 12

  枚举项 描述   KEYCODE_UNKNOWN = -1 未知按键  KEYCODE_FN = 0 功能（Fn）键  KEYCODE_HOME = 1 功能（Home）键
 ...
 **起始版本：** 22
   ...
   KEYCODE_PLAYPAUSE = 2630 多媒体键：播放/暂停。
