...
**Slug**: `car-navigationinfomgr`

**DocID**: `eb16398f43e944aca7ff4d4bfee6f286`

**NodeID**: `0002017757963416844393fa8ac5f640`
...
车道线，从最左边到最右边按序排列。通讯以四位为一个单元进行解析，每个单元对应一个车道线，根据需求可以传多个车道线，图标编码为枚举值，具体参考
trafficLane
。
...
导航状态，包含地图状态、导航类型、导航目的地、导航途经点、路线、地图和主题等。
