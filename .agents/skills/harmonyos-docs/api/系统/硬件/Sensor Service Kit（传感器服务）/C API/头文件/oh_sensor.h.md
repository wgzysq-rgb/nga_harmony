...
**DocID**: `cc172ca2bff74b80a2fb5f4e7b771439`

**NodeID**: `00020177579634168469476df779e382`
...
参数检查失败。例如，参数无效；或传入的参数类型不正确。

SENSOR_SERVICE_EXCEPTION
传感器服务异常。

[h2]OH_Sensor_Subscribe()
...
const Sensor_SubscriptionAttribute
 *attribute

- 指向订阅属性的指针，该属性用于指定数据报告频率。请参考
...
- 指向订阅者信息的指针，该信息用于指定的回调函数报告传感器数据。请参考
Sensor_Subscriber
。
