...
**Slug**: `js-apis-awareness-metadatabinding`

**DocID**: `107a99a2e4c94ddabda2748b34b810c3`

**NodeID**: `0002017757963416845360ff392b4464`
...
Internal handling failed. Set Meta data to screenshot app fail.
...
事件类型，type为‘operationSubmitMetadata’，表示系统应用获取编码内容。
...
Internal handling failed. Service exception.

32100004

Subscribe Failed. Possible causes: 1. Abnormal system capability; 2. IPC communication abnormality; 3. Algorithm loading exception.
