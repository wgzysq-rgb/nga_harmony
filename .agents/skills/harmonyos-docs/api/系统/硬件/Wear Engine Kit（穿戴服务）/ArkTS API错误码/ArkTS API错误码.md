...
**Slug**: `wearengine_api_error_code`

**DocID**: `5ad2bb64ac7d41eeb89c6b883a2abd46`

**NodeID**: `000201775796341684349d7629d6487c`
...
申请WearEngine服务时未配置兼容选项。

开发者未在开发者联盟申请WearEngine服务。

处理步骤

申请WearEngine服务时，勾选兼容选项。
...
应用未在metadata中配置clientId。

WearEngine发生未知错误。

处理步骤

调试时检查应用的签名证书等信息，与开发者联盟是否一致。
