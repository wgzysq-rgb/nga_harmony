...
**Slug**: `pen-instantsshapegenerator`

**DocID**: `35527871568142f0bb5e4a3ffa399897`

**NodeID**: `00020177579634168452025d851bee0c`
...
用于绘制结果形状的笔宽。某些形状结果会根据此值而变化，例如箭头。单位：画布宽度的千分之一。
...
'InstantShapeGenerator aboutToAppear'
...
'InstantShapeGenerator aboutToDisappear'
