...
> **分区**: API参考  |  **Slug**: `pen-handwrite-headerfile-declare`  |  **DocID**: `1bca381a7cca4edbb0aeb608c05e2d11`
 ...
 **相关模块：** [HandWrite](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pen-handwrite-c)
 ...
 名称 描述   enum [HandWrite_ErrCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pen-handwrite-c#handwrite_errcode) {
