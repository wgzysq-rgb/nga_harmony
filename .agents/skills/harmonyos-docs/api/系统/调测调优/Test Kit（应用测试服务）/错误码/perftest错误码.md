...
> **分区**: API参考  |  **Slug**: `errorcode-perftest`  |  **DocID**: `d62ecaf277ac4cb1af8dbfda8f885a84`
...
# perftest错误码
     ...
     **处理步骤**
      ...
      - 尝试通过重试解决IPC传输失败问题。
      - 判断PerfTest对象是否已被销毁，若已销毁需要重新[创建PerfTest对象](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-perftest#create)。
