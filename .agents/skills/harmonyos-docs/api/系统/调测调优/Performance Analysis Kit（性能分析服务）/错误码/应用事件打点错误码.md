...
**Slug**: `errorcode-hiappevent`

**DocID**: `eb276ff8dc724c0f80af7fce571e3222`

**NodeID**: `000201775796341684495255d80e12fc`
...
在调用addWatcher接口进行��件订阅时，由于传入了非法的过滤事件领域，系统将忽略此次订阅。
