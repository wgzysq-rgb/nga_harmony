...
**DocID**: `9c1ae8576f5942bc8c4d75ccfe76df5f`

**NodeID**: `000201775796341684583faa76cb3e94`
...
当未设置TP_INFO标志时，设置D2D_TP_INFO标志，此时调用信息埋点接口
tracepoint()
...
HiTraceMeter打点操作传入的trace说明信息，默认值为""。
...
true：HiTraceId已启用flag；false：HiTraceId未启用flag。
