...
**Slug**: `js-apis-faultlogger`

**DocID**: `ab9bfa42e53b4f66a238db094a3aa7c0`

**NodeID**: `0002017757963416848609df5fab76c4`
...
系统侧保存的应用故障日志数量受系统日志的压力限制，推荐使用
@ohos.hiviewdfx.hiAppEvent
订阅APP_CRASH及APP_FREEZE等故障事件。

本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

本模块接口从API version 18开始废弃使用, 该接口不再维护。后续版本推荐使用
@ohos.hiviewdfx.hiAppEvent
订阅APP_CRASH，APP_FREEZE事件。
