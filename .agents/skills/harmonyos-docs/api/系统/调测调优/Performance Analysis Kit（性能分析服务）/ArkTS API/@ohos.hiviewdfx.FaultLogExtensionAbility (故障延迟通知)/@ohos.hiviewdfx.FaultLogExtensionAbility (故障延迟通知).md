...
**DocID**: `22105c15077f41e3a20845fe51907dd6`

**NodeID**: `000201775796341684620db9d0f0f949`
...
应用接入故障延迟通知需要通过FaultLogExtensionAbility实现，开发者可以在
onFaultReportReady
中订阅并处理故障事件。

FaultLogExtensionAbility被拉起后只有很短的时间完成故障处理，建议处理时间不要超过10秒。超时没有处理完成可以在
onDisconnect
中保存状态。
...
FaultLogExtensionAbility的上下文环境，继承自
ExtensionContext
。
