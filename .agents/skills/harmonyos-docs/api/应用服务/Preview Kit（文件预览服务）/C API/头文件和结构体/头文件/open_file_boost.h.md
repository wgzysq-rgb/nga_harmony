...
**Slug**: `openfileboost-open__file__boost_8h`

**DocID**: `59dc0ce7f5ec4ced9e5bcaf337eac2de`

**NodeID**: `0002017757959462673710d9dfbfbe18`
...
系统查询app状态的回调函数定义，该函数在调用
HMS_OpenFileBoost_OnFilePreload
推荐文件之前先回调app。该函数用于系统向app查询当前是否允许推荐文件给app。如果应用处于前台焦点或者某些特殊状态，不适合预加载文件，app返回特定枚举值拒绝预加载。
