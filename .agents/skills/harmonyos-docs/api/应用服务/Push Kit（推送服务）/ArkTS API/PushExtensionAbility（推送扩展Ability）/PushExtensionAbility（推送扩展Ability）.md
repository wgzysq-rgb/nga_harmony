...
**Slug**: `push-extension-ability`

**DocID**: `2b4c5da14ea34e34b5b378fda7b6a5c5`

**NodeID**: `000201775795946267211d213d8ffa7b`

---

PushExtensionAbility（推送扩展Ability）

推送扩展Ability目前为预留能力，暂未开放使用。若您的应用有拉起应用的子进程，在子进程中自行处理业务的诉求，请参考
发送语音播报消息
。
...
PushExtensionAbility的上下文环境，继承自
ExtensionContext
。
