...
**Slug**: `push-servicenotification`

**DocID**: `7e0933d27db443f59b3846a61e9a5c79`

**NodeID**: `000201775795946267198d4c2e0149c0`
...
设备行为差异
：该接口在Phone、Tablet、PC/2in1中可正常调用，在其他设备类型中返回错误码1000900017。
...
回调函数。当请求订阅成功，err为undefined，data为订阅授权结果；否则为错误对象。
...
设备行为差异
：该接口在Phone、Tablet中可正常调用，在其他设备类型中返回错误码1000900017。
...
当订阅type为SUBSCRIBE_WITH_HUAWEI_ID时，详情请参见
选用订阅模板
。
...
设备行为差异
：该接口在Phone、Tablet、PC/2in1中可正常调用，在其他设备类型中无效果。
...
设备行为差异
：该枚举值在Phone、Tablet、PC/2in1中可正常使用，在其他设备类型中无效果。
