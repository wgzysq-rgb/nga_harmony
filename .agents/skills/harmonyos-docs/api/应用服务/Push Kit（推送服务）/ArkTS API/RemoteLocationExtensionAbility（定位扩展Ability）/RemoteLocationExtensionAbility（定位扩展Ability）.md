...
**Slug**: `remote-location-ability`

**DocID**: `24d6510dff0d44e5be210ee82ce8a8e6`

**NodeID**: `000201775795946267216b6fe2e965cc`
...
设备行为差异
：该属性在Phone、Tablet、PC/2in1中可正常使用，在其他设备类型中无效果。
...
RemoteLocationExtensionAbility的上下文环境，继承自
ExtensionContext
。
