...
**DocID**: `87714ad342854f6fbd948121868dcc36`

**NodeID**: `000201775795946267300f1a9be04c98`
...
应用只在后台展示通知消息；应用在前台时，通知消息将不会展示，但可以接收通知消息后自行完成业务处理，详情请参见
应用在前台时处理通知消息
。
