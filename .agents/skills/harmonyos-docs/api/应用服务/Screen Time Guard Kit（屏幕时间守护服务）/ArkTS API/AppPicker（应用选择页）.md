...
**DocID**: `011d87cebc4d473bab58ff77edf19599`

**NodeID**: `0002017757959462670893a6871f840a`
...
guardService.AppInfo

是

已被选择的应用，在picker页呈现勾选状态。
...
Capability not supported. function startAppPicker can not work correctly due to limited device capabilities.
...
该字符串支持的最大长度为200个字符，超出范围时返回1019000009错误码。
...
是否在拉起的跳转页中展示默认的访问不受限应用，true表示展示，false表示不展示。目前支持的默认访问不受限应用仅包括"联系人"。
...
Capability not supported. function startAppForm can not work correctly due to limited device capabilities.
