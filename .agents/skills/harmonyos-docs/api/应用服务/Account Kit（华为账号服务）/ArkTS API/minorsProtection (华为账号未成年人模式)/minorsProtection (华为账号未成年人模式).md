...
**DocID**: `3830a25695fc49d8978a6957f4aec27b`

**NodeID**: `0002017757959462671660b4691dd00a`
...
当登录中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）儿童账号（14周岁及以下）开启未成年人模式，则可能返回年龄段信息为[0,3)、[3,8)、[8,12)或[12,16)。

如用户登录4周岁儿童账号，则返回年龄段信息为[3,8)。

如用户登录9周岁儿童账号，则返回年龄段信息为[8,12)。

当登录中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）非儿童账号开启未成年人模式，则可能返回年龄段信息为[0,3)、[3,8)、[8,12)、[12,16)或[16,18)。

如用户创建13岁临时使用者，则返回年龄段信息为[12,16)。

如用户创建17岁临时使用者，则返回年龄段信息为[16,18)。
