...
**Slug**: `account-api-huawei-id-button`

**DocID**: `03282ae99ed1499e82479fd3acbba0a2`

**NodeID**: `000201775795946267095d4ec9e8bf02`
...
LoginWithHuaweiIDButton需要配合
loginComponentManager
一起使用，用于实现华为账号登录功能。LoginWithHuaweiIDButton组件文本内容默认支持多语言。
