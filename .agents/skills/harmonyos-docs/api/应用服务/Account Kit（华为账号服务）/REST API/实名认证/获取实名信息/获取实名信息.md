...
**Slug**: `account-api-get-realname`

**DocID**: `688a129642344286afbc01fc5ac30d47`

**NodeID**: `00020177579594626726317d9dede8fa`
...
https://openrealname.cloud.huawei.com/rest.php?nsp_svc=OpenRealName.User.getDetailInfo
...
到华为开发者联盟
API Console
上，在“凭证”菜单中，选择创建服务账号密钥时会生成密钥文件，打开密钥文件中有sub_account 信息，该参数为密钥文件中的sub_account 的值。
...
打开创建服务账号密钥时生成的密钥文件，文件中有key_id信息，该参数为密钥文件中的key_id的值。
...
&queryRangeFlag=0001&serviceAccountClientID=
...
请使用Base64.decodeBase64方法解码后，使用请求传入的serviceAccountKeyID对应的私钥解密，解密算法为RSA/ECB/OAEPWithSHA-256AndMGF1Padding，解密后可获得明文姓名和证件号码，Json格式，如{realName:xxx, ctfCode:xxx**xxx}。
