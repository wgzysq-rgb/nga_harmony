...
> **分区**: API参考  |  **Slug**: `errorcode-notification`  |  **DocID**: `22b4945433dc405ebab9f29f9fb12d3f`
...
# 通知错误码
     ...
     **可能原因**
     ...
     应用未设置或未正确设置[NotificationSubscriberExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-notificationsubscriberextensionability)。
