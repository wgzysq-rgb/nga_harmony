...
**DocID**: `2785e012204f4ca69c69b6fe28a8a408`

**NodeID**: `000201775795946267118c2b4e755a57`
...
Permission denied or current device not supported.
...
Promise对象。返回true表示功能已启用；返回false表示功能未启用。
...
Promise对象，返回获取指定应用中“已获取的本机通知”通知开关开启的应用列表。
...
_NotificationExtensionSubscriptionInfo
