...
**Slug**: `payment-api-common-verification-result`

**DocID**: `82d6a8eacd6d46d1a00af48318abb7d0`

**NodeID**: `0002017757959462673851b39fa2e2b2`
...
开发者可以调用该接口查询实名信息验证结果。

场景描述

开发者在用户实名信息验证后，需要获取实名信息验证结果。
...
https://petalpay-developer.cloud.huawei.com.cn/api/v1/realname/verification/result
...
POST /api/v1/realname/verification/result HTTP/1.1
...
ID_TYPE_NOT_SUPPORT：证件类型不支持（当前华为支付开放实名验证能力仅支持身份证）

RARE_WORD_NOT_SUPPORT：生僻字场景不支持 （如姓名中携带了生僻字）
