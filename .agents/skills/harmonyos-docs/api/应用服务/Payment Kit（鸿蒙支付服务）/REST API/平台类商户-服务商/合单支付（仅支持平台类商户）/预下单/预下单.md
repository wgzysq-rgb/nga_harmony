...
**Slug**: `payment-partner-combined-app-prepay`

**DocID**: `a405a1b9202c4df281f4312eaa95ad42`

**NodeID**: `000201775795946267372498158dee72`
...
开发者接入合单支付，首先需要调用该接口获取到预支付ID（prepayId），用prepayId构建
orderStr
...
https://petalpay-developer.cloud.huawei.com.cn/api/v2/partner/combined/preorder/create/app

 说明： 

元服务预下单接口请使用以下URL：

https://petalpay-developer.cloud.huawei.com.cn/api/v2/partner/combined/preorder/create/fa
