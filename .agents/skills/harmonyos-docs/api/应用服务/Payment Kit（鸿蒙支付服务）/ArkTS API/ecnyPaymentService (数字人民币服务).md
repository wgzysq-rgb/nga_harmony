...
**Slug**: `payment-digitalcnyservice`

**DocID**: `45da192cfcaa45319096a22453088994`

**NodeID**: `00020177579594626715316536e2fde4`
...
付款钱包编号后四位，如果传可以在数字人民币收银台默认选择该钱包。若未填写，默认为空。
...
设备行为差异：
该接口在Phone设备中可正常调用，在其他设备类型中返回1014900005错误码。
