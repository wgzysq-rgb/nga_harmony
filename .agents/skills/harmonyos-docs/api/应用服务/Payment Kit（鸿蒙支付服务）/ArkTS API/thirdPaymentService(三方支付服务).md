...
**Slug**: `payment-third-payment-service`

**DocID**: `5ddc643a61314c72bef2fb601ac15322`

**NodeID**: `0002017757959462671685d3748d60ff`
...
系统能力：
SystemCapability.Payment.ThirdPaymentService
...
拉起收银台传入的订单信息，payInfo是json字符串的格式（具体参数根据三方支付方式拉起收银台要求传递，参考
payInfo
）。
...
"
 ...
 // PayMethod.ALI_PAY：'{"orderInfo":"***", 
"token":"***"
}'
 // PayMethod.WECHAT_MINI_PROGRAM：'{"userName":"原始id", "path":"小程序启动路径", "miniProgramType":"小程序的类型，0-正式版 1-开发版 2-体验版 默认0", "extData":"
***
", 
"token":"***"
}'
