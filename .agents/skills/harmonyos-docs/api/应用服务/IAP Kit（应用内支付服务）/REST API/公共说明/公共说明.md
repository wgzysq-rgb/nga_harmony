...
**Slug**: `iap-rest-common-statement`

**DocID**: `64e3ef3771654b43a469e35193898abb`

**NodeID**: `000201775795946267073dd19af87bac`
...
应用内支付的所有服务端接口均要求使用标准的application/json进行访问，使用其他的MIME Type会导致部分场景出现无法预测的调用问题。
