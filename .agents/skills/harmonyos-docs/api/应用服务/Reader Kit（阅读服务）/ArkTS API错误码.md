...
> **分区**: API参考  |  **Slug**: `reader-error-code`  |  **DocID**: `5fd04cbe9dfe45d085b989802bce8fe7`
...
请先初始化ReadPageComponent组件，再调用组件的能力。
...
请检查书籍类型是否为'txt'、'epub'、'mobi'、'azw3'、'azw'。
...
请先检查[应用沙箱目录](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-sandbox-directory)下（'/haps/entry/files/'）是否有导入的书籍。

  尝试重试操作或请通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题。

---
*Updated: 2026-04-22 06:41:24*
