...
**Slug**: `js-apis-app-ability-fenceextensioncontext`

**DocID**: `dde8b434623545b0b66df3db1b7baf81`

**NodeID**: `0002017757959462671484734296333e`

---

@ohos.app.ability.FenceExtensionContext (FenceExtensionContext)

FenceExtensionContext是FenceExtensionAbility的上下文环境，继承自
ExtensionContext
，提供FenceExtensionAbility的相关配置信息以及启动Ability接口。
