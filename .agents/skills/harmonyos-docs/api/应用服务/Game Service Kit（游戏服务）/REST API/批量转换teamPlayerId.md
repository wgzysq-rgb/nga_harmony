...
**DocID**: `ee31f491033d4fa0b74399968e3a884b`

**NodeID**: `000201775795946267156b17e8645983`
...
调用
获取Token
接口时使用的域名需与本接口域名保持一致，例如本接口使用“connect-api.cloud.huawei.com”，则调用
获取Token
接口需使用“https://connect-api.cloud.huawei.com/api/jas/open/players/player-accounts/team-player/convert”。
...
认证信息，格式为“Authorization: Bearer ${access_token}”。access_token为
获取Token
中获取的access_token。
...
包含返回码及描述信息的JSON字符串，格式为{"code":
retcode
, "msg": "
description
"}，retcode为返回码，description为返回码描述信息。
...
private static void batchGetOpenIds(String domain, String client_id, String token, List<String> teamPlayerIds, String appId) {
 ...
 keyString.put("teamPlayerIds", teamPlayerIds); // 原主体的teamPlayerId
