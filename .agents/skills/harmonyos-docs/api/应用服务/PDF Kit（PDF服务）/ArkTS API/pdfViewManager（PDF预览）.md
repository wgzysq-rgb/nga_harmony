...
**DocID**: `5ee0f2458b704405a8ca46a6bf948069`

**NodeID**: `000201775795946267098334b39ebad9`
...
X坐标偏移，范围0~1，含义是0%~100%的偏移如果总宽度是1000px，要偏移X轴500px，值是0.5。
...
Y坐标偏移，范围0~1，含义是0%~100%的偏移，如果总高度是1000px，要偏移Y轴500px，值是0.5。
...
连续滚动时上下页面的间距，大于等于0，单位为px，默认值：10。
...
[h2]registerSelectedRectsChangedListener
...
[h2]registerPageFitChangedListener
...
[h2]registerPageChangedListener
...
[h2]registerScaleChangedListener
...
[h2]registerTextSelectedListener
...
[h2]registerAnnotationSelectedListener
...
[h2]registerImageSelectedListener
...
[h2]registerActionClickListener
...
[h2]registerAnnotationChangedListener
...
[h2]registerPageCountChangedListener
...
可滚动组件滚动时的嵌套滑动选项，包括scrollUp、scrollDown、scrollLeft、scrollRight，默认值为
PdfNestedScrollMode
.SELF_ONLY。
...
默认值：PdfNestedScrollMode.SELF_ONLY。
...
自身先滑动，自身滑动到边缘以后父组件滑动。如果父组件有边缘效果，在滑动到父组件边缘后，触发父组件边缘效果，否则触发子组件的边缘效果。

---
*2026-04-22T15:55:04.393Z*