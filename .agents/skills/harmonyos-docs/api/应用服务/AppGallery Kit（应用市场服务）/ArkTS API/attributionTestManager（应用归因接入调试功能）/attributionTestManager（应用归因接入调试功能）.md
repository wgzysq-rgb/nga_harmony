...
**Slug**: `store-attributiontestmanager`

**DocID**: `20c09f0b69824fd58e54a4e5fb4c148a`

**NodeID**: `00020177579594626719385a482aade0`
...
import { attributionTestManager } from '@kit.AppGalleryKit';
import { SignUtil } from '../common/utils/SignUtil'; // 参考指南附录
生成签名方法
部分代码
...
分发平台对应的归因角色ID，本次登记归因来源对应营销任务所归属的分发平台的标识符，长度固定为8个字符。
