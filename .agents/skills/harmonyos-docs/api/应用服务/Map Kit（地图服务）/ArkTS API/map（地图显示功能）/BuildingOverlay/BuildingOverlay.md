...
**DocID**: `fe49c95adefe421a97439c1d21a22bca`

**NodeID**: `000201775795946267332cbf945fb98c`
...
设置是否显示3D建筑的侧面和顶部。如果不需要显示3D建筑请同时将
setSideVisible
和
setFloorVisible
设置为false。
...
所选楼层底部到地面的高度，单位：米，取值范围：大于等于0，异常值不处理。
