...
> **分区**: API参考  |  **Slug**: `map-module-desc`  |  **DocID**: `6edfc4fda38d48e79e066e8410b06f4f`
...
[newLatLng](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-newlatlng)：设置地图的中心点和缩放层级。
  ...
  [newLatLngBounds](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-newlatlngbounds)：设置地图经纬度范围、地图区域和边界之间的距离。
