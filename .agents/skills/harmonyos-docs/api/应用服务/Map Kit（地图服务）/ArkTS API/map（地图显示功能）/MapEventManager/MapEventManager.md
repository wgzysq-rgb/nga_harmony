...
**Slug**: `map-map-mapeventmanager`

**DocID**: `f55a971228384ceba76686a798499b57`

**NodeID**: `0002017757959462673385ec4c992672`
...
off(type: 'mapClick', callback?: Callback<
mapCommon.LatLng
>): void
...
off(type: 'infoWindowClick', callback?: Callback<
Marker
>): void
...
'massPointOverlayClick'：监听海量点图层点击事件。
...
'massPointOverlayClick'：监听海量点图层点击退出事件。
