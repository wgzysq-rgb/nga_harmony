...
**DocID**: `985ec1a4cf64428da8d622c31f00b67c`

**NodeID**: `000201775795857640740855774d05fd`
...
用于表示一次骨骼点检测的完整结果。作为骨骼点检测的顶层输出，封装了一次检测的全部结果。继承自visionBase的
Response
。
