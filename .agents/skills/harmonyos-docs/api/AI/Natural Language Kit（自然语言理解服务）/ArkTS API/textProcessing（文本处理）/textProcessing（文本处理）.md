...
**Slug**: `natural-language-text-processing-api`

**DocID**: `5fc826766dbb4dfabc8c14c81ef99732`

**NodeID**: `000201775795857640706d44faaba49f`
...
还提供实体抽取功能，通过对用户输入的文本进行实体识别。然后依据Kit中的实体类别来进行分类，其中用户可以根据实体类别列表中的类别来进行选择。输出结果中包含实体的类别、实体在原文本中的位置、实体的原文本以及实体解析后的其他字段。实体字段内容可参考
EntityType
详情。
...
Promise对象，true表示初始化成功，false表示初始化失败。
...
Promise对象，true表示释放引擎成功，false表示释放引擎失败。
