...
**Slug**: `arkts-apis-camera-autoexposure`

**DocID**: `47c5deb83c3346459dcfec83b98bbde6`

**NodeID**: `000201775795910761112f421b9d381c`
...
获取当前曝光模式。接口调用失败会抛出相应错误码并返回undefined，错误码类型
CameraErrorCode
。
...
曝光模式。传参为null或者undefined，作为0处理，曝光锁定。
...
曝光点，x、y设置范围应在[0，1]之内，超过范围，如果小于0设置0，大于1设置1。
