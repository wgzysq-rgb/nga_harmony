...
**Slug**: `arkts-apis-camera-focus`

**DocID**: `344cb620311945609995a774d255ec53`

**NodeID**: `0002017757959107612871bf0a82ca77`
...
指定的焦距模式。传参为null或者undefined，作为0处理，手动对焦模式。
...
获取当前设备的焦距模式。接口调用失败会抛出相应错误码并返回undefined，错误码类型
CameraErrorCode
。
...
用于获取当前的焦点。接口调用失败会返回相应错误码，错误码类型为
CameraErrorCode
。
...
用于获取当前焦距，单位mm。接口调用失败会返回相应错误码，错误码类型
CameraErrorCode
。
