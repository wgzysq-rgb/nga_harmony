...
**Slug**: `arkts-apis-camera-stabilizationquery`

**DocID**: `24fcdf22ba9040a484aec3abfbb4e9bc`

**NodeID**: `000201775795910761363a48a3fe8b55`
...
返回视频防抖模式是否支持。true表示支持，false表示不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型
CameraErrorCode
。
