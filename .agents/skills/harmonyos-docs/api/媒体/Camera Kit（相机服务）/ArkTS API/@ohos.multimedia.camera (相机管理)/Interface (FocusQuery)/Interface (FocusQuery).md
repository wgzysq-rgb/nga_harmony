...
**Slug**: `arkts-apis-camera-focusquery`

**DocID**: `f312f0556c2e439f94be2eafec731729`

**NodeID**: `000201775795910761301c0cf180ea29`
...
检测对焦模式是否支持。true表示支持，false表示不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型
CameraErrorCode
。
