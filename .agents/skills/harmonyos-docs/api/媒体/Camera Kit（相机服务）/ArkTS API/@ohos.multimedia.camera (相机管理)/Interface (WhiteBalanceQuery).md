...
**Slug**: `arkts-apis-camera-whitebalancequery`

**DocID**: `a658319df20b470f89746ae8108ced8b`

**NodeID**: `0002017757959107613796edd3d8990a`
...
表示是否支持白平衡模式。true表示支持，false表示不支持。若接口调用失败，返回undefined。
...
用于获取手动白平衡值的可调范围，如[2800，10000]，单位为K（Kelvin，温度单位），实际情况根据底层能力返回为准。若接口调用失败，返回undefined。
