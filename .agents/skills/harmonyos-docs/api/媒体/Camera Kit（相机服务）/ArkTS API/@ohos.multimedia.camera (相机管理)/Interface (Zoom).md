...
**Slug**: `arkts-apis-camera-zoom`

**DocID**: `499cbb06066742a79d225a33cb491c26`

**NodeID**: `0002017757959107613812de35d26b27`
...
可变焦距比，通过
getZoomRatioRange
获取支持的变焦范围，如果设置超过支持范围的值，则只保留精度范围内数值。
...
获取当前的变焦比结果。接口调用失败会返回相应错误码，错误码类型
CameraErrorCode
。
