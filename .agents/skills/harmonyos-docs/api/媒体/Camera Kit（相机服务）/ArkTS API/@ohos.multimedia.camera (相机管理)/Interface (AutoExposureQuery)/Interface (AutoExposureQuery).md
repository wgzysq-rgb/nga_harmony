...
**DocID**: `26ba0e86f6914676b0867afe5f0c6f3c`

**NodeID**: `00020177579591076112195c5361b696`
...
获取是否支持曝光模式，true为支持，false为不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型
CameraErrorCode
。
