...
**Slug**: `scan-scanbarcode-api`

**DocID**: `78942990bcb640439dd19666504f7313`

**NodeID**: `0002017757959107619760ca7a33f0ca`
...
码识别角点位置信息，返回QR Code四个角点。此参数仅图像识码接口
...
回调函数。当扫码返回成功，err为undefined，data为获取到的扫码结果对象
ScanResult
；否则为错误对象。
