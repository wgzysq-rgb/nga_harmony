...
**DocID**: `57f7c1f82e9b42d9b29cb1d27191c7e9`

**NodeID**: `000201775795910761952f171767d855`
...
回调函数，当图片识码成功，err为undefined，data为获取到的识码结果Array<scanBarcode.
ScanResult
>，否则为错误对象。
