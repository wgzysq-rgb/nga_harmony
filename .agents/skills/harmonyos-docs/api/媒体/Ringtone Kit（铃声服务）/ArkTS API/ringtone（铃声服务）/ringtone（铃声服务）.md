...
**DocID**: `8e7ece2ff03943c0a2f956340be1a38a`

**NodeID**: `000201775795910761934bc54f4caa42`
...
Array<
uniformTypeDescriptor.UniformDataType
>
...
返回对应类型的铃声和文件支持的最大时长（单位：秒），其中闹钟铃声时长为300s，短信铃声和通知铃声时长为7s，来电铃声时长为60s。
