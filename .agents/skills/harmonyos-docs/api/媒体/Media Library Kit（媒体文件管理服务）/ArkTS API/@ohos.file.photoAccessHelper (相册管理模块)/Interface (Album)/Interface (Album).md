...
**Slug**: `arkts-apis-photoaccesshelper-album`

**DocID**: `0110479535754bfcbb1ff80648733595`

**NodeID**: `0002017757959107611903cf8aaa45db`
...
回调函数。当相册属性修改成功，err为undefined，否则为错误对象。
...
回调函数。当添加图片或视频成功，err为undefined，否则为错误对象。
...
回调函数。当移除图片或视频成功，err为undefined，否则为错误对象。
