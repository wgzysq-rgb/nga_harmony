...
**Slug**: `kts-apis-photoaccesshelper-mediaassetchangerequest`

**DocID**: `f548c793b81647b5bff36d3621b15cf8`

**NodeID**: `000201775795910761077da966ad9f7b`

---

Class (MediaAssetChangeRequest)

MediaAssetChangeRequest implements 
MediaChangeRequest
.
...
图片资产的数据来源，在应用沙箱下的uri。示例fileUri：'file://com.example.temptest/data/storage/el2/base/haps/entry/files/test.jpg'。
...
视频资产的数据来源，在应用沙箱下的uri。示例fileUri：'file://com.example.temptest/data/storage/el2/base/haps/entry/files/test.mp4'。
...
The uri format is incorrect or does not exist.
...
对于同一个资产变更请求，不支持在成功获取临时文��写句柄后，重复调用该接口。
...
待添加资源的数据来源，在应用沙箱下的uri。示例fileUri：'file://com.example.temptest/data/storage/el2/base/haps/entry/files/test.jpg'。
