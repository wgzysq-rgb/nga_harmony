...
**Slug**: `arkts-apis-photoaccesshelper-absalbum`

**DocID**: `a71edcce521c4ae286cda02664dff550`

**NodeID**: `0002017757959107611735f08f1de639`
...
回调函数。当获取相册中的文件成功，err为undefined，data为获取到的图片和视频数据结果集
FetchResult
；否则为错误对象。
