...
**Slug**: `arkts-apis-photoaccesshelper-movingphoto`

**DocID**: `0a457b34a47342038de8c5e58d316078`

**NodeID**: `0002017757959107612539a55c9cba3d`
...
通过picker的方式调用该接口来请求动态照片对象并读取内容，不需要申请'ohos.permission.READ_IMAGEVIDEO'权限，详情请参考
开发指南
。
...
待写入动态照片图片内容的uri。示例imageFileUri为："file://com.example.temptest/data/storage/el2/base/haps/ImageFile.jpg"。
...
待写入动态照片视频内容的uri。示例videoFileUri为："file://com.example.temptest/data/storage/el2/base/haps/VideoFile.mp4"。
...
通过picker调用接口请求动态照片对象并读取内容，不需要申请'ohos.permission.READ_IMAGEVIDEO'权限，详情请参考
开发指南
。
...
使用picker调用该接口请求动态照片对象并读取内容时，不需要申请'ohos.permission.READ_IMAGEVIDEO'权限，详情请参考
开发指南
。
...
Promise对象，返回包含所请求文件内容的ArrayBuffer。
