...
**Slug**: `arkts-apis-photoaccesshelper-photoviewpicker`

**DocID**: `8836670f9ee549929b78026eb2e674c1`

**NodeID**: `0002017757959107611181f59113afab`
...
photoPicker选择选项，若无此参数，则默认选择媒体文件类型为图片和视频类型，默认选择媒体文件数量的最大值为50。
...
Scene parameters validate failed, possible causes:1. An illegal enumeration value was passed to PhotoSelectOptions.globalMovingPhotoState.
