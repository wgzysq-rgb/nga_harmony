...
**DocID**: `9a93f932ea8d4c828fe99f5287447aaf`

**NodeID**: `000201775795910761975fb4d0c71c60`
...
photoAccessHelper.MovingPhoto

否

否

支持媒体库MovingPhoto数据源，具体信息详见
MovingPhoto
说明。
...
一个MovingPhotoViewController对象可以控制一个MovingPhotoView，可用视频播放实例请参考
