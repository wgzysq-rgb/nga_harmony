...
**Slug**: `ohos-file-recentphotocomponent`

**DocID**: `349d40fc168d44f69470e8790152ff21`

**NodeID**: `0002017757959107619676a6d33ba053`
...
最近图片/视频的拍摄时间，单位为毫秒。（距1970年1月1日的毫秒数值）。
...
查询最近图片是否存在，true为存在，false为不存在，默认为true。
