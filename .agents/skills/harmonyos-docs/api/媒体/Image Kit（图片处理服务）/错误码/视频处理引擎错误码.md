...
**Slug**: `errorcode-videoprocessingengine`

**DocID**: `ad16df75011c4086a483bfcea5182c74`

**NodeID**: `000201775795910761958d51591b2c67`
...
输入或输出图像缓冲区无效：图像缓冲区宽度（高度）过大或色彩空间不正确。

参数无效：参数不包含有效信息（例如，算法档位不正确）。
