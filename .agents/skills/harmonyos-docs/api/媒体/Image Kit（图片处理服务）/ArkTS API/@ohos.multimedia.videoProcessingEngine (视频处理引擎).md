...
**DocID**: `4595c5d09dc54894afd9f88bec6e456a`

**NodeID**: `000201775795910761966c5a21a88661`
...
Capability not supported. Function initializeEnvironment can not work correctly due to limited device capabilities.
...
Capability not supported. Function create can not work correctly due to limited device capabilities.
...
当level为HIGH时，支持范围[512, 2000]；当level为其他��，支持范围[32, 3000]。
...
算法档位（HIGH、MEDIUM、LOW、NONE），默认为NONE。
...
Capability not supported. Function enhanceDetail can not work correctly due to limited device capabilities.
...
Capability not supported. Function enhanceDetailSync can not work correctly due to limited device capabilities.
