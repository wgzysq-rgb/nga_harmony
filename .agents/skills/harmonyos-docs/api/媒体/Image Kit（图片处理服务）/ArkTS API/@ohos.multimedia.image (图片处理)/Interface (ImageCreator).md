...
**Slug**: `arkts-apis-image-imagecreator`

**DocID**: `1ed43cdd04504ebfae08ec636693be0b`

**NodeID**: `0002017757959107611054a715c14b96`
...
创建ImageCreator实例，ImageCreator不支持多线程。
...
回调函数，当获取最新图片成功，err为undefined，data为获取到的最新图片；否则为错误对象。
...
回调函数，当将图片放入队列成功，err为undefined，否则为错误对象。
...
回调函数，当监听事件触发成功，err为undefined，否则为错误对象。
...
回调函数。当移除注册成功时，err返回null，否则为错误对象。
...
回调函数，当图像释放成功，err为undefined，否则为错误对象。
