...
**DocID**: `b15a5cf3adeb4be9a637d4c8c01db6a1`

**NodeID**: `000201775795910761051ea28c05e0a7`
...
在调用AuxiliaryPicture的方法前，需要通过
image.createAuxiliaryPicture
或Picture的
getAuxiliaryPicture
创建一个AuxiliaryPicture实例。

由于图片占用内存较大，所以当AuxiliaryPicture对象使用完成后，应主动调用
release
