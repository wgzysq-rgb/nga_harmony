...
**DocID**: `267a391055c44c969f441be4480bac10`

**NodeID**: `000201775795910761313e909dfc64fb`
...
色彩空间转换包括单层HDR图片转换SDR图片，SDR图片之间的转换，以及SDR图片转换单层HDR图片，部分能力由厂商支持。使用
...
包括从双层HDR图片转换为单层HDR图片的能力。部分能力由厂商支持。使用
...
包括从单层HDR图片转换为双层HDR图片的能力。部分能力由厂商支持。使用
OH_ImageProcessing_IsDecompositionSupported
查询是否支持从单层HDR图片到双层HDR图片的转换。
...
生成单层HDR图片的HDR Vivid元数据。该能力由厂商支持。如果不支持该能力，
OH_ImageProcessing_Create
将返回
...
[h2]ImageDetailEnhancer_QualityLevel
...
当前处理不支持，可以通过“OH_ImageProcessing_IsXXXSupported”接口查询是否支持该能力。
