...
**DocID**: `3ae21ab2c1c54512bd69c875af848ae5`

**NodeID**: `0002017757959107612015777f250f28`
...
表明JavaScript native层ImagePacker对象的指针。
...
表明JavaScript native层ImagePacker对象。
...
表明指向native层ImagePacker的指针。

napi_value source

表明待编码JavaScript native层PixelMap对象或者ImageSource对象。
...
表明native层ImagePacker_Native值的指针。
