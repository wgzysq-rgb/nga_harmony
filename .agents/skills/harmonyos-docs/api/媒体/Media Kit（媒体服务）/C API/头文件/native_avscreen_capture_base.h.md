...
**DocID**: `b710be68772048cb96defd285a5a93a0`

**NodeID**: `000201775795910761240fec1045ee84`
...
[h2]OH_AVScreenCaptureStateCode
...
[h2]OH_AVScreenCaptureBufferType
...
[h2]OH_AVScreenCaptureFilterableAudioContent
...
[h2]OH_AVScreenCaptureContentChangedEvent
...
[h2]OH_AVScreenCapture_FillMode
...
[h2]OH_ScreenCaptureHighlightMode
...
[h2]OH_AVScreenCaptureOnAudioBufferAvailable()
...
音频缓存区是否可用。true表示音频缓存区可用，false表示音频缓存区不可用。
...
[h2]OH_AVScreenCaptureOnVideoBufferAvailable()
...
视频缓存区是否可用。true表示视频缓存区可用，false表示视频缓存区不可用。

[h2]OH_AVScreenCapture_OnStateChange()
...
指向应用设置该回调处理方法时提供的自定义数据的指针。

[h2]OH_AVScreenCapture_OnError()
...
[h2]OH_AVScreenCapture_OnBufferAvailable()
...
指向OH_AVBuffer缓存区实例的指针，该回调方法执行结束返回后，数据缓存区不再有效。
...
[h2]OH_AVScreenCapture_OnDisplaySelected()
...
[h2]OH_AVScreenCapture_OnCaptureContentChanged()
...
[h2]OH_AVScreenCapture_OnUserSelected()
