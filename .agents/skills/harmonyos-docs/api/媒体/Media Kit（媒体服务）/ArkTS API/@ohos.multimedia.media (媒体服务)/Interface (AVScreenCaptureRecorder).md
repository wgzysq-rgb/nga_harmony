...
**DocID**: `5edf12f9c2c84dae8f044037eda522bc`

**NodeID**: `0002017757959107611394a12dfab297`
...
需要豁免隐私的窗口列表，包括主窗口id和子窗口id，窗口属性获取方法可以参考
getWindowProperties
。
...
麦克风开关控制，true代表麦克风打开，false代表麦克风关闭。
...
需要在Picker中隐藏的窗口列表，窗口属性获取方法可以参考
getWindowProperties
。
