...
**Slug**: `arkts-apis-media-audioplayer`

**DocID**: `9deeb83dc65940b9ad80d3670c920121`

**NodeID**: `000201775795910761260b160fda583f`
...
回调函数。获取音频轨道信息成功时，err为undefined，data为获取到的MediaDescription数组，否则为错误对象。
