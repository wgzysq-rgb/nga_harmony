...
**Slug**: `arkts-apis-media-avmetadataextractor`

**DocID**: `66a3d18c612a410c8b71fb93b4062fa2`

**NodeID**: `0002017757959107610764df5b44e609`
...
Operation not allowed. Returned by promise.
...
Operation not allowed. Returned by callback.

5400106

Unsupported format. Returned by callback.
...
Promise对象。异步返回音视频元数据对象（AVMetadata）。
...
回调函数。当释放资源成功，err为undefined，否则为错误对象。
