...
**Slug**: `arkts-apis-avsession-e`

**DocID**: `ec9ae496d1994e36910b3ab3c9d0045f`

**NodeID**: `000201775795910761169733211e7128`
...
分辨率为480P(640*480 dpi)。

RESOLUTION_720P

1

分辨率为720P(1280*720 dpi)。

RESOLUTION_1080P

2

分辨率为1080P(1920*1080 dpi)。

RESOLUTION_2K

3

分辨率为2k(2560*1440 dpi)。

RESOLUTION_4K

4

分辨率为4k(4096*3840 dpi)。
...
ERR_CODE_CAST_CONTROL_PLAYER_NOT_WORKING
13+
...
ERR_CODE_CAST_CONTROL_ILLEGAL_SEEK_TARGET
13+
...
ERR_CODE_CAST_CONTROL_PLAY_SPEED_UNSUPPORTED
13+
...
ERR_CODE_CAST_CONTROL_INVALID_PARAM
13+
...
ERR_CODE_CAST_CONTROL_OPERATION_NOT_ALLOWED
13+
...
ERR_CODE_CAST_CONTROL_IO_NETWORK_CONNECTION_FAILED
13+
...
ERR_CODE_CAST_CONTROL_IO_INVALID_HTTP_CONTENT_TYPE 
13+
...
ERR_CODE_CAST_CONTROL_IO_FILE_NOT_FOUND
13+
...
ERR_CODE_CAST_CONTROL_IO_NO_CONTENTS
13+
...
ERR_CODE_CAST_CONTROL_IO_CONTENT_BUSY
13+
...
ERR_CODE_CAST_CONTROL_IO_USE_FORBIDDEN
13+
...
ERR_CODE_CAST_CONTROL_PARSING_UNSPECIFIED
13+
...
ERR_CODE_CAST_CONTROL_PARSING_MANIFEST_MALFORMED
13+
...
ERR_CODE_CAST_CONTROL_PARSING_MANIFEST_UNSUPPORTED
13+
...
ERR_CODE_CAST_CONTROL_DECODING_INIT_FAILED
13+
...
ERR_CODE_CAST_CONTROL_AUDIO_RENDERER_INIT_FAILED 
13+
...
ERR_CODE_CAST_CONTROL_DRM_LICENSE_ACQUISITION_FAILED
13+
