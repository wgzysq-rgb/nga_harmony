...
**DocID**: `158ce24caa694045a7b26e4e299e2d88`

**NodeID**: `000201775795910761053631ed7c345f`
...
创建AVCastPickerHelper对象，获取context参考
getHostContext
。
...
AVCastPicker选择选项。无此参数时，以AVCastPickerOptions默认值拉起。
...
事件回调类型，支持事件'pickerStateChange'：当半模态窗口变化时，触发该事件。
...
取消对应的监听事件，支持事件'pickerStateChange'。
