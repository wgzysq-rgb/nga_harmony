...
**DocID**: `9f721634b40f45ebbc3fe213c4bef09a`

**NodeID**: `0002017757959107611074087d44a9b7`
...
查询指定的source type是否支持回声消除的结果。true表示支持回声消除，false表示不支持回声消除。
...
返回true时表示支持低时延播放，返回false时表示不支持。
...
返回true时表示支持低时延录制，返回false时表示不支持。
...
返回true时表示智能降噪开关已打开，返回false时表示开关已关闭。
