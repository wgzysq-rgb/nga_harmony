...
**DocID**: `bb585834f17045aca7ca60b3852bb280`

**NodeID**: `000201775795910761242fcd37dbd07f`
...
[h2]Demuxer_MediaKeySystemInfoCallback()
...
[h2]OH_AVDemuxer_SelectTrackByID()
...
[h2]OH_AVDemuxer_UnselectTrackByID()
...
指向OH_AVMemory实例的指针，用于储存压缩帧数据。

OH_AVCodecBufferAttr
 *info

指向OH_AVCodecBufferAttr实例的指针，用于储存压缩帧的相关信息。
...
[h2]OH_AVDemuxer_ReadSampleBuffer()
...
指向OH_AVBuffer实例的指针，用于储存压缩帧数据以及相关信息。
...
期望跳转位置对应的时间，单位为ms，该时间戳是相对文件开始的位置。
...
[h2]OH_AVDemuxer_SetMediaKeySystemInfoCallback()
...
[h2]OH_AVDemuxer_SetDemuxerMediaKeySystemInfoCallback()
...
[h2]OH_AVDemuxer_GetMediaKeySystemInfo()
