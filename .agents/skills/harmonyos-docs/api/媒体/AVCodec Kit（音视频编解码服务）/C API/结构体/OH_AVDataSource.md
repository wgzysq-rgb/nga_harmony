...
> **分区**: API参考  |  **Slug**: `capi-codecbase-oh-avdatasource`  |  **DocID**: `abe534d41c3a41a0be26eeacafc8b072`
 ...
 **所在头文件：** [native_avcodec_base.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-avcodec-base-h)
 ...
 名称 描述   int64_t size 数据源的总大小。  [OH_AVDataSourceReadAt](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-avcodec-base-h#oh_avdatasourcereadat) readAt 数据源的数据回调。
