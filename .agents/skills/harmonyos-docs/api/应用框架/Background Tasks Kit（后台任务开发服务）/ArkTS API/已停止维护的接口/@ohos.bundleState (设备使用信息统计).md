...
**Slug**: `js-apis-deviceusagestatistics`

**DocID**: `8b676a76a559405792efc162158b26b1`

**NodeID**: `000201775796216196624d42f06e1562`
...
指定的callback回调方法。如果指定的bundleName有效，则返回指定bundleName的应用当前是否是空闲状态；否则返回null。
