...
**DocID**: `57407d68c03d4b788525c037d8bbc5db`

**NodeID**: `000201775796216197837caa5428cae1`
...
[h2]OH_Cursor_GetFloatVectorCount()
...
表示结果集中指定列的索引，索引值从0开始。

size_t *length

该参数是输出参数，结果集中指定列的浮点数数组大小会写入该变量。
...
该参数是输出参数，结果集中指定列的值会以浮点数数组形式写入该变量，调用者需要申请数组内存。
