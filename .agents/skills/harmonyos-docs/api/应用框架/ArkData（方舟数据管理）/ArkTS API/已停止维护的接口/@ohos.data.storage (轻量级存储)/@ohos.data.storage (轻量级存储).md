...
**Slug**: `js-apis-data-storage`

**DocID**: `e8298288aa024337ae7fda49e0e4d5c4`

**NodeID**: `000201775796216196667e9f4732df66`
...
检���存储对象是否包含名为给定key的存储。使用callback方式返回结果，此方法为异步方法。
