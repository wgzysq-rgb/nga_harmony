...
**DocID**: `55adfc6728a5482fa586dc1b5a562c65`

**NodeID**: `000201775796216196423df3ac2c323f`
...
sendableRelationalStore.fromSendableValues
20+
...
sendableRelationalStore.toSendableValues
20+
...
当字段类型是bigint时，在创建表的sql语句中，类型应当为：UNLIMITED INT，详见
通过关系型数据库实现数据持久化
。
...
并发场景的键值对数据存储，其中，键的类型为string，值的类型为ValueType。
