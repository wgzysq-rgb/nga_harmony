...
**Slug**: `js-apis-data-uniformdatastruct`

**DocID**: `faac64d749e346298c3a275530bac52d`

**NodeID**: `000201775796216196435dfc2b9e342a`
...
UniformDataType
对应的数据结构，方便不同应用间进行数据交互，减少数据类型适配的工作量。
...
统一数据类型标识，标识为纯文本类型数据，固定为“general.plain-text”，数据类型描述信息见
UniformDataType
。
