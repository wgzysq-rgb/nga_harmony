...
**Slug**: `js-apis-inputmethod-extension-context`

**DocID**: `fbdd325cca8e4b1abec66060a77c921f`

**NodeID**: `00020177579621619631999f5f438231`
...
回调函数。当销毁输入法应用成功时，err为undefined；否则为错误对象。
...
用于指定目标应用的Want类型信息，包括ability名称、bundle名称等。
