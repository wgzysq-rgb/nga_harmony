...
**DocID**: `8ab4348058b4455aba80ae3fc9eaf44b`

**NodeID**: `00020177579621619642996dbc6b29a8`
...
设备行为差异：
该组件在Phone、Tablet设备及上述特定设备形态下可正常使用，在其他设备中不可交互。
...
设备行为差异：
该接口在Phone、Tablet设备及上述特定设备形态下可正常使用，在其他设备中不可交互。
