...
> **分区**: API参考  |  **Slug**: `arkts-basic-components-web-webkeyboardcontroller`  |  **DocID**: `561800290e07427d8592f7b8d74538fa`
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   text string 是 向Web输入框插入字符。       #### deleteForward12+
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   length number 是 从后往前删除Web输入框中指定长度的字符。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   length number 是 从前往后删除Web输入框中指定长度的字符。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   key number 是 向Web输入框传递功能键，目前仅支持Enter键。       #### close12+
