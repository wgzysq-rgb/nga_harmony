...
**DocID**: `a1056fbc1d634fb1955c1c5887fd8f40`

**NodeID**: `00020177579621619712764d8c334814`
...
Controller相关的Native API结构体。在调用接口前建议通过
...
注��JavaScript对象到window对象中，并在window对象中调用该对象的异步方法。
