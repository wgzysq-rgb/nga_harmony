...
**Slug**: `arkts-apis-web-webnativemessagingextensioncontext`

**DocID**: `b9bc08a48a754ae4b57f02345f6fd4f2`

**NodeID**: `000201775796216196376fb6a1ea511d`
...
Internal error. Possible causes: 1. Failed to connect to the system service; 2. The system service failed to communicate with dependency module.
