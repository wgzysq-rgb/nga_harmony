...
> **分区**: API参考  |  **Slug**: `arkts-apis-webview-jsmessageext`  |  **DocID**: `a2d013b0383c4c6096ec73f0e8899785`
 ...
 **返回值：**
  ...
  类型 说明   [JsMessageType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-e#jsmessagetype10) [runJavaScriptExt](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-webviewcontroller#runjavascriptext10)接口脚本执行后返回的结果的类型。       #### getString10+
 ...
 **返回值：**
 ...
 以下错误码的详细介绍请参见[Webview错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-webview)。
  ...
  错误码ID 错误信息   17100014 The type and value of the message do not match.       #### getErrorDescription22+
 ...
 **返回值：**
  ...
  类型 说明   string | null 若JavaScript脚本执行过程中发生异常，或返回值为object类型，系统会将其格式化为"Not support type: <{exception|object}>"字符串返回，该字符串长度不超过2048个字符，超长部分将被截断；若object对象中包含callback类型的成员，则序列化时将自动忽略该成员；其余情况，接口均返回null。
