...
**Slug**: `arkts-apis-webview-proxycontroller`

**DocID**: `5ceea4e77d4746afa07416a7afaeecaf`

**NodeID**: `000201775796216197061873cab9e37d`
...
设置应用中所有Web使用的代理配置，与
insertBypassRule
中插入的bypass规则匹配的URL将不会使用代理，而是直接向URL指定的源地址发起请求。代理设置成功后，不保证网络连接后会立即使用新的代理设置，在加载页面之前请等待监听器触发，这个监听器将在UI线程上被调用。
