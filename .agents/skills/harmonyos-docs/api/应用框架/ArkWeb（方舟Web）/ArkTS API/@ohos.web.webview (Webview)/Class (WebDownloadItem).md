...
**DocID**: `80088093dffe402eb3f2939d641e3f0b`

**NodeID**: `000201775796216197145c6d8408d478`
...
下载的媒体类型（例如，一个声音文件可能被标记为 audio/ogg ，一个图像文件可能是 image/png）。
...
下载文件的路径（包含文件名），路径长度与文件管理中长度一致，最长255字符。
