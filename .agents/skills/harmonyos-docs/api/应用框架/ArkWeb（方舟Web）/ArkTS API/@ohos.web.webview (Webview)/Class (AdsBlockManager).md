...
**Slug**: `arkts-apis-webview-adsblockmanager`

**DocID**: `e448b330fa394007ad1c10871d6b1dcf`

**NodeID**: `000201775796216196681ba2b2974ca3`
...
指定了符合easylist通用语法的规则文件路径，应用需要有此文件的读权限。
...
true表示强制替换掉内置的默认规则，false表示设置的自定义规则将与内置规则共同工作。
...
一组域名列表，例如['example.com', 'abcd.efg.com']
