...
> **分区**: API参考  |  **Slug**: `arkts-apis-webview`  |  **DocID**: `e9fa1ae4370d46c88a09b1aaac32520d`
...
# 模块描述
    ...
    元服务中使用ArkWeb的说明，请参考[Web组件概述](https://developer.huawei.com/consumer/cn/doc/atomic-guides/atomicserviceweb-guidelines)。
     ...
     - [BackForwardCacheSupportedFeatures](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/kts-apis-webview-backforwardcachesupportedfeatures)：设置前进后退缓存配置所支持的特性。
     ...
     import { webview } from '@kit.ArkWeb';     **系统能力：** SystemCapability.Web.Webview.Core
