...
**DocID**: `e61a0092231d4dbcbe465864f1a5e3a8`

**NodeID**: `000201775796216197246c2bb3e08d83`

---

Interface (WebMessagePort)

通过WebMessagePort可以进行消息的发送以及接收，发送
WebMessageType
/
WebMessage
类型消息给HTML5侧。
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的
WebMessage
类型消息。完整示例代码参考
postMessage
。
...
不需要发送消息时关闭该消息端口。在使用close前，请先使用
