...
**Slug**: `js-apis-inner-application-appstatedata`

**DocID**: `ddddaab8d5774159bc543dfe891b5b4e`

**NodeID**: `0002017757962161976763a235abbea0`
...
定义应用状态信息，使用接口
on
注册应用状态变化监听后，当应用、进程或组件的状态变化时，系统通过
