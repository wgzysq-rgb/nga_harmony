...
> **分区**: API参考  |  **Slug**: `js-apis-app-ability-datauriutils`  |  **DocID**: `760bf5ce58bd412e8d91437b15f80d2c`
...
```
     ...
     **参数：**
                                   ...
                                   参数名         类型         必填         说明                                       uri         string         是         表示uri对象。                               **返回值：**

                                   类型         说明                                       number         返回uri路径末尾的ID。                               **错误码**：
...
```
     ...
     **参数：**
                                   ...
                                   参数名         类型         必填         说明                                       uri         string         是         表示uri对象。                         id         number         是         表示要附加的ID。                               **返回值：**

                                   类型         说明                                       string         返回附加ID之后的uri对象。                               **错误码**：
...
```
     ...
     **参数：**
                                   ...
                                   参数名         类型         必填         说明                                       uri         string         是         表示要从中删除ID的uri对象。                               **返回值：**

                                   类型         说明                                       string         返回删除ID之后的uri对象。                               **错误码**：
...
```
     ...
     **参数：**
                                   ...
                                   参数名         类型         必填         说明                                       uri         string         是         表示uri对象                         id         number         是         表示要更新的ID                               **返回值：**

                                   类型         说明                                       string         返回更新ID之后的uri对象。                               **错误码**：
