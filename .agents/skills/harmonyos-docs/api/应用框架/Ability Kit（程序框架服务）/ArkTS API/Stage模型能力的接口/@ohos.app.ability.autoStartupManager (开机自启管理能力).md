...
**DocID**: `0e87a20bea9348c2b6a6690e09c8d7fd`

**NodeID**: `00020177579621619727949e608d866b`
...
Promise对象。返回true表示当前应用已被用户设置为开机自启动，false表示当前应用未被用户设置为开机自启动。
...
Internal error. Possible causes: 1. Connect to system service failed; 2.System service failed to communicate with dependency module.
