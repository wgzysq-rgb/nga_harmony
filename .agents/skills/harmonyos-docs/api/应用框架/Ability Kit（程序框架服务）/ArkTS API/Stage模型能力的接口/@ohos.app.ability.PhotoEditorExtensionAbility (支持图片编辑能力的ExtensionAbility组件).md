...
**DocID**: `8d5d4c9c4f9f4b46ba37ff239dbeddd4`

**NodeID**: `0002017757962161972293185c4c6a6e`
...
ExtensionAbility
，开发者可通过PhotoEditorExtensionAbility实现图片编辑扩展页面。应用通过
startAbilityByType
...
PhotoEditorExtensionAbility的上下文，提供保存图片能力。
...
待编辑的原始图片
uri
，格式为file://<bundleName>/<sandboxPath>。
...
当前PhotoEditorExtensionAbility的Want类型信息，包括ability名称、bundle名称等。
...
PhotoEditorExtensionAbility界面内容相关信息。
