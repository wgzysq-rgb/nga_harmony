...
**Slug**: `js-apis-app-ability-autofillmanager`

**DocID**: `56e1aecd939343a8b7d46a60f582a218`

**NodeID**: `000201775796216197975c1530e6fcef`
...
示例中从AppStorage中取得的UiContext为预先在EntryAbility（拉起此页面的Ability）中OnWindowStageCreate生命周期获得，并存储到AppStorage中，具体可参考
requestAutoSave
。
...
The parameter check failed. Possible causes: 1. Get instance id failed; 2. Parse instance id failed; 3. The second parameter is not of type callback.
