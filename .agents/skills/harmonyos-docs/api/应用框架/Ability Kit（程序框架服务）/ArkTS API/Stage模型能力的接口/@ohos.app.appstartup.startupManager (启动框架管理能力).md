...
**DocID**: `79c74705ab564fa198553689f1636aab`

**NodeID**: `000201775796216197273ae1cbbbdc33`
...
表示启动任务配置信息，包含启动框架超时时间与启动任务监听器配置。
...
返回布尔值，true表示该启动任务或so预加载任务已执行完成，false表示该启动任务或so预加载任务尚未执行完成。
