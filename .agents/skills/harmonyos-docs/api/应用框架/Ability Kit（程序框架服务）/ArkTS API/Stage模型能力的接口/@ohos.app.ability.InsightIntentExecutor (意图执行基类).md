...
**DocID**: `13df8b1a81d942d091ade5e97a23825e`

**NodeID**: `0002017757962161972247456455d8ce`

---

@ohos.app.ability.InsightIntentExecutor (意图执行基类)

本模块提供意图执行基类，开发者通过本模块对接端侧
意图框架
，
通过配置文件开发意图
实现意图的业务逻辑。
...
返回意图执行结果或返回带有意图执行结果的Promise对象，表示本次意图执行返回给系统入口的数据。
