...
**Slug**: `js-apis-app-ability-applicationstatechangecallback`

**DocID**: `3f4e1bf6fe634fd88dd8934cfbb86961`

**NodeID**: `00020177579621619791343501a3af1f`
...
该模块仅支持监听当前进程的前后台状态变化。如果需要监听整个应用的前后台状态变化，可使用
