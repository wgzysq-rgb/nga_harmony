...
**Slug**: `js-apis-app-ability-childprocessargs`

**DocID**: `d0461c7f789741d588a4928fe2d64dc4`

**NodeID**: `000201775796216197047db5b3bf0f01`
...
传递到子进程的参数。
childProcessManager
启动子进程时，可以通过ChildProcessArgs传递参数到子进程中。
...
开发者自定义参数，透传到子进程中。可以在
ChildProcess.onStart
方法中通过args.entryParams获取，entryParams支持传输的最大数据量为150KB。
