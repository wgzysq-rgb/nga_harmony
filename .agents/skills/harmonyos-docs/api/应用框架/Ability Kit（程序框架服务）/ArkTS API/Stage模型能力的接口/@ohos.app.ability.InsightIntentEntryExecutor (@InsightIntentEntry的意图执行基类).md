...
**DocID**: `7d6deeaa86f64a348ca03694a035946c`

**NodeID**: `000201775796216197217525a60543f4`
...
- 若UIAbility冷启动，意图执行时UIAbility生命周期触发顺序：
onCreate
、
onWindowStageCreate
、onExecute、
...
- 若UIAbility热启动，且启动时UIAbility处于后台，意图执行时UIAbility生命周期触发顺序：
onNewWant
、onExecute、
onForeground
。
