...
**Slug**: `js-apis-app-ability-openlinkoptions`

**DocID**: `fd532cc849174bcf8b3e6e80441e8878`

**NodeID**: `000201775796216197237b9ded2bd2de`
...
OpenLinkOptions可以作为
openLink()
的入参，用于标识是否仅打开AppLinking和传递键值对可选参数。
...
说明
：appLinkingOnly字段为true时不会触发Deep Linking流程，该字段不会生效。
