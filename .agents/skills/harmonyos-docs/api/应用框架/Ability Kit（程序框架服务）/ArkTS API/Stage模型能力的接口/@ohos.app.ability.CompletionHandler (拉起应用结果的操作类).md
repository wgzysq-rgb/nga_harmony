...
**Slug**: `js-apis-app-ability-completionhandler`

**DocID**: `b809331a0717420e8f5e3c82bea0b5f1`

**NodeID**: `0002017757962161970985256f2ccfe7`
...
ElementName信息用于标识被拉起应用。通常，ElementName仅包含abilityName和bundleName。moduleName和deviceId信息是否存在取决于调用方是否传入。shortName和uri为空。
