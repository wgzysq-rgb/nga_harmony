...
**Slug**: `js-apis-app-ability-childprocessoptions`

**DocID**: `81994123f2cf470c8348ef77c74df8c4`

**NodeID**: `00020177579621619707424e5924e91e`
...
子进程的启动配置选项。通过
childProcessManager
启动子进程时，可以通过ChildProcessOptions配置子进程启动选项。
