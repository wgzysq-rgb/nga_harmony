...
**DocID**: `25f93bf1b0e24547b5568f5f2a2c0f60`

**NodeID**: `00020177579621619661166e270c05da`
...
setImageCacheCount方法需要在@Entry标记的页面，
onPageShow
或
aboutToAppear
里面设置才生效。

setImageCacheCount、setImageRawDataCacheSize、和setImageFileCacheSize并不灵活，后续不继续演进，对于复杂情况，更推荐使用
ImageKnife
。
...
setImageRawDataCacheSize方法需要在@Entry标记的页面，
onPageShow
或
aboutToAppear
里面设置才生效。
...
内存中解码前图片数据的缓存大小，单位为字节。number取值需大于0。
...
请求全屏时，设定非全屏到全屏的过渡时间，单位为毫秒，默认时间与非全屏到全屏的距离成正比。
