...
> **分区**: API参考  |  **Slug**: `arkts-apis-uicontext-uiinspector`  |  **DocID**: `2995bb0dd6c44bc59f6342f1812a3c77`
 ...
 **参数：**
  ...
  类型 说明   [inspector.ComponentObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-inspector#componentobserver) 组件回调事件监听句柄，用于注册和取消注册监听回调。     **示例：**
