...
**Slug**: `arkts-apis-uicontext-magnifier`

**DocID**: `954d15ac744342f7906855c9cb7339b2`

**NodeID**: `0002017757962161976890fb3745218f`
...
或
key
设置。当组件id为空字符串或未找到匹配id的组件时，不显示放大镜。
...
放大镜显示的组件内容相对组件水平方向坐标，单位为vp。当坐标值大于组件宽度或小于0时不显示放大镜；将值设为undefined时保持放大镜的当前显示状态。
...
放大镜显示的组件内容相对组件垂直方向坐标，单位为vp。当坐标值大于组件高度或小于0时不显示放大镜；将值设为undefined时保持放大镜的当前显示状态。
