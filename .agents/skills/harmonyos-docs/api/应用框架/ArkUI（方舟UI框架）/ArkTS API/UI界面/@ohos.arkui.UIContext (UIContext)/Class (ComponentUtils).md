...
**Slug**: `arkts-apis-uicontext-componentutils`

**DocID**: `b71b2c75e2d1471cb919c4113dd98aaa`

**NodeID**: `000201775796216197540e1b13c838b1`
...
该接口需要在目标组件布局、完成以后获取目标组件区域大小信息，建议在
onAppear
中使用该接口。
