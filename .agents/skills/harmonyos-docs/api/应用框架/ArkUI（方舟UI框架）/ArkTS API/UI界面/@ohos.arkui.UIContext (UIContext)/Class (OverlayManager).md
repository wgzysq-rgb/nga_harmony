...
**Slug**: `arkts-apis-uicontext-overlaymanager`

**DocID**: `0db73774fb2c493ea6962bc8343908d9`

**NodeID**: `000201775796216197716a5cb41270ed`
...
getOverlayManager()
方法获取到OverlayManager对象，再通过该对象调用对应方法。
...
在OverlayManager上删除此content。

示例：

请参考
addComponentContent示例
。
