...
> **分区**: API参考  |  **Slug**: `js-apis-curve`  |  **DocID**: `4d2edab398614d10b60983057d3cb230`
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   count number 是 阶梯的数量，需要为正整数。
 ...
 **说明：** 
 ...
 设置小于1的值时，按值为1处理。
   ...
   end boolean 是 在每个间隔的起点或终点发生阶跃变化。
 ...
 -false：在起点发生阶跃变化。
  ...
  类型 说明   [ICurve](#icurve9) 曲线的插值对象。     **示例：**
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   x1 number 是 确定贝塞尔曲线第一点横坐标。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   velocity number 是 初始速度。是由外部因素对弹性动效产生的影响参数，其目的是保证对象从之前的运动状态平滑地过渡到弹性动效。该速度是归一化速度，其值等于动画开始时的实际速度除以动画属性改变值。
 ...
 **说明：** 
 ...
 设置的值小于等于0时，按1处理。
   ...
   damping number 是 阻尼。用于描述系统在受到扰动后震荡及衰减的情形。阻尼越大，弹性运动的震荡次数越少、震荡幅度越小。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   response number 否 弹簧自然振动周期，决定弹簧复位的速度。
 ...
 **说明：** 
 ...
 弹性动画曲线为物理曲线，[animation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-animatorproperty)、[animateTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-explicit-animation)、[pageTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-page-transition-animation)中的duration参数不生效，动画持续时间取决于springMotion动画曲线参数和之前的速度。时间不能归一，故不能通过该曲线的interpolate函数获得插值。

      **返回值：**

  类型 说明   [ICurve](#icurve9) 曲线对象。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   response number 否 解释同springMotion中的response。
 ...
 **说明：** 
 ...
 设置小于等于0的值时，按默认值0.15处理。

   dampingFraction number 否 解释同springMotion中的dampingFraction。
 ...
 **说明：** 
 ...
 设置小于0的值时，按默认值0.86处理。
   ...
   overlapDuration number 否 解释同springMotion中的overlapDuration。
 ...
 **说明：** 
 ...
 [animation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-animatorproperty)、[animateTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-explicit-animation)、[pageTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-page-transition-animation)中的duration参数不生效，动画持续时间取决于responsiveSpringMotion动画曲线参数和之前的速度，也不能通过该曲线的interpolate函数获得插值。
 ...
 **说明:** 
 ...
 2、[animation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-animatorproperty)、[animateTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-explicit-animation)、[pageTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-page-transition-animation)中的duration参数不生效，动画持续时间取决于responsiveSpringMotion动画曲线参数和之前的速度，也不能通过该曲线的[interpolate](#interpolate9)函数获得插值。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   velocity number 是 初始速度。外部因素对弹性动效产生的影响参数，目的是保证对象从之前的运动状态平滑地过渡到弹性动效。该速度是归一化速度，其值等于动画开始时的实际速度除以动画属性改变值。
 ...
 **说明:** 弹性动画曲线为物理曲线，[animation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-animatorproperty)、[animateTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-explicit-animation)、[pageTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-page-transition-animation)中的duration参数不生效，动画持续时间取决于interpolatingSpring动画曲线参数。时间不能归一，故不能通过该曲线的[interpolate](#interpolate9)函数获得插值。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   interpolate (fraction: number) => number 是 用户自定义的插值回调函数。
 ...
 **说明：**
 ...
 fraction等于1时，返回值为1对应动画终点，返回值不为1将导致动画的终值不是状态变量的值，出现大于或者小于状态变量值，再跳变到状态变量值的效果。
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   fraction number 是 当前的归一化时间参数。
 ...
 **说明：** 
 ...
 设置的值小于0时，按0处理；设置的值大于1时，按1处理。
  ...
  类型 说明   number 返回归一化time时间点对应的曲线插值。     **示例：**
 ...
 **参数：**
 ...
 默认值：Curve.Linear
  ...
  类型 说明   string 返回插值曲线对象。       #### curves.steps(deprecated)
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   count number 是 阶梯的数量，需要为正整数。  end boolean 是 在每个间隔的起点或是终点发生阶跃变化。
 ...
 -false：在起点发生阶跃变化。
  ...
  类型 说明   string 返回阶梯曲线对象。       #### curves.cubicBezier(deprecated)
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   x1 number 是 确定贝塞尔曲线第一点横坐标。  y1 number 是 确定贝塞尔曲线第一点纵坐标。  x2 number 是 确定贝塞尔曲线第二点横坐标。  y2 number 是 确定贝塞尔曲线第二点纵坐标。     **返回值：**

  类型 说明   string 返回三阶贝塞尔曲线对象。       #### curves.spring(deprecated)
 ...
 **参数：**
  ...
  参数名 类型 必填 说明   velocity number 是 初始速度。是由外部因素对弹性动效产生的影响参数，其目的是保证对象从之前的运动状态平滑地过渡到弹性动效。  mass number 是 质量。弹性系统的受力对象，会对弹性系统产生惯性影响。质量越大，震荡的幅度越大，恢复到平衡位置的速度越慢。  stiffness number 是 刚度。是物体抵抗施加的力而形变的程度。在弹性系统中，刚度越大，抵抗变形的能力越强，恢复到平衡位置的速度就越快。  damping number 是 阻尼。是一个纯数，无真实的物理意义，用于描述系统在受到扰动后震荡及衰减的情形。阻尼越大，弹性运动的震荡次数越少、震荡幅度越小。     **返回值：**

  类型 说明   string 返回弹簧曲线对象。       #### 整体示例
