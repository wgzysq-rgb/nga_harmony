...
**DocID**: `1fc22f0fb9ac4f0b8cbd6e3ebc971de5`

**NodeID**: `0002017757962161979589bb2b03910e`
...
异步执行时返回Promise对象，同步执行时无返回值。Promise仅表示操作完成，无实际返回内容。
