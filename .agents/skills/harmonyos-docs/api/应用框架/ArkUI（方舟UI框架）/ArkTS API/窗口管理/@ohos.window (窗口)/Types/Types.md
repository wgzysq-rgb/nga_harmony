...
> **分区**: API参考  |  **Slug**: `arkts-apis-window-t`  |  **DocID**: `66630e42d376469199a10878fd57addb`
...
# Types
     ...
     **元服务API：** 从API version 11开始，该接口支持在元服务中使用。
                                   ...
                                   类型         说明                                       'status'         状态栏。                         'navigation'                   HarmonyOS各设备不支持此能力。

          三键导航栏。

                         'navigationIndicator'         底部导航。根据用户设置，可表现为导航条或三键导航栏。                                            #### WindowAnimationCurveParam20+
     ...
     **系统能力：** SystemCapability.Window.SessionManager
                                   ...
                                   类型         说明                                       Array<number>         表示值类型为数字数组，元素取值范围见对应曲线描述。                               当曲线类型为LINEAR，动画曲线参数选填，且不生效。
     ...
     **参数：**
                                   ...
                                   参数名         类型         必填         说明                                       info         T         是         回调函数调用时系统传入[RotationChangeInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-i#rotationchangeinfo19)类型的参数。                               **返回值：**

                                   类型         说明                                       U         回调函数需要返回[RotationChangeResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-i#rotationchangeresult19) | void类型的返回值。
