...
**DocID**: `69ee36677a2a46459794e44457ade94e`

**NodeID**: `000201775796216197570bf7bcd0017b`
...
string类型可选值：可以转化为数字的字符串（如'10'）或带长度单位的字符串（如'10px'）或'auto'，不允许设置百分比字符串。
...
/
size
）时仍遵守默认布局行为，在主轴上自适应子组件尺寸，此时flexShrink不生效。
...
GridCol
可以绑定alignSelf属性来改变它自身在交叉轴方向上的布局。
