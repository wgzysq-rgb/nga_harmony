...
**DocID**: `bae2b0870157419a9f071cf71403231f`

**NodeID**: `000201775796216197562132336451f2`
...
组件的属性类，用来区别不同组件自定义内容区后所需要的不同信息，比如Button组件的ButtonConfiguration，Checkbox组件的CheckBoxConfiguration等。
