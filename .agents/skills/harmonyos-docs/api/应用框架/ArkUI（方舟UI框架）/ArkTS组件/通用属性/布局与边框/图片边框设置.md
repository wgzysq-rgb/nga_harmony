...
**DocID**: `eed257d5f1bb4a6097c2656656b49161`

**NodeID**: `0002017757962161976693cad9a43107`
...
边框图源或者渐变色设置。参数类型为string类型时，用于设置边框图源，引用方式请参考
加载图片资源
。
