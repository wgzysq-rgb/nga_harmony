...
**DocID**: `380075bce3e04ab984be3c8c42604430`

**NodeID**: `00020177579621619761698220245a98`
...
当color的值为undefined时，维持之前取值或组件默认取值，具体行为不同组件可能会有差异，建议开发者使用确定颜色或
ColoringStrategy
。
