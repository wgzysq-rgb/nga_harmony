...
**DocID**: `e462f649621f456689dd4efd752b7625`

**NodeID**: `000201775796216197573fdcbe8f6b64`
...
拖拽排序数据移动回调。当父容器组件为
List
，并且ForEach/LazyForEach/Repeat每次迭代都生成一个ListItem组件时才生效。设置拖拽排序时可以定义不同的拖拽操作，并在响应事件发生时响应。与
onMove
