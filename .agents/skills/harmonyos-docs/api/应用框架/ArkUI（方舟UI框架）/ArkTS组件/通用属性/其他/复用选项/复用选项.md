...
> **分区**: API参考  |  **Slug**: `ts-universal-attributes-reuse`  |  **DocID**: `9656518074f0420aa1d9af5738a580ba`
...
# 复用选项
     ...
     **参数：**
                                   ...
                                   参数名         类型         必填         说明                                       options         [ReuseOptions](#reuseoptions)         是         复用选项，用于配置复用相关信息，由开发者指定。                               **返回值：**

                                   类型         说明                                       T         返回当前组件。                                            #### ReuseOptions
     ...
     **系统能力：** SystemCapability.ArkUI.ArkUI.Full
                                   ...
                                   名称         类型         只读         可选         说明                                       reuseId         [ReuseIdCallback](#reuseidcallback)         否         是         复用标识id，相同复用标识id的V2自定义组件会被互相复用。默认的复用标识id为自定义组件名。                                            #### ReuseIdCallback
