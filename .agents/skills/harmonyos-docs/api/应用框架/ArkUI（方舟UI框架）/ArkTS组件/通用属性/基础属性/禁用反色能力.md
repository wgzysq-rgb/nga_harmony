...
**Slug**: `ts-allow-force-dark`

**DocID**: `48f5ca7f94a34044be105e2d6b968c77`

**NodeID**: `000201775796216197650d86e6534f29`
...
组件是否使用反色能力。true：组件使用反色能力；false：组件不使用反色能力。
