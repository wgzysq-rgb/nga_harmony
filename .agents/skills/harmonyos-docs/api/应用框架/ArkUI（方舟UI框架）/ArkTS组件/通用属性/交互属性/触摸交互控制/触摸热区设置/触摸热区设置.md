...
**DocID**: `be840bad7d734be6b8e3541063b84a54`

**NodeID**: `000201775796216197760230e359d4d5`

---

触摸热区设置

设置组件的响应热区。在ArkUI开发框架中，处理触屏事件和鼠标事件时，会在事件触发前进行按压点与组件响应热区的
触摸测试
，以收集需响应事件的组件。基于测试结果，框架会分发相应的事件。影响
点击事件
、
触摸事件
、
...
每个触摸热区均包括输入工具类型、位置和大小。

默认值：

[{

tool：ResponseRegionSupportedTool.ALL,
...
[h2]示例1（通过responseRegion接口设置触摸热区）
