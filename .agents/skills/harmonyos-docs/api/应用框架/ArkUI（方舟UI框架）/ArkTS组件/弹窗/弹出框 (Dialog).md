...
**DocID**: `c76eec68b0ce4e69a222f74960ff9e07`

**NodeID**: `000201775796216197928dcb1d8638b6`
...
checkbox的选中状态改变事件。isChecked为true时，表示checkbox已选中，isChecked为false时，表示checkbox未选中。现推荐使用onCheckedChange
12+
。
...
从API version 14开始，该示例展示了���置跟手弹出框（警告弹出框为例），包含visible、popover、targetBuilder等内容。
