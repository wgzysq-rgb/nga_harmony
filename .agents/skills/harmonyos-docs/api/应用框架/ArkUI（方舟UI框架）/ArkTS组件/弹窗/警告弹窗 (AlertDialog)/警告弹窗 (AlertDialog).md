...
**Slug**: `ts-methods-alert-dialog-box`

**DocID**: `f1d05b63977a4e5bb0e74cef8d331ceb`

**NodeID**: `00020177579621619648226fc8a988bc`
...
设置页面级弹窗需要显示的层级下的
节点UniqueID
。仅在levelMode属性设置为LevelMode.EMBEDDED时生效。
...
在2in1设备上设置
AlertDialogParam
中showInSubWindow属性的值为true时，可以弹出在主窗外显示的弹窗。
...
该示例通过配置
AlertDialogParam
中的backgroundBlurStyleOptions属性，实现了自定义背景模糊效果。
...
该示例通过配置
AlertDialogParam
中的backgroundEffect属性，实现自定义背景效果。
