...
**DocID**: `3abc9fc9e5064807af3f83eaafa7f4cb`

**NodeID**: `0002017757962161975189b2adf58be5`
...
、
Image
等组件默认状态为不可获焦，不可获焦状态下，无法触发焦点事件，需要设置
focusable
属性为true才可触发。
