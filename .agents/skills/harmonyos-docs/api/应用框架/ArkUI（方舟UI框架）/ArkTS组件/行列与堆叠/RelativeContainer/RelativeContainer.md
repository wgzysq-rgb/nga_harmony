...
**DocID**: `fe8b31a2181c4feb898d6a112e385d17`

**NodeID**: `0002017757962161968021807413c76e`
...
从API version 20开始，在RelativeContainer组件中，
width
、
height
...
chainMode
接口从上至下分别实现了水平方向的
SPREAD链，SPREAD_INSIDE链和PACKED链
。
...
本示例展示了在镜像模式（direction声明Direction.Rtl）下以屏障为锚点时使用
