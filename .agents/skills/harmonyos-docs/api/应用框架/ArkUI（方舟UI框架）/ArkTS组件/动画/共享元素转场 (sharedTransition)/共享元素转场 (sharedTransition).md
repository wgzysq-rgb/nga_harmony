...
**Slug**: `ts-transition-animation-shared-elements`

**DocID**: `68ab77ee4e0049559ab6403456d6bfbb`

**NodeID**: `000201775796216197852c8db513c55a`

---

共享元素转场 (sharedTransition)

可以通过设置组件的sharedTransition属性将该元素标记为共享元素并设置对应的共享元素转场动效。sharedTransition仅发生在
@ohos.router (页面路由)
跳转时。
