...
**DocID**: `3d0a763385ae45d19e3edb9d1f2d4db0`

**NodeID**: `000201775796216197982f8d32ed16fc`
...
从API version 10开始支持利用
LinearGradient
设置Ring样式的渐变色。Ring类型不建议设置透明度，如需设置透明度，建议使用
DataPanel
。

从API version 23开始支持利用
LinearGradient
