...
**DocID**: `299d476ebd164a29b1c75e02269ea335`

**NodeID**: `000201775796216197138af0bdb71946`
...
当配置了symbol和icon 时，symbol的显示优先级更高。

当symbol和symbolModifier 同时设置HM Symbol资源时，symbolModifier设置的资源具有更高的显示优先级。
...
当配置symbol和icon时，symbol的显示优先级更高。

当symbol和symbolModifier同时设置HM Symbol资源时，symbolModifier设置的资源具有更高的显示优先级。
