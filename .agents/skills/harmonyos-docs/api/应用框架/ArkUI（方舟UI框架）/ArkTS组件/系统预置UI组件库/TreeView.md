...
**DocID**: `57a9a2a0ac9f43018c2ec3d7743f006e`

**NodeID**: `0002017757962161972301239f5f332e`
...
节点信息。，用于指定新增节点的属性。如果不传该参数，在当前选中的节点下添加一个标题为“新建文件夹”节点。
...
节点信息。传入时取消对应的节点信息的监听，否则取消该类型的所有节点信息的监听。
