...
**DocID**: `429690d91ed64979a4f0adbfe1424a1f`

**NodeID**: `0002017757962161965935638c45f9b0`
...
元服务API：
 从API version 12开始，该接口��持在元服务中使用。
...
传参SymbolGlyphModifier时，不支持使用symbolEffect修改动效类型和
effectStrategy
设置动效。
