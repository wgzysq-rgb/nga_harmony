...
**DocID**: `74889a3e322948038282242bb50158dc`

**NodeID**: `00020177579621619721606bbe79e311`
...
默认值：-1，没有激活态的子项。若设置数值小于-1，按没有激活项处理。
...
toolBarSymbolOptions有传入参数时，icon不生效。
...
设置backgroundColor后的ToolBarModifier对象。
...
设置stateEffect后的ToolBarModifier对象。
