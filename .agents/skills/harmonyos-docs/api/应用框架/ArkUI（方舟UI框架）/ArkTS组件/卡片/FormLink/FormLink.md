...
**Slug**: `ts-container-formlink`

**DocID**: `7f2c8f266fbe49de84a3d3d49868d3a4`

**NodeID**: `000201775796216196541d78f9b1163b`
...
singleton
的UIAbility，即启动模式为单实例的UIAbility），但不会调度到前台。提供方应用需要具备后台运行权限(
