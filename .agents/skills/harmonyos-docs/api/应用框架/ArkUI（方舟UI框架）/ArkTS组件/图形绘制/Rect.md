...
**DocID**: `ba0035f7d9124c40a53941b5264bb122`

**NodeID**: `000201775796216197892559e2b52172`
...
异常值undefined和null按照[[0, 0], [0, 0], [0, 0], [0, 0]]处理。
...
定义Rect轮廓的虚线模式的数组，数组元素交替表示线段长度和间隙长度。
...
偶数多元素数组：数组元素按顺序循环，如[a, b, c, d]表示线段长度a->间隙长度b->线段长度c->间���长度d->线段长度a->...
