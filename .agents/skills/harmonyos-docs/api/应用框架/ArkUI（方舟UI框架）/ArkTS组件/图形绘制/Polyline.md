...
**Slug**: `ts-drawing-components-polyline`

**DocID**: `af7f56a56eed4060b81992ab45f2a7bc`

**NodeID**: `000201775796216196765296c0efe86b`
...
设置填充区域的颜色，支持
attributeModifier
动态设置属性方法。与通用属性foregroundColor同时设置时，后设置的属性生效。
...
attributeModifier
动态设置属性方法。斜接长度表示外边框外边交点到内边交点的距离，边框宽度即strokeWidth属性的值。该属性取值仅在strokeLineJoin属性取值LineJoinStyle.Miter时生效。
