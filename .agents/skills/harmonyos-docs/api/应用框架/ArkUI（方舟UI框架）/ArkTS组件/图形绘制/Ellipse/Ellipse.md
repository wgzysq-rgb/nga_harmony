...
**Slug**: `ts-drawing-components-ellipse`

**DocID**: `f77c06b4332b4728a8bae63a84891ca9`

**NodeID**: `0002017757962161966337836158840e`
...
设置边框拐角绘制样式，支持
attributeModifier
动态设置属性方法。Ellipse组件无法形成拐角，该属性设置无效。
...
attributeModifier
动态设置属性方法。Ellipse组件不支持设置尖角图形，该属性设置无效。
