...
**Slug**: `ts-swiper-components-indicator`

**DocID**: `8845d8d4ea3b4139bed202665a0eaeaf`

**NodeID**: `0002017757962161964806fdf8a8f327`
...
组件中的
indicator
已有的能力作为一个单独组件提供给开发者使用。开发者可以不依赖Swiper组件单独显示导航点，也可以通过IndicatorComponentController与Swiper组件绑定使用。
