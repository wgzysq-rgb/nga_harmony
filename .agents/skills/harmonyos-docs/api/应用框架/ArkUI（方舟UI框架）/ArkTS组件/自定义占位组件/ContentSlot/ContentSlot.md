...
**Slug**: `ts-components-contentslot`

**DocID**: `67e4b70b690c4b7e933cee025da59c98`

**NodeID**: `000201775796216196619955ba52dbb7`
...
Content作为ContentSlot的管理器，通过Native侧提供的接口，可以注册并触发ContentSlot的上下树事件回调以及管理ContentSlot的子组件。
