...
**DocID**: `4de2b94f67d349b4ad37e483b0104006`

**NodeID**: `0002017757962161965669a79ad32998`
...
为避免因控件样式不合法而导致授权失败，请开发者先了解安全控件样式的
约束与限制
。
...
如果icon、text都不传入，
PasteButton
中的options参数不生效，创建的PasteButton为默认样式。
