...
**DocID**: `ec1ff191c277425189f026eac2180fba`

**NodeID**: `000201775796216197832d656faaa538`
...
在ImageSpan中，设置为非0时，
verticalAlign
将固定为ImageSpanAlignment.BASELINE对齐；设置为0时，要使基线对齐策略生效，需同时设置
verticalAlign
