...
**DocID**: `de6792c4e9f54c3181354b65757cd0bc`

**NodeID**: `000201775796216196672428cb72469b`
...
默认值：undefined，默认状态下配合
CheckboxGroupOptions
属性group信息为undefined的节点使用。
...
卡片能力：
 从API version 18开始，该接口支��在ArkTS卡片中使用。
...
设置Checkbox组件形状，包括圆形和圆角方形。与
shape

11+
相比，shape参数新增了对undefined类型的支持。如果想要调整当前Checkbox的样式，需使用
contentModifier
属性自定义Checkbox样式。
...
12+
相比，modifier参数新增了对undefined类型的支持。设置该属性时，会导致其他属性设置失效。
...
该示例通过配置CheckBoxShape实现圆形和圆角方形多选框���式。
