...
**DocID**: `c514b2fd2083409b8c6715bf306644e3`

**NodeID**: `00020177579621619676268feae8c1fb`
...
在结合带缓存功能的组件使用时（如
List
），未被创建的Checkbox选中状态需要应用手动控制。详细示例请参考
示例4
。
...
默认值：undefined，默认状态下管理
CheckboxOptions
属性group信息为undefined的节点。
...
设置是否全选。若同组的
Checkbox
显式设置了select属性，则Checkbox的优先级高。与
selectAll
...
开发者必须自定义此类以实现ContentModifier接口，使用方法见
contentModifier
。
