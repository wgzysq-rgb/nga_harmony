...
**Slug**: `ts-basic-components-calendarpicker`

**DocID**: `f53d4ebdd19548f7a3e79c606285b762`

**NodeID**: `00020177579621619785989980a9f3b9`
...
设置选择器与入口组件的对齐方式。与
edgeAlign
相比，alignType参数新增了对undefined类型的支持。
...
设备行为差异：
 该接口在Wearable设备上使用���，应用程序运行异常，异常信息中提示接口未定义，在其他设备中可正常调用。
...
start日期晚于当前系统日期，选中日期未设置

选中日期为start日期

end日期早于当前系统日期，选中日期未设置

选中日期为end日期

日期格式不符合规范，如‘1999-13-32’

start日期或end日期设置无效，选中日期取默认值
...
从API version 19开始，新增了
markToday
接口，
CalendarOptions
中新增了disabledDateRange属性。
