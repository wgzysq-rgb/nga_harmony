...
**Slug**: `ts-basic-gestures-swipegesture`

**DocID**: `d4fec749d6fa4a6a8ec3614a681477d1`

**NodeID**: `000201775796216197611e4dd3c8d078`
...
{ fingers?: number; direction?: SwipeDirection; speed?: number }
...
设置快滑手势事件。与
SwipeGesture
相比，options参数新增了isFingerCountLimited，表示是否检查触摸屏幕的手指数量。
