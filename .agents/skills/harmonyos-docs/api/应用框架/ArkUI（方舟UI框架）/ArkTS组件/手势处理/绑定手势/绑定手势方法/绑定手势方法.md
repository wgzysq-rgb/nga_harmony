...
**DocID**: `37f7d0056c984e6bb1abb0423b084d97`

**NodeID**: `0002017757962161974583733c3dfce3`
...
可以通过gesture、priorityGesture和parallelGesture给组件绑定手势识别，手势识别成功后可以通过事件回调通知组件。可以通过
触摸热区
