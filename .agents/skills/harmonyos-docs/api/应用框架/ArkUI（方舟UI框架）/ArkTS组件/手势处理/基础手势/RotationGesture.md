...
**Slug**: `ts-basic-gestures-rotationgesture`

**DocID**: `8075f2b0853a4821b5808165475659c3`

**NodeID**: `00020177579621619758660fb9527247`
...
设置旋转手势事件。与
RotationGesture
相比，options参数新增了isFingerCountLimited参数，表示是否检查触摸屏幕的手指数量。
...
Rotation手势识别成功，接收到触摸取消事件触发的回调。与
onActionCancel
相比，该回调返回手势事件信息。
