...
**Slug**: `ts-combined-gestures`

**DocID**: `40c49cf9fa2d4660967f32151ef7238d`

**NodeID**: `000201775796216196664f0741115b2d`
...
设置一个或者多个基础手势类型时，这些手势会被识别为组合手势。若此参数不填则组合手势识别功能不生效。

说明：

当需要为一个组件同时添加单击和双击手势时，可在组合手势中添加两个
TapGesture
