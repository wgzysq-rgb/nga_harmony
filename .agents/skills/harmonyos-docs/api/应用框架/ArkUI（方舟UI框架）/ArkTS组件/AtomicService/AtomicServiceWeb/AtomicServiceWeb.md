...
**Slug**: `ohos-atomicservice-atomicserviceweb`

**DocID**: `32f3812462604484bc7a34abd2ab8b49`

**NodeID**: `000201775796216196730b0ef2799242`
...
用户自定义代理信息。默认User-Agent定义与使用场景请参考
User-Agent开发指导
。
...
页面是否可前进或者后退给定的step步。返回true表示可以前进或者后退，返回false表示不可以前进或后退。
