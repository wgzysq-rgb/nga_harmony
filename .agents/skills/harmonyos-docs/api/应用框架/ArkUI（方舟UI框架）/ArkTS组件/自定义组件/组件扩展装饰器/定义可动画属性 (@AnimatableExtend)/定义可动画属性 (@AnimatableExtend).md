...
**DocID**: `63cf125fd7264407bca77220adb2f8ac`

**NodeID**: `00020177579621619742617590d1ab09`
...
使不可动画属性变为可动画属性，自定义数据运算规则使得属性能进行插值运算得到中间结果，再由动画驱动属性从起点值逐渐过渡到终点值。
