...
**DocID**: `569b78136f07457383f659ece10ccf5e`

**NodeID**: `000201775796216196640ff1f4f20ad4`
...
从API version 20开始，在自定义布局的自定义组件中，子组件若设置了
LayoutPolicy
...
从API version 9开始支持，从API version 10开始废弃，推荐使用
onPlaceChildren
替代。
