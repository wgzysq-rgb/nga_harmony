...
**Slug**: `ts-container-navigator`

**DocID**: `d22ef042f2b34da09037406b554b123b`

**NodeID**: `00020177579621619675380b1f0b84b7`
...
从API version 13开始，该组件不再维护，建议使用
Navigation
组件进行页面路由。
...
从API version 7开始支持，从API version 13开始废弃，建议使用
NavPathInfo
替代。
...
从API version 7开始支持，从API version 13开始废弃，建议使用
NavigationAttribute
替代。NavigationAttribute为Navigation组件的属性。
...
路由组件是否处于激活状态。设置为true时，组件处于激活态。设置为false时，组件不处于激活态。
