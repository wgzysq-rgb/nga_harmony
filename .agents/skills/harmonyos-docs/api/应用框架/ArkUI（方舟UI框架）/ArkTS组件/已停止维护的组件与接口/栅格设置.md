...
**DocID**: `45707ed14e7746829f8d95603dc30044`

**NodeID**: `000201775796216197833584febd6877`
...
从API version 9开始，该模块不再维护，推荐使用新组件
GridCol
、
GridRow
替代。
...
该属性从API version 14开始废弃，推荐使用新组件
GridCol
、
GridRow
。
