...
**Slug**: `js-service-widget-basic-clock`

**DocID**: `e36dc70efdd34025a5c5631014388b42`

**NodeID**: `000201775796216197551a7b39213334`
...
表盘数字的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过2.1.6 自定义字体样式指定的字体，会被选中作为文本的字体。
