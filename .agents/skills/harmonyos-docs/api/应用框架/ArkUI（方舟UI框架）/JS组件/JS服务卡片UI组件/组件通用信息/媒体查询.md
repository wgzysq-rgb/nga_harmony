...
**DocID**: `db3afe61f2304d4f8f5fc47b13f76eae`

**NodeID**: `000201775796216197603047af20dde1`
...
将多个媒体特征（Media Feature）以逻辑运算符“与”的方式连接成一个媒体查询，只有当所有媒体特征都为true，查询条件成立。另外，它还可以将媒体类型和媒体功能结合起来。
