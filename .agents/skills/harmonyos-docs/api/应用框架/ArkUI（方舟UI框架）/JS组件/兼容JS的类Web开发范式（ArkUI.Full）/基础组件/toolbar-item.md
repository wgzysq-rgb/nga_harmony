...
**Slug**: `js-components-basic-toolbar-item`

**DocID**: `0067021742464beeacc699e8939d4247`

**NodeID**: `00020177579621619775283c689e083c`
...
字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过
自定义字体
指定的字体，会被选中作为文本的字体。
