...
**Slug**: `js-components-svg-animate`

**DocID**: `7ee3b61e194d43ad890c504cdcd61927`

**NodeID**: `000201775796216197704a58eeb2dcd8`
...
与keyTimes相关联的一组贝塞尔控制点。定义每个关键帧的贝塞尔曲线，曲线之间用分号隔开。曲线内的两个控制点格式为x1 y1 x2 y2。比如0.5 0 0.5 1; 0.5 0 0.5 1;0.5 0 0.5 1
