...
> **分区**: API参考  |  **Slug**: `js-components-container-form`  |  **DocID**: `a55bc357c3ce4706827bcf0338d7f481`
...
除支持[通用事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-events)外，还支持如下事件：
  ...
  名称 参数 描述   submit FormResult 点击提交按钮，进行表单提交时，触发该事件。  reset - 点击重置按钮后，触发该事件。     **表1** FormResult

  名称 类型 描述   value Object input元素的name和value的值。       #### 方法
