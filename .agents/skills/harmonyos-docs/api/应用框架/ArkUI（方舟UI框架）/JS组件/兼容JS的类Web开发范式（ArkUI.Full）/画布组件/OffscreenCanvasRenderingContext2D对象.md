...
**Slug**: `js-offscreencanvasrenderingcontext2d`

**DocID**: `dde701ab604147c787a43c82ea0203bd`

**NodeID**: `0002017757962161976663dade59450d`
...
使用OffscreenCanvasRenderingContext2D在
OffscreenCanvas对象
...
指定点是否在路径的区域内。返回true时，指定点在路径区域内。返回false时，指定点不在路径区域内。
