...
**Slug**: `js-apis-file-storage-statistics`

**DocID**: `54207261db61454db0a24ff7aea7eb9a`

**NodeID**: `000201775796216196428eac331658bf`
...
Promise对象，返回指定卷上的应用存储空间大小（单位为Byte）。
...
The input parameter is invalid. Possible causes: Mandatory parameters are left unspecified.
...
Promise对象，返回内置存储的总空间大小（单位为Byte）。
...
storageStatistics.getTotalSizeSync
15+
...
Promise对象，返回内置存储的可用空间大小（单位为Byte）。
...
storageStatistics.getFreeSizeSync
15+
