...
**Slug**: `capi-cloud-disk-error-code-h`

**DocID**: `9f50b6421e7f411cb9c8532660bc9bf2`

**NodeID**: `000201775796216197878dd6b19c6e7c`
...
引用文件：
 <filemanagement/clouddiskmanager/cloud_disk_error_code.h>
...
同步根路径和该应用现有的同步根路径发生冲突。

CLOUD_DISK_CONFLICT_OTHER_APP = 34400006

同步根路径和其他应用现有的同步根路径发生冲突。
