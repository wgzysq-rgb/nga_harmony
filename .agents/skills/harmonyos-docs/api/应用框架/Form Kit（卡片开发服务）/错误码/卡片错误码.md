...
> **分区**: API参考  |  **Slug**: `errorcode-form`  |  **DocID**: `f6fc067f01d64b92a3a4eef3cab88fde`
...
# 卡片错误码
     ...
     **处理步骤**
     ...
     检查当前卡片对应互动卡片配置项[sceneAnimationParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration#sceneanimationparams标签)是否正确。
     ...
     **处理步骤**
     ...
     检查入参卡片尺寸是否在[FormDimension](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formdimension)和[supportDimensions](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration#配置文件字段说明)配置列表。
     ...
     **处理步骤**
     ...
     检查[半模态卡片编辑页](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/-ui-widget-event-formeditextensionability-overview#半模态卡片编辑)是否已打开。
     ...
     **处理步骤**
      ...
      - 重启系统后重试。
      - 重启后仍旧失败，请提[在线工单](https://developer.huawei.com/consumer/cn/support/feedback/#)获取帮助。
     ...
     **可能原因**
      ...
      - 空参数错误，比如传入空字符串（''）。
      - 参数格式错误。
      - 参数值错误。输入参数需要与[app.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-configuration-file)和[配置ArkTS卡片的配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration)中对应的配置保持一致。
