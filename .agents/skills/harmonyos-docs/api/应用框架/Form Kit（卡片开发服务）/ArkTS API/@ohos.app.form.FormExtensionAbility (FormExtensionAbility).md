...
**DocID**: `f472d80803fd4bba8315139c5d4575af`

**NodeID**: `00020177579621619631000fed42578f`
...
FormExtensionAbility的上下文环境，继承自
ExtensionContext
。
...
[h2]FormExtensionAbility.onAddForm
...
当前卡片相关的Want类型信息，其中Want中的parameters为自定义取值，取值可以包含
卡片参数枚举
...
[h2]FormExtensionAbility.onCastToNormalForm
...
[h2]FormExtensionAbility.onUpdateForm

onUpdateForm(formId: string, wantParams?: Record<string, Object>): void

卡片提供方接收携带参数的更新卡片的通知接口。获取最新数据后调用formProvider的
updateForm
接口刷新卡片数据。
...
[h2]FormExtensionAbility.onChangeFormVisibility
...
[h2]FormExtensionAbility.onFormEvent
...
[h2]FormExtensionAbility.onRemoveForm
...
[h2]FormExtensionAbility.onConfigurationUpdate
...
[h2]FormExtensionAbility.onAcquireFormState
...
want表示获取卡片状态的描述。描述包括Bundle名称、能力名称、模块名称、卡片名称等。
...
formInfo.FormState枚举，表示卡片当前的状态。
...
[h2]FormExtensionAbility.onStop
12+
...
[h2]FormExtensionAbility.onFormLocationChanged
20+
...
[h2]FormExtensionAbility.onSizeChanged
20+
...
卡片尺寸，例如 Dimension_1_2，表示 1 x 2 卡片。
