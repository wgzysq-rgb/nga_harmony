...
**Slug**: `js-apis-hashset`

**DocID**: `f449f3377ca04c1aa90858b2c96ed061`

**NodeID**: `000201775796216196450e4b634833c9`
...
HashSet基于
HashMap
实现。在HashSet中，仅处理value对象。

HashSet和
TreeSet
相比，HashSet中的数据按Hash值排序，因此元素的插入顺序与遍历时的顺序可能不一致，而TreeSet则是按照元素的自然排序或者自定义比较器进行有序存储。它们集合中的元素都不允许重复，HashSet允许插入null值，TreeSet不建议插入null值，可能会影响排序。
...
callbackFn被调用时用作this值，默认值为当前实例对象。
