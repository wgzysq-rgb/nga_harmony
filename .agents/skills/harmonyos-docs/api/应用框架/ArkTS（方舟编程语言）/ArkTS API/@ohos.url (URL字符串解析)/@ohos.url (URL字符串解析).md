...
**DocID**: `30f82b5b1eaf46339be21716e09e8af2`

**NodeID**: `000201775796216196430d8f3d1a1e45`

---

@ohos.url (URL字符串解析)

URL代表的是统一资源定位符，本模块提供了常用的工具函数，实现了解析URL字符串和构造
URL
对象等功能。
...
URLSearchParams接口定义了一些处理URL查询字符串的实用方法，从API version 9开始废弃，建议使用
URLParams
。
...
若查找一个不存在的键值对名称时返回值为undefined，从API version 7开始支持，从API version 9开始废弃，建议使用
URLParams.get
9+
