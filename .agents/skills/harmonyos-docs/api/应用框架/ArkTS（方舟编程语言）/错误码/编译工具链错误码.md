...
**Slug**: `errorcode-ets-loader`

**DocID**: `064b3224495e483580de1298a0f313e7`

**NodeID**: `00020177579621619634356c8ffe09b6`
...
检查${filePath}所属的${pkgName}模块是否配置正确。

检查对应的文件名是否正确（包括大小写敏感）。
