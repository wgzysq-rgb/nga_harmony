...
**DocID**: `8423c2d7c6034f8aa2af39b497fd552a`

**NodeID**: `00020177579585958080889aa08ca3b3`
...
语句结果值。若value为假（false）或者省略，则输出以"Assertion failed"开头。如果value为真值（true），则无打印。
