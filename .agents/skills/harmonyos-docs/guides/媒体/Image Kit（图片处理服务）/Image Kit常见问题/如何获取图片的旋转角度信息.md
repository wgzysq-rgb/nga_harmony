...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-rotate-faq`  |  **DocID**: `ff4dbc11c40445d181a8d016174418c5`  |  **NodeID**: `00020177579552692867995dc3509841`
...
# 如何获取图片的旋转角度信息
     ...
     要将图片正确显示需要执行与之对应的特定的操作，如下表所示：
          ...
          ArkTS场景下读取和编辑图片的旋转角度信息，可参考：[编辑图片Exif信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-tool)，对应的propertyKey需要设置为：ORIENTATION。
