...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-picture-decoding`  |  **DocID**: `dafbe234484d420d90c6f45274f349a2`  |  **NodeID**: `000201775795526928833ab938865002`
...
```
         ...
         const imageSource: image.ImageSource = image.createImageSource(rawFileDescriptor);       
             设置解码参数DecodingOptions，解码获取picture多图对象。并对picture进行操作，如获取辅助图等。对于picture和辅助图的具体操作请参考文档[Picture](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-picture)。
