...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-pixelmap-operation`  |  **DocID**: `b1e773a3b2814357b9487db2f00f7e8c`  |  **NodeID**: `00020177579552692885274bbd5f0746`
...
# 使用PixelMap完成位图操作
    ...
    **图1** 位图操作示意图
     ...
     位图操作相关API的详细介绍请参见[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)。
             ...
             完成[图片解码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-decoding)，获取PixelMap位图对象。
...
```
             ...
             完成[图片解码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-decoding)，获取两张宽度相同且像素格式相同的PixelMap位图对象。

             参考以下代码对两张PixelMap进行拼接。
