...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-processing-arkts`  |  **DocID**: `89fb170950294ff589900d7b8f297889`  |  **NodeID**: `000201775795526928857354c4ea4a34`
...
添加引用文件。
  ...
  import { image, videoProcessingEngine } from '@kit.ImageKit';  初始化环境。

  let promise: Promise<void> = videoProcessingEngine.initializeEnvironment();  （可选）配置输入。
