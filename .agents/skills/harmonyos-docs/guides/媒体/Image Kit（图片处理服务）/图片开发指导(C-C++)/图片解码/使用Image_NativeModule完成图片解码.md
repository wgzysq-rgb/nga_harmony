...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-source-c`  |  **DocID**: `2c9c286c8311404ab224bb9effa31425`  |  **NodeID**: `0002017757955269288138be1d707317`
...
```
     ...
     **解码接口使用示例**
                         ...
                         部分接口（如：[OH_ImageSourceNative_GetSupportedFormats](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-image-source-native-h#oh_imagesourcenative_getsupportedformats)）在API version 20以后才支持，需要开发者在进行开发时选择合适的API版本。
...
```
       ...
       static ImageSourceNative *g_thisImageSource = new ImageSourceNative();             创建GetJsResult函数处理napi返回值。
...
```
       ...
       const int MAX_STRING_LENGTH = 1024;             创建ImageSource实例。
