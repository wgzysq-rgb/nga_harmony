...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-source-picture-c`  |  **DocID**: `bf1413bf2e4f49eab7113e3228e092fd`  |  **NodeID**: `000201775795526928836943aab11c82`
...
```
       ...
       static ImagePictureNative *g_thisPicture = new ImagePictureNative();             定义ImageAuxiliaryPictureNative类。
...
```
       ...
       static ImageAuxiliaryPictureNative *g_thisAuxiliaryPicture  = new ImageAuxiliaryPictureNative();             创建GetJsResult函数处理napi返回值。
