...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-packer-picture-c`  |  **DocID**: `efe214f0577741d6bdfe141cf3875872`  |  **NodeID**: `000201775795526928849202328bdb5c`
...
```
             创建ImagePictureNative的一个实例。

       static ImagePictureNative *g_thisPicture = new ImagePictureNative();             创建GetJsResult函数处理napi返回值。
