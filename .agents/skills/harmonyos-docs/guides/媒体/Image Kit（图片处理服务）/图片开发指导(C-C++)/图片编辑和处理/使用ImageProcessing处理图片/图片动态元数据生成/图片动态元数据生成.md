...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-dynamic-metadata-generation`  |  **DocID**: `cdc3b447bea6478d82182792c8d82fad`  |  **NodeID**: `000201775795526928877315aa2036e3`
...
```
  ...
  ret = OH_ImageProcessing_GenerateMetadata(instance, hdr);  释放实例资源。
