...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `image-scaling`  |  **DocID**: `3e3e36a1929d4267adb440fe9595a45e`  |  **NodeID**: `0002017757955269288762df4e8b374d`
...
```
 ...
 一般在进程内第一次使用时调用，可提前完成部分耗时操作。
  ...
  ImageProcessing_ErrorCode ret =  OH_ImageProcessing_InitializeEnvironment();  创建细节增强模块。
