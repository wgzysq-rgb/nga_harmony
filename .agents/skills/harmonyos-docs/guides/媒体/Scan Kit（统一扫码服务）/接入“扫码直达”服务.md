...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `scan-directservice`  |  **DocID**: `2b8e2ff707ef453d8b4fba28c2386ebd`  |  **NodeID**: `0002017757955269286054ccd9d6b126`
...
参考[开发准备](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/scan-config-agc)完成必要的准备工作。
