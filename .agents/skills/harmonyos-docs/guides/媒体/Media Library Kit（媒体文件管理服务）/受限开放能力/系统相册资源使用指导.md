...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `photoaccesshelper-systemalbum-guidelines`  |  **DocID**: `a7a150e593214810bb46f065960c9713`  |  **NodeID**: `000201775795526928726e8a0e2a6906`
...
```
     ...
     先[获取收藏夹对象](#获取收藏夹对象)。然后调用[Album.getAssets](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-absalbum#getassets-1)接口获取收藏夹中的资源。
...
```
     ...
     先[获取视频相册对象](#获取视频相册对象)。然后调用[Album.getAssets](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-absalbum#getassets-1)接口获取视频相册对象中的视频资源。
     ...
     **开发步骤**
      ...
      - 调用[FetchResult.getFirstObject](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-fetchresult#getfirstobject-1)接口获取第一个视频。
