...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `medialibrary-request-photouris-permission`  |  **DocID**: `e822130dbe4148fa94c81664bb432d54`  |  **NodeID**: `000201775795526928637debad4e1030`
...
导入相关接口模块文件。
  ...
  import { photoAccessHelper } from '@kit.MediaLibraryKit';  初始化输入的uri列表。
