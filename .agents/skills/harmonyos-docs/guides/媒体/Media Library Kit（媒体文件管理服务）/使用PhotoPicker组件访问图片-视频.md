...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `component-guidelines-photoviewpicker`  |  **DocID**: `7e08fc5b861948c3870de39757f1c3ed`  |  **NodeID**: `00020177579552692861345419d3476d`
...
```
  应用界面出现时，初始化组件配置选项实例（PickerOptions）。
...
```
  创建[PhotoPickerComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-file-photopickercomponent#photopickercomponent)组件。
