...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `photoaccesshelper-photoviewpicker`  |  **DocID**: `1cc5dd05a241487fa1267e9578f82825`  |  **NodeID**: `0002017757955269285979c78c5024f5`
...
```
      ...
      const photoSelectOptions = new photoAccessHelper.PhotoSelectOptions();           配置可选的媒体文件类型和媒体文件的最大数目。
...
```
     ...
     媒体库支持Picker选择[媒体文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)URI后，根据指定URI获取图片或视频资源，下面以查询指定URI为'file://media/Photo/1/IMG_datetime_0001/displayName.jpg'为例。

     
             定义媒体资源处理器[MediaAssetDataHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-mediaassetdatahandler)，系统在资源准备就绪时向应用回调onDataPrepared。
