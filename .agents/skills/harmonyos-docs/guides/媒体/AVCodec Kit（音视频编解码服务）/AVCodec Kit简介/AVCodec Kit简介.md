...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `avcodec-kit-intro`  |  **DocID**: `d22a745884ae4c1a984539ab2bf339f7`  |  **NodeID**: `000201775795526928586dfc35f0702a`
...
# AVCodec Kit简介
    ...
    基于性能考虑，AVCodec Kit仅提供C接口。
      ...
      - 视频编码、解码支持硬件加速：支持H.264、H.265、H.265 10bit的硬件编解码。
       ...
       具体开发指导请参考[视频解码Surface模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-decoding#surface模式)、[视频编码Surface模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-encoding#surface模式)。
