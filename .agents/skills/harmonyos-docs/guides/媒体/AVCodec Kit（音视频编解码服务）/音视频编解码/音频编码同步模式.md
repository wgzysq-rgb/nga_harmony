...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `synchronous-audio-encoding`  |  **DocID**: `8996a8cc72794bbba001e09d1a6dc045`  |  **NodeID**: `0002017757955269287121390d9ae941`
...
```
             调用OH_AudioCodec_Configure配置编码器。
...
// AAC LC编码一帧包含1024采样点，2声道，��入数据为S16LE，16比特数据，占用2字节。
