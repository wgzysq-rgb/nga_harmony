...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `obtain-supported-codecs`  |  **DocID**: `68ce5aa3cd8f46f8b32dda5201d9a56a`  |  **NodeID**: `0002017757955269286526e50c9c9ab8`
...
```
       若获取能力实例成功，继续向下执行。实例无显性释放接口，使用完毕后系统会自动回收。
             ...
             按需调用相应的查询接口。详细的API说明请参考[native_avcapability.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-avcapability-h)。
