...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `audio-encoding`  |  **DocID**: `df5cfa60d1f54bf09e08252bbe9b8484`  |  **NodeID**: `0002017757955269286719d1ebca63d3`
...
```
             调用OH_AudioCodec_PushInputBuffer()，写入待编码的数据。需开发者填充完整的输入数据后调用。
