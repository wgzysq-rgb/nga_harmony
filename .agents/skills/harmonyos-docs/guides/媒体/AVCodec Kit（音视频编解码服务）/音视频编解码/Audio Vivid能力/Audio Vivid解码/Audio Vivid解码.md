...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `audiovivid-audiodecoder`  |  **DocID**: `ec0fc15426214690925466a27536c4a4`  |  **NodeID**: `00020177579552692885345d6db14b71`
...
```
  ...
  int ret = OH_AudioCodec_Start(decoder);  停止和释放实例。
