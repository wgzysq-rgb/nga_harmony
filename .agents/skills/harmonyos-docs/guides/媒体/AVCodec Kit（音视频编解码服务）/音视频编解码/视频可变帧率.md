...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `video-variable-refreshrate`  |  **DocID**: `24246c2baf274df9aacca9b152e5aa81`  |  **NodeID**: `00020177579552692878626c70610035`
...
- 只支持硬件解码后直接送显的视频播放场景。
- 屏幕整体刷新率会被调整，建议在全屏播放、无弹幕、无动效的场景使用，否则会影响弹幕、动效的流畅度体验。
- 依赖解码帧率配置，使用前需要正确配置OH_MD_KEY_FRAME_RATE属性。
- 与硬件平台能力相关，当平台不支持时，接口不报错，内部能力不生效，不影响正常解码播放流程。
