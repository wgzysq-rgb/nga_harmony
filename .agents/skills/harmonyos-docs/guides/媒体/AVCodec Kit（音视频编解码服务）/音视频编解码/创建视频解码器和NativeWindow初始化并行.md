...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `parallel-decoding-nativewindow`  |  **DocID**: `be29cb0194954e27b06e074324a52950`  |  **NodeID**: `00020177579552692878325c3375bd71`
...
```
       ...
       具体开发指导请参考[视频解码Surface模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-decoding#surface模式)“步骤-5：调用OH_VideoDecoder_Configure()配置解码器”。
...
```
       ...
       具体开发指导请参考[视频解码Surface模式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-decoding#surface模式)“步骤-8：调用OH_VideoDecoder_Start()启动解码器”。
       ...
       本例中的nativeWindow，有两种方式获取：
        ...
        - 如果解码后直接显示，则从XComponent组件获取，获取方式请参考 [XComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent)；
        - 如果解码后接OpenGL后处理，则从NativeImage获取，获取方式请参考 [NativeImage](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/native-image-guidelines)。
