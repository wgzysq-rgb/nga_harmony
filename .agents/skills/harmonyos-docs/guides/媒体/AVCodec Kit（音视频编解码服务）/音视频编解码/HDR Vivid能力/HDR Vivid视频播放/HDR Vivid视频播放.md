...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hdr-vivid-video-player`  |  **DocID**: `dd0eb629bddb42a7a7ccf117dd60d511`  |  **NodeID**: `000201775795526928810e27062ecf8d`
...
```
  ...
  target_link_libraries(sample PUBLIC libnative_buffer.so)  添加头文件。
