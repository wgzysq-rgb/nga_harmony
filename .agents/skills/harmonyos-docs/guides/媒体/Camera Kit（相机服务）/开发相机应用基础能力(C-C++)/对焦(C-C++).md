...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `camera-focus-native`  |  **DocID**: `a520f58ea4494dfcb70e9b2f9f3b2ca9`  |  **NodeID**: `000201775795526928777ca366a6df15`
...
```
  ...
  target_link_libraries(entry PUBLIC libohcamera.so libhilog_ndk.z.so)  调用[OH_CaptureSession_SetFocusMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_setfocusmode)设置对焦模式。
