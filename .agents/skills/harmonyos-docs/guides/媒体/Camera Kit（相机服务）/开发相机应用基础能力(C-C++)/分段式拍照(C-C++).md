...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-camera-deferred-capture`  |  **DocID**: `08b1eb031d8c407a96e6bf065f139b30`  |  **NodeID**: `000201775795526928733a95ffa5ce48`
...
```
             相机初始化及拍照触发参考[拍照(C/C++)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/native-camera-shooting)。
