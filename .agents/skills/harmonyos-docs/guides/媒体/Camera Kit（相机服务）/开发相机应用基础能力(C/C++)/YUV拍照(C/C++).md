...
> **分区**: Guides  |  **Slug**: `native-camera-yuv-shooting`  |  **DocID**: `1d0f1a8d57ff4d9cb2502c45663f4f54`  |  **NodeID**: `0002017768396966040574ba5057dcde`
...
```
             创建并打开相机设备，参考[设备输入(C/C++)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/native-camera-device-input)中的步骤3-4。
...
```
             注册单段式(PhotoAvailable)或分段式(PhotoAssetAvailable)拍照回调，若应用希望快速得到回图，推荐使用[分段式拍照(PhotoAssetAvailable)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/native-camera-deferred-capture)回调。
