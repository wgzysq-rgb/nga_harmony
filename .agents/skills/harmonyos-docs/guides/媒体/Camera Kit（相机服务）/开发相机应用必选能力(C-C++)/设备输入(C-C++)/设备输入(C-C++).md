...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-camera-device-input`  |  **DocID**: `79196a28b8c947e09487407aaa89f30b`  |  **NodeID**: `000201775795526928677dda03d44fd4`
...
```
             通过[OH_CameraManager_CreateCameraInput()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-manager-h#oh_cameramanager_createcamerainput)方法，获取cameraInput对象。
