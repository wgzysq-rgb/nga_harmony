...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `camera-device-management`  |  **DocID**: `de3beeddc8564c29b87514d4b12d0e1a`  |  **NodeID**: `000201775795526928665b35a78b909c`
...
```
             通过[getCameraManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-f#cameragetcameramanager)方法，获取cameraManager对象。
