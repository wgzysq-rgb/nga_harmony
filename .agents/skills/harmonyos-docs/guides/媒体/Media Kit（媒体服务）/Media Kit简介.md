...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `media-kit-intro`  |  **DocID**: `1f5e24325b0f4e249afff863a2ddbba6`  |  **NodeID**: `0002017757955269285842178959dbb7`
...
# Media Kit简介
    ...
    Media Kit提供的模块有：
     ...
     详细流媒体开发流程请参考[流媒体播放开发指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/streaming-media-playback-development-guide)。
     ...
     图中的数字标注表示需要数据与外部模块的传递。
             ...
             应用从XComponent组件获取窗口SurfaceID，获取方式参考[XComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent)。
     ...
     支持的协议如下：
          ...
          支持的视频播放格式和主流分辨率如下：
                        ...
                        | 视频容器规格          | 规格描述          | 分辨率         
                               | mp4                    视频格式：H26510+/H264

          音频格式：AAC/MP3

         | 主流分辨率，如4K/1080P/720P/480P/270P         
                 | mkv                    视频格式：H26510+/H264
     ...
     支持的音视频源参考[媒体数据解析](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-video-demuxer)。
     ...
     支持的视频源参考[视频解码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-decoding)。
     ...
     支持修改源视频文件的编码参数（格式、码率）和封装格式。源视频的音视频编码和封装格式为系统AVCodec支持的解码和解封装格式，目标视频的音视频编码和封装格式为系统AVCodec支持的编码和封装格式。
             ...
             支持将HDR VIVID/HLG/HDR10视频转换为SDR视频，以及SDR视频的转码。
