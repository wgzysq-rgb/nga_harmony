...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `avtranscoder-practice`  |  **DocID**: `9a2fc94b1335404487a224d3185c9f3c`  |  **NodeID**: `000201775795526928846a7e17f585af`
...
```
     ...
     参考以下示例，使用worker线程的方式来实现异步线程进行转码。
      ...
      新建工程，下载[完整示例工程](https://gitcode.com/openharmony/applications_app_samples/tree/master/code/DocsSample/Media/AVTranscoder/AsyncTranscoder)，并将示例工程的资源复制到对应目录。       ```
AsyncTranscoder
