...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `video-subtitle`  |  **DocID**: `9edda9f760314d07a1051aad9a0c0018`  |  **NodeID**: `000201775795526928873606215d327a`
...
# 使用AVPlayer添加视频外挂字幕(ArkTS)
    ...
    在进行应用开发的过程中，开发者可以通过AVPlayer的实例注册on('subtitleUpdate')方法监听字幕信息。
     ...
     详细的API说明请参考[AVPlayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer)
             ...
             调用[addSubtitleFromFd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer#addsubtitlefromfd12)，使用视频播放的AVPlayer实例设置外挂字幕资源。
