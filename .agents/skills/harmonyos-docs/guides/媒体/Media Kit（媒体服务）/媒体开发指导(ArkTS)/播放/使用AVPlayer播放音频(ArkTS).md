...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `using-avplayer-for-playback`  |  **DocID**: `d29ccfdf3f504039bde63bd906bfcb95`  |  **NodeID**: `00020177579552692881864dbf1f4f2f`
...
```
     ...
     参考以下示例，完整地播放一首音乐，实现起播后3s暂停，暂停3s重新播放的效果。
      ...
      新建工程，下载[示例工程](https://gitcode.com/openharmony/applications_app_samples/tree/master/code/DocsSample/Media/AVPlayer/AVPlayerArkTSAudio)，并将示例工程的以下资源复制到对应目录。       ```
AVPlayerArkTSAudio
entry/src/main/ets/
└── pages
    └── Index.ets (播放界面)
