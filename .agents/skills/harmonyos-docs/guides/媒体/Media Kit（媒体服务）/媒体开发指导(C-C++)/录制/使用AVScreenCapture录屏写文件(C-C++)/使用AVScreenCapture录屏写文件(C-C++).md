...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `using-avscreencapture-for-file`  |  **DocID**: `ea08fb8ad2204f29b3921657b1c8f19a`  |  **NodeID**: `000201775795526928868cc7e6e14ac9`
...
```
       ...
       OH_AVScreenCapture_StartScreenRecording(capture);             调用StopScreenRecording()方法停止录制。

       OH_AVScreenCapture_StopScreenRecording(capture);             调用Release()方法销毁实例，释放资源。
