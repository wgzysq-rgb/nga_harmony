...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `drm-avcodec-integration`  |  **DocID**: `7020262662c5411e9c818c363c44bd6f`  |  **NodeID**: `00020177579552692862022f94ac8d7a`
...
# 基于AVCodec播放DRM节目(C/C++)
     ...
     target_link_libraries(sample PUBLIC libnative_drm.so)                         上述'sample'字样仅为示例，此处由调用者根据实际工程目录自定义。
