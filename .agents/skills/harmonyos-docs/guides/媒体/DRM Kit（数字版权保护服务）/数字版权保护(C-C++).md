...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `drm-c-dev-guide`  |  **DocID**: `9873454dda3446feaceda8aa548bfe45`  |  **NodeID**: `000201775795526928599a3005ce9777`
...
```
       ...
       target_link_libraries(PUBLIC libnative_drm.so)             获取设备支持的DRM解决方案名称和唯一标识的列表。
