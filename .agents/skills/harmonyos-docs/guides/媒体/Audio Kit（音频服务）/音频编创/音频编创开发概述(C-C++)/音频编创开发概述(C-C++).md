...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `audio-suite`  |  **DocID**: `1a01b89550534d2884f9308bb8f644dd`  |  **NodeID**: `000201775795526928657769f7ab8b4f`
    ...
    **图1**：音频编创实现原理图
     ...
     **图2**：管线运行状态图
     ...
     状态的功能如下表所示。
                        ...
                        | 状态名          | 功能         
                               | stopped                    初始状态，或者工作状态经过[OH_AudioSuiteEngine_StopPipeline()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-suite-engine-h#oh_audiosuiteengine_stoppipeline)命令进入该状态。

          切换到stopped状态下，各节点将释放缓存。

        
                 | running                    工作状态，或者初始状态执行[OH_AudioSuiteEngine_StartPipeline()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-suite-engine-h#oh_audiosuiteengine_startpipeline)命令进入该状态。
