...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `using-ohaudio-for-playback`  |  **DocID**: `5950700928974b81805965b0ff4586f0`  |  **NodeID**: `0002017757955269286752cb4effb6d7`
...
```
     ...
     OH_AudioStreamBuilder_Destroy(builder);     开发者可以通过以下几个步骤来实现一个简单的播放功能。
