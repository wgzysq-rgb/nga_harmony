...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `using-ohavsession-developer`  |  **DocID**: `fe2b3869e2c74ec7a35cfb30e59a0b27`  |  **NodeID**: `000201775795526928695ba8ae7eb02b`
...
```
     ...
     开发者可以通过以下几个步骤在NDK接入本地会话。
             ...
             创建会话并激活媒体，需要传入会话类型AVSession_Type，自定义的TAG，以及应用的包名、ability名字。
