...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `local-avsession-overview`  |  **DocID**: `43fe5ca78f80448c8fb2f24c2f35c1c0`  |  **NodeID**: `000201775795526928647e0f655ec9e0`
...
# 本地媒体会话概述
     ...
     import { avSession as AVSessionManager } from '@kit.AVSessionKit';     根命名域中的所有方法都可以作为AVSessionManager的方法。
