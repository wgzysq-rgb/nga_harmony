...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `using-switch-call-devices`  |  **DocID**: `58db7a608c6143c3b88d29678ed6d6bf`  |  **NodeID**: `0002017757955269286502de7cc10dad`
...
```
             创建VOICE_COMMUNICATION类型的AudioRenderer，并开始播放。具体通话音频播放等实现，请参考[开发音频通话功能](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-call-development)。
...
```
             实现通话功能，请参考[开发音频通话功能](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-call-development)。
