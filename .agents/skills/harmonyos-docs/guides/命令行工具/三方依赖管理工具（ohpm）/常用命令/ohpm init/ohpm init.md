...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-ohpm-init`  |  **DocID**: `a081c2b5cc76473c85c81eb77e1be7da`  |  **NodeID**: `0002017757901610454957f4bfaeffa8`
...
- 类型： string
 ...
 从ohpm 6.0.2.636版本开始，可以在 init 命令后配置--log_level <string>参数，指定执行当前命令的日志级别（info、debug、warn、error），如果未指定该值则日志级别为.ohpmrc中配置的log_level的级别。
...
```
 ...
 ohpm init -g group_name 执行结果为：示例中 name 字段自动显示为 @group_name/demo。
