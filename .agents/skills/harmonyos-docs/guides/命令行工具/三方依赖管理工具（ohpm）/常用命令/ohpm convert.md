...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-ohpm-convert`  |  **DocID**: `9cf4d2c1e2c243dab5719b54337bea22`  |  **NodeID**: `000201775790161045524ba1bc6769a6`
...
**转换远程npm三方库中的包**
 ...
 ohpm convert axios --registry https://registry.npmjs.org/ 结果示例：
