...
> **分区**: Guides  |  **Slug**: `ide-ui-generator`  |  **DocID**: `3cddf42bcc534605828a427a682deb1d`
...
- 在DevEco Studio菜单栏点击**Tools > Generate Project From...**打开UI Generator工具，首次使用需要阅读并确认用户协议，确认后可继续使用。
输入待配置项路径，点击**Next**进入下一步。 待配置项
 ...
 配置输出工程待配置项，点击**Finish**进行生成。 待配置项
