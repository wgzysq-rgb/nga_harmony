...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `i18n-numbers-weights-measures`  |  **DocID**: `aad6c9b92015418ea809783acd3d24c3`  |  **NodeID**: `000201775795788884285852d018e8b0`
...
# 数字与度量衡国际化
     ...
     度量衡包括长度单位、面积单位、体积单位和容量单位等，通过[I18NUtil](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n#i18nutil9)类的[unitConvert](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n#unitconvert9)接口实现度量衡转换和格式化。
     ...
     **表1** 格式化使用的风格(style)
       ...
       import { i18n } from '@kit.LocalizationKit';             单位转换。
