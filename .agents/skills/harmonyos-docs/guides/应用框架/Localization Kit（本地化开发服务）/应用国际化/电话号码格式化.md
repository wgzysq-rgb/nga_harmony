...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `i18n-phone-numbers`  |  **DocID**: `53c59936feb74c9f85a79a72e1b2320d`  |  **NodeID**: `0002017757957888843035efa45a9b41`
...
# 电话号码格式化
     ...
     电话号码格式化通过[PhoneNumberFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n#phonenumberformat8)的[format](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n#format8)接口实现。
     ...
     **表1** 电话号码格式化的类型(type)
       ...
       import { i18n } from '@kit.LocalizationKit';             处理号码。
