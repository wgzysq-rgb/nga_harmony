...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ipc-rpc-development-guideline`  |  **DocID**: `7aaf0350296a4ba79fbfa133bb142e84`  |  **NodeID**: `000201775795788884016810156c4591`
...
# IPC与RPC通信开发指导(ArkTS)
     ...
     IPC/RPC的主要工作是跨进程建立对象通信的连接（客户端进程的Proxy和服务端进程的Stub建立一一对应关系），从而通过Proxy的接口可以和Stub进行IPC/RPC通信。
             ...
             创建变量connect，指定连接成功、连接失败和断开连接时的回调函数。

             连接服务，获取服务代理对象Proxy，并注册死亡监听。
