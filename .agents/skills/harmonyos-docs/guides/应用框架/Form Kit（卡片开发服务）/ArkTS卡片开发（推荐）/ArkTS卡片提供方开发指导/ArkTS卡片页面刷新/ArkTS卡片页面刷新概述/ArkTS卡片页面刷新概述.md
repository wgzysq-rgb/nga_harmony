...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-ui-widget-interaction-overview`  |  **DocID**: `28d4d89c2a0e4750ae32710695af335b`  |  **NodeID**: `000201775795788884644694744996e1`
...
# ArkTS卡片页面刷新概述
     ...
     **图3 卡片管理服务通知卡片提供方定时定点刷新卡片流程图**
     ...
     根据卡片提供方开发者提前配置声明的定时刷新信息，卡片管理服务会根据定时信息、卡片可见状态、刷新次数等因素综合判断是否需要通知卡片提供方更新卡片。
      ...
      - 卡片提供方仅允许刷新自己的卡片，其他提供方的卡片无法刷新。
      - 卡片使用方仅允许刷新添加到自己的卡片，添加到其他使用方的卡片无法刷新。
