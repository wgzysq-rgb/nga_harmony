...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-ui-widget-open-formmanager`  |  **DocID**: `6a0be822a9784bd38ddfd14177f9131f`  |  **NodeID**: `00020177579578888466499dace6404d`
...
# 应用内拉起卡片管理加桌
     ...
     下面给出示例，实现如下功能：在应用内点击“添加卡片到桌面”按钮，拉起卡片管理页面。用户可在卡片管理页面，点击“添加至桌面”按钮，此时在桌面即可看到新添加的卡片。
             ...
             通过[openFormManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-form-formprovider#formprovideropenformmanager18)方法在应用内添加拉起卡片管理页面入口。
...
```
             用户可在卡片管理页面，点击“添加至桌面”或者“添加至负一屏”，此时在桌面或者负一屏即可看到新添加的卡片。结果示例如下。

---
*Updated: 2026-04-20 01:49:03*
