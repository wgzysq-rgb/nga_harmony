...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `tool-disassembler`  |  **DocID**: `28ddc9c3e9bc4c43ba6e26b0c9e518c1`  |  **NodeID**: `000201775795788884220831f167a2a9`
...
反汇编命令如下：
 ...
 ark_disasm.exe [options] input_file output_file 参数说明：
...
```
 ...
 ark_disasm.exe test.abc test.txt 查看反汇编文件的内容。
...
```
 ...
 ark_disasm.exe --verbose test.abc test.txt 此处列出部分示例。
