...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-interthread-shared`  |  **DocID**: `2c67e836709c4933a20530711d42ae47`  |  **NodeID**: `00020177579578888483154bdb1ebcf0`
...
```
     export const testSendSendable: () => void;     UI主线程发起调用。
...
```
     整个过程主要包括的逻辑实现为：
             ...
             在UI主线程中创建ArkTS运行环境，并发起一个C++子线程创建Sendable对象，保存到result中，然后将result引用的Sendable对象序列化到全局序列化数据serializationData中。
