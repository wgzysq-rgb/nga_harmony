...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `napi-define-sendable-object`  |  **DocID**: `3844fa9785f54dad8e7f9f8fc799e52a`  |  **NodeID**: `000201775795788884885040dbd3bf77`
...
```
  ArkTS侧在UI主线程中定义Sendable实例对象并传递给TaskPool子线程，子线程处理完数据后返回UI主线程，UI主线程可以继续访问该Sendable实例对象。
