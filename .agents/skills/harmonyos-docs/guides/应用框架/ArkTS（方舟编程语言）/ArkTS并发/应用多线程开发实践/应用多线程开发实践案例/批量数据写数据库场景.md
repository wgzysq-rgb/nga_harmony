...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `batch-database-operations-guide`  |  **DocID**: `57c323fafa754889ba38a2df7a9b1db6`  |  **NodeID**: `0002017757957888846658027dfd5a09`
...
创建多个子任务，支持数据库的创建、插入、查询和清除等操作。

  UI主线程发起数据库操作请求，在子线程中完成数据库的增删改查等操作。
...
定义数据库中的数据格式，可以使用Sendable，以减少跨线程操作的耗时。
...
定义数据库中的数据格式，采用Sendable，减少跨线程耗时。
