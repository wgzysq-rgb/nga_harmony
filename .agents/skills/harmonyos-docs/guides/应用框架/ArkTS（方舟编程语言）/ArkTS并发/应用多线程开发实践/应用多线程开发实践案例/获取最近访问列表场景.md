...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `sendablelrucache-recent-list`  |  **DocID**: `112f261d4cea4cc5bc088660e526398a`  |  **NodeID**: `000201775795788884867cf75da937e8`
...
# 获取最近访问列表场景
      ...
      存放到SendableLruCache实例中的对象必须是Sendable对象。
           ...
           创建SendableLruCache实例对象，并根据业务需求预设最大容量。
