...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `buffer`  |  **DocID**: `a0ff79261eea42abb28fb04d9872d2e3`  |  **NodeID**: `00020177579578888420776612452e7b`
...
# Buffer与FastBuffer
     ...
     Buffer模块各接口使用详见：[@ohos.buffer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-buffer)。
     ...
     FastBuffer模块各接口使用详见：[@ohos.fastbuffer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fastbuffer)。
