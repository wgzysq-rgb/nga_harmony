...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `xml-parsing`  |  **DocID**: `3922742039c0445580dfce5e9fc0b8fe`  |  **NodeID**: `000201775795788884503c106901582f`
...
# XML解析
    ...
    **表1** XML解析选项，其详细介绍请参见[ParseOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-xml#parseoptions)。
       ...
       import { xml, util } from '@kit.ArkTS'; // 需要使用util模块函数对文本编码             对XML文本编码后调用XmlPullParser。
...
```
       ...
       import { xml, util } from '@kit.ArkTS'; // 使用util模块对文本编码             对XML文本编码后调用XmlPullParser。
...
```
       ...
       import { xml, util } from '@kit.ArkTS'; // 使用util模块函数对文本编码             对XML文本编码后调用XmlPullParser。
