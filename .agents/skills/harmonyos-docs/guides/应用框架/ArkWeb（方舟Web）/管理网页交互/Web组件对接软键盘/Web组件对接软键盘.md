...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `web-docking-softkeyboard`  |  **DocID**: `c13cadfe16484abc9027926fd1b2315f`  |  **NodeID**: `0002017757957888842329b5248269ae`
...
```
     ...
     在移动设备上，支持设置Web页面的软键盘避让模式。
      ...
      - 在应用代码中设置[UIContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-uicontext)的软键盘避让模式[setKeyboardAvoidMode()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-expand-safe-area#setkeyboardavoidmode11)。ArkWeb组件支持Resize和Offset两种模式。
