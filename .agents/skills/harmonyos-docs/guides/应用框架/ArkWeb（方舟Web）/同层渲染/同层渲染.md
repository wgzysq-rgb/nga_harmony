...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `web-same-layer`  |  **DocID**: `e3319aa727d640b19ab5cf4cf611f2db`  |  **NodeID**: `000201775795788884097118a9271444`
...
```
       ...
       如果使用<embed>标签，需要显式书写embed，并且type类型以"native/"开头；如果使用<object>标签，需要注册<object>标签及type类型。
                  ...
                  #### [h2]涉及界面交互的ArkUI组件（如TextInput等）光标与输入框错位该如何解决？
