...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `app-takeovers-web-media`  |  **DocID**: `bd645e43653748ff876ceb0193b302e5`  |  **NodeID**: `000201775795788884172d8245c1a7bd`
...
```
     ...
     该流程与[同层渲染](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-same-layer)绘制一致。
             ...
             在应用启动阶段，应用应保存[UIContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-uicontext)，以便后续的同层渲染绘制流程能够使用该UIContext。
