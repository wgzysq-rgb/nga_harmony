...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `web-clipboard`  |  **DocID**: `899ffef6b99e4c4da2374e241eaf3465`  |  **NodeID**: `000201775795788884299ddc7249444d`
...
```
                         通过异步剪贴板接口read()和readText()方法读取系统剪贴板数据，需[申请访问剪贴板权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/get-pastedata-permission-guidelines)：ohos.permission.READ_PASTEBOARD。
