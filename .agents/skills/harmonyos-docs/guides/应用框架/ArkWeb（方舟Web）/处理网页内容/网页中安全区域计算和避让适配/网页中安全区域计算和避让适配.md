...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `web-safe-area-insets`  |  **DocID**: `3d02c57bcec5495e8cd0ca6200ea97b4`  |  **NodeID**: `000201775795788884248b97dc9debe1`
...
```
     ...
     <meta name='viewport' content='viewport-fit=cover'>     如表1所示，viewport-fit默认为auto，与contain表现一致，表示网页内容全部包含在安全区域内。cover表示网页内容完全覆盖可视窗口，可能与非安全区域发生重叠。
