...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `web-app-page-data-channel`  |  **DocID**: `0cbf4920d91441f395a81a75dfdf66e3`  |  **NodeID**: `000201775795788884198275ab544c44`
...
```
                  #### [h2]onControllerAttached与javaScriptOnDocumentStart的执行顺序是什么？
