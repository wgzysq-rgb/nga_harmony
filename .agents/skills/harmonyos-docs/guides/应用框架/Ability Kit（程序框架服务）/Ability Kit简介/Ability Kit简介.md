...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `abilitykit-overview`  |  **DocID**: `a9bc25b589464514894e12421bcbd348`  |  **NodeID**: `0002017757957888840137b0579c87e5`
...
# Ability Kit简介
      ...
      - 应用的跨设备流转：通过应用的跨端迁移和多端协同，获得更好的使用体验。比如，在平板上播放的视频，迁移到智慧屏继续播放。详见[自由流转](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/distributed-overview)。
