...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `actions-entities`  |  **DocID**: `1fc7f24b63d44d9a9018a7b8fabc723a`  |  **NodeID**: `0002017757957888847912872436fbfd`
...
# 常见action与entities（不推荐使用）
    ...
    **常见action**
           ...
           ACTION_VIEW_DATA：查看数据，当使用网址uri时，则表示显示该网址对应的内容。具体操作流程请见[通过startAbility拉起文件处理类应用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/file-processing-apps-startup)。
