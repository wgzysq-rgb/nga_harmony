...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `app-service-extension-ability`  |  **DocID**: `0db35acad10a44be8762d08307059392`  |  **NodeID**: `00020177579578888469727c1f3504e7`
...
# 使用AppServiceExtensionAbility组件实现后台服务
     ...
     在DevEco Studio工程中手动新建一个AppServiceExtensionAbility组件，具体步骤如下：
             ...
             在工程Module对应的ets目录下，右键选择“New > Directory”，新建一个目录并命名为myappserviceextability。
