...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `start-express-apps`  |  **DocID**: `d910a3f86c074af89a2482be0e5425b2`  |  **NodeID**: `000201775795788884865d7421a64231`
...
```
       效果示例图：
             ...
             在module.json5中配置[uris](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#skills标签)：
