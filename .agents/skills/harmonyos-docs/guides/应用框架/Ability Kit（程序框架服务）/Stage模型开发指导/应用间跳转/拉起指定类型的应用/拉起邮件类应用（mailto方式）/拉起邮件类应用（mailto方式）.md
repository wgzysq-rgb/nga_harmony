...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `start-email-apps-by-mailto`  |  **DocID**: `80b50d028cd6472dad715f6288a3582d`  |  **NodeID**: `000201775795788884812387e0160293`
...
# 拉起邮件类应用（mailto方式）
     ...
     <a href="mailto:support@example.com?subject=Product Inquiry&body=I am interested in...">联系我们</a>     实际开发时，需要将邮箱地址替换为真实的邮箱，邮件内容可以根据需要进行配置。
...
```
     实现效果如下：
             ...
             为了能够支持被其他应用通过mailto协议拉起，目标应用需要在[module.json5配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file)中声明mailto。
