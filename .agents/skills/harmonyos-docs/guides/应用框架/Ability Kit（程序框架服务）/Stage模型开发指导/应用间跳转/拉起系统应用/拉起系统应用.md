...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `system-app-startup`  |  **DocID**: `1deac61a44c449128639718eec639dec`  |  **NodeID**: `0002017757957888845427b687cc6090`
...
# 拉起系统应用
     ...
     [Payment Kit](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/payment-introduction)提供了[requestPayment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-paymentservice#paymentservicerequestpayment)接口，可以实现单次支付、支付并签约。
