...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `start-navigation-apps`  |  **DocID**: `2b3081884a7f416b82f410ec9c7c1ff3`  |  **NodeID**: `000201775795788884721a5f731c222e`
...
# 拉起导航类应用（startAbilityByType）
     ...
     startAbilityByType接口中type字段为navigation，支持路线规划、导航、位置搜索三种意图场景，对应的wantParam参数如下：
       ...
       import { common } from '@kit.AbilityKit';             构造接口参数并调用startAbilityByType接口。
...
```
       效果示例图：
             ...
             在module.json5中配置[uris](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#skills标签)，步骤如下：
...
```
       ...
       UIAbility.onCreate(want: Want, launchParam: AbilityConstant.LaunchParam): void       在参数**want.uri**中会携带目标方配置的linkFeature对应的uri。
