...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pageability-launch-type`  |  **DocID**: `3335888da84c4cc5b9c36d5b9284ee2b`  |  **NodeID**: `000201775795788884789740bb3c7a8a`
...
| 启动模式  | 描述  | 说明  
 ...
 | multiton  | 多实例模式  缺省启动模式。每次调用startAbility方法时，都会在应用进程中创建一个新的Ability实例。表现为在最近任务列表中可以看到有多个该类型的Ability实例。
