...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `serviceability-configuration`  |  **DocID**: `754663b5511644c882561479839d37b5`  |  **NodeID**: `000201775795788884734864ef6ec477`
...
# ServiceAbility组件配置
    ...
    **表1** ServiceAbility部分配置项说明
        ...
        ServiceAbility支持的配置项及详细说明详见[module对象内部结构](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-structure)。
