...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `access-dataability`  |  **DocID**: `e3ae3567d25c441281e55b9e5074813b`  |  **NodeID**: `000201775795788884855feb6c72baf0`
...
```
      注：关于DataAbilityPredicates的详细内容，请参考[DataAbility谓词](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-ability)。
...
```
    ...
    DataAbility的客户端的接口是由工具接口类对象DataAbilityHelper向外提供，相关接口可参考[DataAbilityHelper模块](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-ability-dataabilityhelper)。
