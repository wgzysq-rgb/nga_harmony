...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `share-app-file`  |  **DocID**: `87499be9e7534cb2a499056659f920d6`  |  **NodeID**: `000201775795788884234d44cb68add8`
...
# 应用文件分享
     ...
     格式为：file://<bundleName>/<path>
        ...
        - 推荐使用系统提供的接口获取URI，如[getUriFromPath接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fileuri#fileurigeturifrompath)。
