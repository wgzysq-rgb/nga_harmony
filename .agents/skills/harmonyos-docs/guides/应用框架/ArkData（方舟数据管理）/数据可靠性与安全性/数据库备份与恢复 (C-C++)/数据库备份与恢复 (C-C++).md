...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-backup-and-restore`  |  **DocID**: `ac86a92836cc4daca1eab5b0df693474`  |  **NodeID**: `00020177579578888420228897e6085d`
...
config = nullptr;
```
  调用OH_Rdb_RegisterCorruptedHandler接口注册数据库异常处理。
...
```
  调用OH_Rdb_UnregisterCorruptedHandler接口取消注册数据库异常处理。
