...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-vector-store-guidelines`  |  **DocID**: `d8e6abb014c74d6bb18e9b139fa9279b`  |  **NodeID**: `000201775795788884328ab7f87f9f04`
...
```
             获取到OH_Rdb_Store后，修改或删除数据。示例代码如下：
