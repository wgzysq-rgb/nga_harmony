...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `data-sync-of-distributed-data-object`  |  **DocID**: `398afd5350494de491a8577e1333c703`  |  **NodeID**: `0002017757957888842632d61c114b44`
...
```
       ...
       3.3 从want中获取源端放入的sessionId，使用这个sessionId加入组网。
                 ...
                 跨设备Call调用实现的多端协同开发需要申请ohos.permission.DISTRIBUTED_DATASYNC权限和配置单实例启动标签，详见[通过跨设备Call调用实现多端协同](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-cross-device-interaction)。
