...
> **分区**: Guides  |  **Slug**: `data-cloud-sync-of-rdb-store`  |  **DocID**: `4b9bcecef0bf47e49cfee4d318bef6a9`  |  **NodeID**: `000201776839955443583d91b476ec57`
...
导入模块。
  ...
  import { relationalStore,cloudData } from '@kit.ArkData';  设备A创建关系型数据库，设置端云同步分布式表。
