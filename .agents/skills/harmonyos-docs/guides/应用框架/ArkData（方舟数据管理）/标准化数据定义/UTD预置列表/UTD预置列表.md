...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `uniform-data-type-list`  |  **DocID**: `69d33508d6f7454fb6ff55af357545f8`  |  **NodeID**: `000201775795788884322c2a4d402359`
...
| **UTD-ID**  | **BelongingTo类型**  | **后缀名**  | **MIMEType类型**  | **说明**  
 ...
 | general.kml  | general.xml,general.navigation  | .kml  | application/vnd.google-earth.kml+xml  | KML地理标记语言。从HarmonyOS 6.0.2开始支持此类型。  
 | general.kmz  | general.archive,general.navigation  | .kmz  | application/vnd.google-earth.kmz  | KMZ文件压缩格式。从HarmonyOS 6.0.2开始支持此类型。  
 | general.gpx  | general.xml,general.navigation  | .gpx  | application/gpx+xml  | GPS位置数据格式。从HarmonyOS 6.0.2开始支持此类型。  
 | com.apple.iwork  | general.archive  | -  | -  | iWork类型基类。从HarmonyOS 6.0.2开始支持此类型。  
...
| **UTD-ID**  | **BelongingTo类型**  | **后缀名**  | **MIMEType类型**  | **说明**  
 ...
 | openharmony.hsp  | openharmony.package  | .hsp  | -  | HarmonyOS系统定义的动态共享包。  
 | openharmony.har  | openharmony.package  | .har  | -  | HarmonyOS系统定义的静态共享包。  
