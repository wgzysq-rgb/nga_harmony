...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ui-design-set-hds-slide-horizon-listitem`  |  **DocID**: `59775e7a0d694880bf7af82ead9ef8e9`  |  **NodeID**: `0002017757957888841199bac444f086`
...
```
             简单配置页面的布局，调用HdsListItem的接口绘制列表的横滑动效按钮的内容和样式。
