...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ui-design-normal-process`  |  **DocID**: `e0277db8ef744c2db1fe4ed04d9e378e`  |  **NodeID**: `000201775795788884165c1b86a55aab`
...
```
             简单配置页面的布局，调用[单层图标接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsdrawable#hdsdrawablegethdsicon)获取处理后的图标信息，也可以调用[异步批量处理接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsdrawable#hdsdrawablegethdsicons)。
