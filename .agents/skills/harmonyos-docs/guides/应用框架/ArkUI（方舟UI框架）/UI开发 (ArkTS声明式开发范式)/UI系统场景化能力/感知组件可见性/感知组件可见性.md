...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-manage-components-visibility`  |  **DocID**: `9e76eca7ccd1465f8005093778d17ed3`  |  **NodeID**: `000201775795788884508ba67963aaca`
...
```
     ...
     **解决措施**
      ...
      - 尝试将[measureFromViewport](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-component-visible-area-change-event#onvisibleareachange22)设置为true进行验证。
