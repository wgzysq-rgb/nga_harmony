...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-embedded-components`  |  **DocID**: `2d9058e55c29443ca1604cd717dac450`  |  **NodeID**: `00020177579578888469643f565f8e94`
...
```
     **预期效果**
             ...
             在支持EmbeddedUIExtensionAbility的设备上启动应用；

       

             点击terminateSelfWithResult按钮，提供方内容消失，页面显示onTerminated信息。
