...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-persiststorage`  |  **DocID**: `37480045c4d24bb2a0dcd061c33c286c`  |  **NodeID**: `000201775795788884922318002d73f5`
...
```
       ...
       AppStorage.get<number>('aProp'); // returns 47       或在组件内部定义：
...
```
       ...
       **图1** PersistProp初始化流程
        ...
        - 在TestPageOne组件里，@StorageLink绑定的“aProp”为PersistentStorage写入AppStorage中的值，即为上一次退出应用存入的值。
