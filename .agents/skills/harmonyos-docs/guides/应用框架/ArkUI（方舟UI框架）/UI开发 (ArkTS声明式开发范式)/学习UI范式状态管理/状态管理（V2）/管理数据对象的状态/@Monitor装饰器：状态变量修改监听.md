...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-new-monitor`  |  **DocID**: `8c48b2c63d1c44bfb7a1ba5616e113ce`  |  **NodeID**: `0002017757957888849114306a50a687`
...
```
                  #### [h2]无法监听变量从可访问变为不可访问和从不可访问变为可访问
