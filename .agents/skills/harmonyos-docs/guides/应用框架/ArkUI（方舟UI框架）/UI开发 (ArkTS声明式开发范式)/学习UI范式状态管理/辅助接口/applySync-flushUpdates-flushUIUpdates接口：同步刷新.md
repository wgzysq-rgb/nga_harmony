...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-new-applysync-flushupdates-flushuiupdates`  |  **DocID**: `7173a03501d14940a22908bf458fddc4`  |  **NodeID**: `00020177579578888478881f1966f725`
...
struct Index {
  ...
  animateAction() {
    this.getUIContext().animateTo({
      ...
      // 调用applySync接口同步刷新动画尾帧，若不调用该接��则不显示动画
      UIUtils.applySync(() => {
        this.x = 100;
        this.y = 100;
      });
