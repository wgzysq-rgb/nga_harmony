...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-new-type`  |  **DocID**: `76cd1b6611634c5cb41a8d62abde5c26`  |  **NodeID**: `000201775795788884927318de77048e`
...
```
             ...
             不支持非built-in类型。如[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)、NativePointer、[ArrayList](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arraylist)等Native类型。
