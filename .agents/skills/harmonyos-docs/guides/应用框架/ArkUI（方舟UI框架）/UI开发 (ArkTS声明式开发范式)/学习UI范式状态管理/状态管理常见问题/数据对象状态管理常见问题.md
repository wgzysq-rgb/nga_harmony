...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-state-management-faq-inner-class`  |  **DocID**: `28c95d28fa0c46b0816c1263ec2117cc`  |  **NodeID**: `000201775795788884725a9d7c146812`
...
```
     ...
     为了减少由简单的属性相关的数组引起的“冗余刷新”，需要将属性数组转变为对象数组，配合自定义组件，实现精准控制更���范围。
