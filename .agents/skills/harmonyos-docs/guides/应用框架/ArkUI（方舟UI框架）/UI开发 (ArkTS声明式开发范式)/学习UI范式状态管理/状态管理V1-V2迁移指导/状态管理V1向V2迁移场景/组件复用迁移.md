...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-v1-v2-migration-reusable`  |  **DocID**: `6d93f578d6fe410ea88da6ddfaeba78a`  |  **NodeID**: `000201775795788884923f1828e33f39`
...
# 组件复用迁移
     ...
     **迁移规则**
             ...
             涉及组件内状态变量的迁移可参考[组件内状态变量迁移指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-v1-v2-migration-inner-component)。
                  ...
                  #### [h2]aboutToRecycle与aboutToReuse迁移
