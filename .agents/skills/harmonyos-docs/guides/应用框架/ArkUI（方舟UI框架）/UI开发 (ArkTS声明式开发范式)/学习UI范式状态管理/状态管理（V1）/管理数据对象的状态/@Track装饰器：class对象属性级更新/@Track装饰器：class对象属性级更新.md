...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-track`  |  **DocID**: `7bcbfdcb91094e689604d53ec4cf4d96`  |  **NodeID**: `000201775795788884900aefce4efe8c`
...
```
     在上面的示例中：
       ...
       Text 1 is rendered             类logNotTrack中的属性均未被@Track装饰器装饰，点击按钮"change logNotTrack.str1"，此时Text3、Text4均会刷新，有两条日志输出，存在冗余刷新。
