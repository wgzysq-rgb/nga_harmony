...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-new-computed`  |  **DocID**: `86c0e26e5c194e40a49a067a8e97c4a9`  |  **NodeID**: `000201775795788884921df99229a21f`
...
| @Computed方法装饰器  | 说明  
 ...
 | 被执行的时机  @ComponentV2中的@Computed会在自定义组件创建的时候初始化，触发@Computed计算。
