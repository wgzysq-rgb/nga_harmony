...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-gesture-events-multi-level-gesture`  |  **DocID**: `e65ce1e8404245519bb9f4e6a154061f`  |  **NodeID**: `000201775795788884809cd838094866`
...
```
     ...
     当组件A设置hitTestBehavior为HitTestMode.None时，点击��件B区域时，组件B的onTouch事件触发，而组件A的onTouch事件无法触发，组件B的点击手势触发。
