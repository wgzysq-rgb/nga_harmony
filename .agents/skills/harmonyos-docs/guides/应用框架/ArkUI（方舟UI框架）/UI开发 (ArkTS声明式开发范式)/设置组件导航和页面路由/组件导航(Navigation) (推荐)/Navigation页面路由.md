...
> **分区**: Guides  |  **Slug**: `arkts-navigation-jump`  |  **DocID**: `173db5427c5843d4a9e4a363eb5b21c2`  |  **NodeID**: `0002017768399554431174ce320c2fe2`
...
```
     ...
     实现步骤为：
             ...
             在Navigation中增��List组件，来定义导航主页中不同的一级界面。
