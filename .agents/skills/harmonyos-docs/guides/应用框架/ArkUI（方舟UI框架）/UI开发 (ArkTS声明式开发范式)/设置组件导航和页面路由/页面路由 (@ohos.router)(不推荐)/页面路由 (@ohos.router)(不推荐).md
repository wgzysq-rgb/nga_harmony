...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-routing`  |  **DocID**: `6ba83381c29e4549a5fb67c83d019a2f`  |  **NodeID**: `000201775795788884509a43e049809f`
...
```
     ...
     **图2** 页面返回
     ...
     this.getUIContext().getRouter().back();     这种方式会返回到上一个页面，即上一个页面在页面栈中的位置。但是，上一个页面必须存在于页面栈中才能够返回，否则该方法将无效。
