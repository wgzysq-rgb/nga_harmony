...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-mutablebuilder`  |  **DocID**: `38e6a6c6f3e24934a7abbe114d0d94c5`  |  **NodeID**: `000201775795788884841bf3c8e113e8`
...
```
     ...
     declare function mutableBuilder<Args extends Object[]>(builder: BuilderCallback): MutableBuilder<Args>;     同时MutableBuilder对象是一个模板类，继承自[WrappedBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrapbuilder#接口说明)。
