...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-custom-components-access-restrictions`  |  **DocID**: `3c2f84411108407293e1370d45d8b4a7`  |  **NodeID**: `00020177579578888479425ebf89d9c0`
...
当成员变量被private访问限定符和@State/@Prop/@Provide/@BuilderParam装饰器同时修饰，并且通过父组件进行初始化赋值，ArkTS会进行校验并产生告警日志。
...
```
  ...
  The member attributes of a struct can not be protected.  【正例】
