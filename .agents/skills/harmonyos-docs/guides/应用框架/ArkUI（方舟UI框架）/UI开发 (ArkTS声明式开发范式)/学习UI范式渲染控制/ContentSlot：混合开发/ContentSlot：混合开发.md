...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-rendering-control-contentslot`  |  **DocID**: `fdc9fac21f2347e1a997d1990406d134`  |  **NodeID**: `000201775795788884603e10960b90bc`
...
```
          ...
          } [ArkUI_NodeContentEventType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodecontenteventtype)
