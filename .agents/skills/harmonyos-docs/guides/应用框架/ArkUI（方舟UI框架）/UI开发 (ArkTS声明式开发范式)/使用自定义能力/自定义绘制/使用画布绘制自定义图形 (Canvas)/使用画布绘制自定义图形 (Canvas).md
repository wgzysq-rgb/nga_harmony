...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-drawing-customization-on-canvas`  |  **DocID**: `6a057eaa1bd74f2f833800af0d1abdd9`  |  **NodeID**: `00020177579578888463327868fc23ae`
...
```
     ...
     import lottie from '@ohos/lottie'     具体接口请参考[lottie](https://gitcode.com/openharmony-tpc/lottieArkTS)。
