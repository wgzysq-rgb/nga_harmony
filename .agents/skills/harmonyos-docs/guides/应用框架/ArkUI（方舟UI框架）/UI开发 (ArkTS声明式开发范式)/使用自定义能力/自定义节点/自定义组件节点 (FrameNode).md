...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-user-defined-arktsnode-framenode`  |  **DocID**: `5e4972be835c418a9770e4c621daf914`  |  **NodeID**: `000201775795788884777e6ee743b912`
...
```
     ...
     查找获得FrameNode的方式包括三种：
             ...
             使用[getFrameNodeById](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-uicontext#getframenodebyid12)获取。

             使用[getFrameNodeByUniqueId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-uicontext#getframenodebyuniqueid12)获取。

             通过[无感监听](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-observer)获取。
