...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-user-defined-extension-drawmodifier`  |  **DocID**: `57b89e8f494b4b1bbe73f42f1d580ac6`  |  **NodeID**: `0002017757957888847076cc1ef755ea`
...
```
     ...
     从API version 12开始，通过重写DrawModifier中的[drawContent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-draw-modifier#drawcontent)方法，可以替换组件��本的内容绘制函数。
