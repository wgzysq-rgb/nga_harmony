...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `js-framework-js-tag`  |  **DocID**: `bc7d6362f7d64afc811e5547bff11488`  |  **NodeID**: `000201775795788884431f0295cab272`
...
| 属性  | 类型  | 必填  | 缺省值  | 描述  
  | designWidth  | number  | 否  720

  | 页面显示设计时的参考值，实际显示效果基于设备宽度与参考值之间的比例进行缩放。  
 | autoDesignWidth  | boolean  | 否  | false  页面设计基准宽度是否自动计算。
