...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `js-framework-resource-restriction`  |  **DocID**: `b993e12bbad24280aeadee449d4ca682`  |  **NodeID**: `0002017757957888845881ac52ba0701`
...
| 属性  | 类型  | 描述  
  | $r  | (key: string) => string  获取资源限定下具体的资源内容。例如：$r('strings.hello')。
