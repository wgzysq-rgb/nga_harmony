...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ndk-embed-arkts-components`  |  **DocID**: `b6bb5b97f2f14ae9bb6fb3823453934a`  |  **NodeID**: `0002017757957888843384cefe37a34e`
...
```
           Native侧通过Node-API保存创建和更新函数，用于后续调用。
...
```
           使用[接入ArkTS页面](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-access-the-arkts-page)章节的页面结构，将Refresh组件作为文本列表的父组件。
...
```
           在Native侧提供Node-API的桥接方法，实现ArkTS侧的NativeNode模块接口。
