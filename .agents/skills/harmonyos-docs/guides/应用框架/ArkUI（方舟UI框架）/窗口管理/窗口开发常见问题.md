...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `window-faqs`  |  **DocID**: `7041d7e9f5ce4665923619ce964eefbc`  |  **NodeID**: `0002017757957888843500758e989ed1`
...
```
     ...
     **问题现象**
     ...
     因为历史问题，主窗场景调用[getWindowProperties()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#getwindowproperties9)获取到的窗口类型即[WindowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-e#windowtype7)为TYPE_SYSTEM_ALERT而不是TYPE_MAIN。
