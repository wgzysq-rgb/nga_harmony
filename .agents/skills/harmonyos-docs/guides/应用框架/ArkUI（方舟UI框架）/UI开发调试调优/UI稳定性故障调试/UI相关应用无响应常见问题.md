...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-stability-freeze-issues`  |  **DocID**: `342b06bc7ee64427a375dbf479a1b058`  |  **NodeID**: `000201775795788884506517dec8051b`
...
```
     **可能原因**
     ...
     应用设置的syncLoad接口用于同步下载网络图片，系统将在主线程中加载图片。在网络条件不佳时，可能会导致任务阻塞。

     **解决措施**

     网络图片加载不应设置syncLoad=true。

     **参考链接**

     相关接口详见[syncLoad](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image#syncload8)。
