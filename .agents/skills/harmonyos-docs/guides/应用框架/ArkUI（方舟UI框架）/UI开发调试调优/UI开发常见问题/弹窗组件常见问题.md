...
> **分区**: Guides  |  **Slug**: `arkts-popup-component-faq`  |  **DocID**: `322842bb58aa492291abcade56586b44`  |  **NodeID**: `00020177683995544389548e8dc4ef53`
...
# 弹窗组件常见问题
     ...
     **可能原因**
     ...
     Popup气泡优先在开发者设置的placement位置显示，当空间不足时会按以下策略自动避让。
             ...
             如果四周空间均不足以完整显示气泡，则默认气泡会遮挡绑定组件进行显示。如果开发者不期望遮挡绑定组件，可通过设置[avoidTarget](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-popup#popupoptions类型说明)属性为AvoidanceMode.AVOID_AROUND_TARGET来解决，此时气泡在剩余空间不足的情况下会进行压缩以避免遮挡绑定组件。
