...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ui-ide-previewer`  |  **DocID**: `9d586c2ad7c14a428c74e990115b3631`  |  **NodeID**: `000201775795788884260e43e96c4a3a`
...
# UI预览
     ...
     支持在修改组件的属性时，无需使用Ctrl+S进行保存，可以直接观察到修改后的预览效果。极速预览默认开启，若需关闭，点击预览器右上角按钮即可。
