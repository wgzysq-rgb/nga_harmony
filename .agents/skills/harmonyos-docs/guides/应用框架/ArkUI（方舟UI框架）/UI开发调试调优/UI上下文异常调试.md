...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-wrong-uicontext-debug`  |  **DocID**: `005c08836cdd47e5b47ae4b662105600`  |  **NodeID**: `0002017757957888842246665646258d`
...
# UI上下文异常调试
     ...
     **问题现象**
     ...
     当发生以下问题时，可根据上文的关键日志或异常进行判断：
      ...
      - 使用[setStyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text#setstyledstring12)方法设置字体大小时，字体大小未发生预期变化。
     ...
     **解决措施**
     ...
     重新获取有效的UIContext对象。可通过以下方式获取：
      ...
      - 使用自定义组件的[getUIContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-custom-component-api#getuicontext)方法获取。
      - 通过窗口的[getUIContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#getuicontext10)方法获取。
