...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkts-layout-debug`  |  **DocID**: `9e30d22b9d2a47678805cbd3082d4df6`  |  **NodeID**: `000201775795788884154e9fbd8cc273`
...
# UI显示异常调试
     ...
     **单个节点**
     ...
     下面通过具体案例，介绍如何解决UI显示异常问题。
                  ...
                  #### [h2]通过ComponentUtils.getRectangleById获取的tabBar组件坐标尺寸异常
