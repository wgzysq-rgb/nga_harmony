...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `displaymanager-faqs`  |  **DocID**: `86f13fa387e8400eaafbc8b9b8c8d648`  |  **NodeID**: `0002017757957888842737c8035fc46f`
...
# 屏幕开发常见问题
     ...
     **问题现象**
     ...
     获取虚拟屏的Display对象后，orientation属性值为4，未在[Orientation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display#orientation10)枚举范围中。
