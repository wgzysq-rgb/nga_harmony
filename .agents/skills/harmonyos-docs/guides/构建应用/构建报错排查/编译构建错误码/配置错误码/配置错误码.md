...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-hvigor-errorcode-00303-1`  |  **DocID**: `683075bbff4e4bcea67ca23f06cef51f`  |  **NodeID**: `000201775790135918932bf35591681e`
...
# 配置错误码
     ...
     **处理步骤**
      ...
      - [下载](https://developer.huawei.com/consumer/cn/download/)一体化DevEco Studio工具。
     ...
     **处理步骤**
     ...
     确保元服���工程的module.json5中包含mainElement字段。
...
```
     ...
     **处理步骤**
      ...
      - 在**File > Settings > ArkUI-X**（macOS为**DevEco Studio > Preferences/Settings > ArkUI-X**）下载SDK。
     ...
     **处理步骤**
      ...
      - 检查项目根目录下的[hvigorconfig.ts文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-life-cycle#section810245135914)，确保includeNode方法的参数name字段存在且非空。
     ...
     **处理步骤**
      ...
      - 检查项目根目录下的[hvigorconfig.ts文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-life-cycle#section810245135914)，确保includeNode方法的参数srcPath字段存在且非空。
