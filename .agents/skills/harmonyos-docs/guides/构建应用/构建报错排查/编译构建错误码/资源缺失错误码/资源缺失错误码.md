...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-hvigor-errorcode-00304`  |  **DocID**: `dd7fbfb4825d4dae8947261c21338211`  |  **NodeID**: `000201775790135918933a38cc81b28e`
...
- 默认资源目录src/main/resources不存在或路径错误。
- 当前目标的资源目录配置不正确或未配置。
...
- 默认资源目录src/main/resources下的profile文件不存在。
...
- 点击**Build > Clean Project**删除缓存后重新构建，检查文件是否生成。
- 如果文件仍未生成，通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题，华为支持人员会及时处理。
