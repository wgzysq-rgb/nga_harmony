...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-hvigor-experimental-properties`  |  **DocID**: `c58bbb0e74b84f6d8998c035fb1eb56c`  |  **NodeID**: `000201775790135918912948bc3a599a`
...
- 按照以上方式开启开关**Enable ohpm execution by hvigor**。
...
- 首次修改cpp文件时，IClang会将该文件识别为频繁修改的目标文件，并为其生成缓存。因此，当���二次修改cpp文件并进行增量编译时，才会提升编译效率。
