...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-hvigor-build-analyzer`  |  **DocID**: `fa58e132f6b24a6c86016d86ff6d4e3d`  |  **NodeID**: `00020177579013591888840fd0d7b6ed`
...
- 通过命令行方式生成构��可视化html文件。如生成HAP模块的构建可视化html文件，命令如下：```
