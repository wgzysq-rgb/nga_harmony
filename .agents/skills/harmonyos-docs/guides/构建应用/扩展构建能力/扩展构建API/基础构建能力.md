...
> **分区**: Guides  |  **Slug**: `ide-hvigor-api`  |  **DocID**: `dcaa56517a1c4113bf4f2d228715ec2f`
 ...
 **返回值:**
  ...
  说明
    ...
    [HvigorNode](#section14832104719474)
 ...
 **参数:**
 ...
 当工程名和模块名相同时，可通过此参数指定获取工程或模块的节点对象。支持以下三种取值：

 
- project：当工程名和模块名相同时，返回工程的节点对象。
- module：当工程名和模块名相同时，返回模块的节点对象。
- node（缺省值）：当工程名和模块名相同时，返回模块的节点对象。
  ...
  说明
    ...
    [HvigorNode](#section14832104719474) | undefined
 ...
 **返回值:**
  ...
  说明
    ...
    [HvigorConfig](#section7253174081515)
 ...
 **返回值:**
  ...
  说明
    ...
    [Parameter](#section18886457152915)
 ...
 **参数:**
  ...
  ([BuildResult](#section1476618469121)) => {}
 ...
 **返回值:**
  ...
  构建的入口任务名字符串数组，如果不存在返回undefined

      **示例：**获取入口任务并打印出来。```
import { hvigor } from '@ohos/hvigor';
console.log(hvigor.getCommandEntryTask());
```
   #### [h2]isCommandEntryTask
 ...
 **参数:**
  ...
  hvigor节点对象，如果入参scriptPath未指向本工程内的hvigorfile.ts则返回undefined
 ...
 **返回值:**
  ...
  说明
    ...
    [HvigorNodeDescriptor](#section1914012226435)
 ...
 **返回值：**
  ...
  说明
    ...
    [HvigorNodeDescriptor](#section1914012226435)[] | undefined

  所有的子节点描述对象，不存在子节点则返回undefined

      **示例：**

 ```
// [hvigorconfig.ts](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-life-cycle#section810245135914)
 ...
 **参数:**
  ...
  properties配置中指定key对应的value值（string，number, boolean类型），若不存在配置时返回undefined
 ...
 **参数:**
  ...
  [HvigorTask](#section2386634104512)
 ...
 ```
// node的获取方式请参考[获取实例](#section17571175618316)
node.registerTask({
    name: 'customTask',
    run() {
 ...
 **参数:**
  ...
  说明
    ...
    [Task](#section2055582515349) | undefined
 ...
 **参数:**
  ...
  (node: [HvigorNode](#section14832104719474)) => void
 ...
 **返回值:**
  ...
  说明
    ...
    [NormalizedFile](#section281448112713)
 ...
 **参数:**
  ...
  [TaskOutput](#section135442202125)
 ...
 **参数:**
  ...
  [HvigorTaskContext](#section17880854104213)
 ...
 **参数:**
  ...
  string | [NormalizedFile](#section281448112713)
 ...
 **参数：**
  ...
  要执行的worker的文件路径，可以拼接函数名称，例如D:/xx/a.js/run是指运行a.js的run方法。

   workerOption

  [WorkerOption](#section2701859185318)
 ...
 **起始版本：**Hvigor 6.0.4
  ...
  priority?: [Priority](#section162915519616);
  ...
  回调函数入参是否使用线程执行结束的返回值，优先级高于callbackInput。
 ...
 **起始版本：**Hvigor 6.0.4
  ...
  getPriority(): [Priority](#section162915519616);
  ...
  回调函数是否使用线程执行结束的返回值作为输入。

---
*Updated: 2026-04-24 01:28:42*
