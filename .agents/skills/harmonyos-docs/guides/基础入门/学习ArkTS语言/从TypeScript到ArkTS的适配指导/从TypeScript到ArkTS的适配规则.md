...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `typescript-to-arkts-migration-guide`  |  **DocID**: `f5f109fa5c184396b334f12fb350febc`  |  **NodeID**: `000201775795466123516a7b98727cc1`
...
```
 ...
 let u: U = new T(); // 是否允许？ 类型为T的值是否能传递给接受类型为U的参数的函数。
 ...
 **TypeScript**
 ...
 import { obj } from 'something.json' assert { type: 'json' } **ArkTS**
