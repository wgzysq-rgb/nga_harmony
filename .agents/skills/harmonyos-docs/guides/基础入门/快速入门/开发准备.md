...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `start-overview`  |  **DocID**: `ece5b9d0040441f6904feeb20446a107`  |  **NodeID**: `0002017757954661234964c318085b00`
...
**FA（Feature Ability）模型：** HarmonyOS API 7开始支持的模型，已经不再主推。FA模型开发可见[FA模型开发概述](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/fa-model-development-overview)。**快速入门章节不再详细说明此模型**。
