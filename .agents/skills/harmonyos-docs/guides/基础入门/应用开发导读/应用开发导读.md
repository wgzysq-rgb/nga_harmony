...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `application-dev-guide`  |  **DocID**: `1f330742a21340bbb3eea142d27e14df`  |  **NodeID**: `00020177579546612348998e0c94b4ab`
...
应用框架相关Kit开放能力：Ability Kit（程序框架服务）、ArkUI（方舟UI框架）等。
  ...
  AI相关Kit开放能力：Intents Kit（意图框架服务）、CANN Kit（CANN异构计算框架服务）等。
