...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `deviceconfig-structure`  |  **DocID**: `c715c08a5d394e44bb83e5b902cea974`  |  **NodeID**: `000201775795466123521fe6f6f78487`
...
| 属性名称  | 含义  | 数据类型  | 是否可缺省  
  | cleartextPermitted  标识自定义域名范围内是否允许明文流量传输。cleartextTraffic和securityConfig同时存在时，以cleartextPermitted的值为准。
 ...
 - subdomains：表示是否包含子域名。取值为"true"时，表示该规则将与相应域名及所有子域名（包括子域名的子域名）匹配；取值为"false"时，规则仅适用于精确匹配项。
