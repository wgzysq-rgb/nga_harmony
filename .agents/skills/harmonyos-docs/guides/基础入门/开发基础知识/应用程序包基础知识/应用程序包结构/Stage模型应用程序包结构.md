...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `application-package-structure-stage`  |  **DocID**: `bb7799a33a884ba2b6524bfcafd49e6f`  |  **NodeID**: `00020177579546612353470d1707121b`
...
| 文件类型  | 说明  
 ...
 | 资源文件  包括应用级资源文件、以及Module级资源文件，支持图形、多媒体、字符串、布局文件等，详见[资源分类与访问](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/resource-categories-and-access)。
