...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hap-package`  |  **DocID**: `fd1e7a78c3f74e918c3e876a148e84c6`  |  **NodeID**: `0002017757954661235334a648567bd5`
...
# HAP
    ...
    应用程序包可以只包含一个基础的entry包，也可以包含一个基础的entry包和多个功能性的feature包。
     ...
     下面简要介绍如何通过DevEco Studio新建一个HAP模块。
             ...
             在工程目录上单击右键，选择**New > Module**。

             在弹出的对话框中选择**Empty Ability**模板，单击**Next**。

             在Module配置界面，配置**Module name**，选择**Module Type**和**Device Type**，然后单击**Next**。

             在Ability配置界面，配置**Ability name**，然后单击**Finish**完成创建。
