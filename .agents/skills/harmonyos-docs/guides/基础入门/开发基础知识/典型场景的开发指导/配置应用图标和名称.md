...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `layered-image`  |  **DocID**: `a6885f7fbe034d8dae5a1517af450f81`  |  **NodeID**: `000201775795466123528e0a8397ec57`
...
```
                 在[app.json5配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-configuration-file)中引用分层图标资源文件。示例如下：
