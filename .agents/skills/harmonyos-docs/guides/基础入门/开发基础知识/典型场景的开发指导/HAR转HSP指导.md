...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `har-to-hsp`  |  **DocID**: `8119969398d24a9b8a7307210cc655ac`  |  **NodeID**: `00020177579546612352922636b9ba39`
...
```
             ...
             修改HAR模块的hvigorfile.ts文件，将以下内容替换文件内容。
