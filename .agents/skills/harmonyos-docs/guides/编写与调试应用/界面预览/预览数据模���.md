...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-previewer-mock`  |  **DocID**: `3f302bca6d9649a89f438e612244ead7`  |  **NodeID**: `0002017757901225582661613edfb825`
...
```
// src/mock/module/utils/CommonUtils.mock.ets
// 导入本地模块
...
// Mock methodA方法
export const methodAMock = (): string => {
  return "methodA Mocked"
}
export {
  methodAMock as methodA,
  ObjectB,
}
