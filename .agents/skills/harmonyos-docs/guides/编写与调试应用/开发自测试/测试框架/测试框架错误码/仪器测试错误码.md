...
> **分区**: Guides  |  **Slug**: `ide-instrument-test-errorcode`  |  **DocID**: `67dfa09801984709b27d4d8fd31ea5d9`
...
- 参考[使用本地真机运行应用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-run-device)连接设备，并打开开发者选项中的USB调试。
- 移除多余的设备，确保只连接一个设备。
