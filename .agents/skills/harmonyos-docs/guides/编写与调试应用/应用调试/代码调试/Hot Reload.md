...
> **分区**: Guides  |  **Slug**: `ide-hot-reload`  |  **DocID**: `7a533937fc2f47568f6cba1af0f109f3`
...
# Hot Reload
    ...
    从DevEco Studio 5.1.1 Beta1版本开始支持热重启能力。
     ...
     如果需要使用热重启的能力，先打开对应开关：点击菜单栏**File > Settings**（macOS为**DevEco Studio > Preferences/Settings**）** > ****Build, Execution, Deployment > Hot Reload**，勾选**Enable hot restart****(to hot reload and restart app)**，点击**OK**完成设置。
      ...
      - 连接真机设备或模拟器。
      在下拉菜单中，将运行/调试配置切换为Hot Reload的配置。       

       

       

      - 运行/调试应用，请参考[使用本地真机运行应用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-run-device)或[使用模拟器运行应用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-run-emulator)。
      修改代码后，可以通过如下操作，查看设备上修改后的显示效果。       
