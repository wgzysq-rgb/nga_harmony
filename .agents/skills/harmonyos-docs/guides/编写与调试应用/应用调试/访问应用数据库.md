...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-database-inspector`  |  **DocID**: `99b3487a53ec4525a9eebc7b58c06af1`  |  **NodeID**: `000201775790122558262807d4a8217f`
...
点击菜单栏**View > Tool Windows > Database Inspector**，打开Database Inspector。
...
- 从设备下拉列表中选择设备（设备需已连接）。
选择包名，点击右侧的**Connect to Databases**按钮，即可查看数据库相关信息。（如果使用DevEco Studio 6.0.2 Beta1版本，按钮名称是**Execute**）。
...
左侧区域点击**New Query**后，右侧会出现**SQL Editor**页签，根据需要选择数据库，并输入SQL后，点击**Execute**按钮即可查看或修改数据。
