...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-emulator-specification`  |  **DocID**: `59618fd373ad4b9a97d15e52ebfa009a`  |  **NodeID**: `000201775790122558300c8b792b2630`
...
**表1 **模拟器和真机的其他重要差异
 ...
 TEE（Trusted Execution Environment，可信执行环境）
  ...
  不支持安全GPS、设备证书等，部分安全相关Kit暂不支持，详情参考[安全Kit简介](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/system-security)
