...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `store-update`  |  **DocID**: `a05b8241cd2948c6b28f5b9568138ed4`  |  **NodeID**: `000201775795649085756d97489f3d19`
...
```
             构造参数，其中入参为[common.UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext)类型的Context。

       let context: common.UIAbilityContext = this.getUIContext().getHostContext() as common.UIAbilityContext;             调用[checkAppUpdate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-updatemanager#updatemanagercheckappupdate)方法检查应用版本是否有更新。
...
```
       ...
       let context: common.UIAbilityContext = this.getUIContext().getHostContext() as common.UIAbilityContext;             调用[showUpdateDialog](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-updatemanager#updatemanagershowupdatedialog)方法显示升级对话框。
