...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `store-attribution-developmentguide`  |  **DocID**: `ab344cdd843246ee88475c3b479c186d`  |  **NodeID**: `000201775795649086038e0c6196b492`
...
```
             构造参数[AdSourceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-attributionmanager#adsourceinfo)。
...
```
             调用[attributionManager.registerSource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-attributionmanager#attributionmanagerregistersource)方法登记归因来源信息。
...
import { BusinessError,deviceInfo } from '@kit.BasicServicesKit';
```
             构造参数[AdTriggerInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-attributionmanager#adtriggerinfo)。
...
```
             调用[attributionManager.registerTrigger](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-attributionmanager#attributionmanagerregistertrigger)方法登记转化信息。
