...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `calendarmanager-practice-developer`  |  **DocID**: `875464c2e4b44017ac28d52854ccc94d`  |  **NodeID**: `000201775795649085731cfd8e0af5b7`
...
| 字段名称  | 对应设置项  | 建议取值  
 ...
 | 提醒时间  | reminderTime  0：全天日程时表示当天上午9点提醒（非全天日程则是日程开始时间）。
