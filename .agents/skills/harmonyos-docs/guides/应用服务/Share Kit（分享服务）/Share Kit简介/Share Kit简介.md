...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `share-introduction`  |  **DocID**: `ba88ef6a5357450eab22c99d246e7069`  |  **NodeID**: `0002017757956490856330421bb3d786`
...
# Share Kit简介
    ...
    **图3** 手机与PC/2in1设备碰一碰分享效果图
     ...
     **图4** 分享运行机制
                        ...
                        | 应用类型          | 相关逻辑         
                               | 宿主应用                    宿主应用需要对可分享的内容提供分享入口，在用户点击分享时，配置分享内容到分享，拉起系统分享面板。
          ...
          - [碰一碰分享](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/knock-share-between-phones-overview)
                 ...
                 | 目标应用                    1. 需要在应用中构建具有数据处理能力组件，包括以下两种分享方式。
