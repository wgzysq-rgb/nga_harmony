...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `knock-share-between-phones-group`  |  **DocID**: `900e3c79f1b24ffc964fa452fff770fa`  |  **NodeID**: `0002017757956490863676ec7c0d7aee`
...
# 邀请组队
     ...
     **图2** 竖屏应用示例
     ...
     针对以上场景，Share Kit提供单向仅发送能力。参考：[SendCapabilityRegistry](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/share-harmony-share#sendcapabilityregistry)的sendOnly属性。
