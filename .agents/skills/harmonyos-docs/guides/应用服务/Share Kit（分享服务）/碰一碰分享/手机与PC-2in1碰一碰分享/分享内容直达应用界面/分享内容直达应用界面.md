...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `knock-share-pc-phones-sandbox`  |  **DocID**: `7d4510876ed348f39e104bbdd067e5ef`  |  **NodeID**: `00020177579564908632068f4df65f29`
...
```
     ...
     当本次沙箱接收回调触发时，如果应用因为业务实现需要拒绝本次接收时，可使用[ReceivableTarget.reject()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/share-harmony-share#reject-1)方法拒绝本次接收。
