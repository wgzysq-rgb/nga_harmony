...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `share-access-mode`  |  **DocID**: `6aeb09d5df504e729802309e2b260c02`  |  **NodeID**: `00020177579564908629353639a8ce60`
...
| 接入模式  | 接入方式&适用应用类型  | 效果图  
 ...
 | 半接模式  **开发者自行开发分享能力面板，并在分享面板中提供系统分享入口**
