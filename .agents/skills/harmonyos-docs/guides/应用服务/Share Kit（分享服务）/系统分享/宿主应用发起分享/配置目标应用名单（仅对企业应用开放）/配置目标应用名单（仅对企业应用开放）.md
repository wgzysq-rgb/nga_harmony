...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `share-app-sharing-mode`  |  **DocID**: `688ae7ea55f1465ea855f5b04e3fb158`  |  **NodeID**: `00020177579564908636460ddf18b2dc`
...
应用必须在module.json5配置文件的requestPermissions标签中声明权限。参考：[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。
