...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `location-guidelines-capi`  |  **DocID**: `aa6abdaa8e7b44d49c9440cb7a152eb7`  |  **NodeID**: `000201775795649086968ad8f3984d8b`
...
| 名称  | 描述  
 ...
 | OH_LocationRequestConfig_SetUseScene(Location_RequestConfig* requestConfig, Location_UseScene useScene)  设置发起定位时的用户活动场景。
