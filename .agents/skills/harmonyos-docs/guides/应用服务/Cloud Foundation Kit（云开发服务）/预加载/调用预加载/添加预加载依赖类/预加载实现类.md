...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cloudfoundation-prefetch-implementation-class`  |  **DocID**: `2dc5ff2259e34afa8b34793d7d1dee3a`  |  **NodeID**: `00020177579564908641371c9d20a474`
...
使用cloudFunctionCall接口之前，请先[设置云函数配置项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cloudfoundation-call-function#设置云函数配置项)。
