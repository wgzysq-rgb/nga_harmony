...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cloudfoundation-storage-list-files`  |  **DocID**: `bf77a665ea694a73a2ad19bf63bf11b3`  |  **NodeID**: `000201775795649086171bc4bef6b681`
...
# 获取云侧文件列表
     ...
     调用[StorageBucket.list](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudstorage#list)可以获取云侧指定目录的文件列表。
