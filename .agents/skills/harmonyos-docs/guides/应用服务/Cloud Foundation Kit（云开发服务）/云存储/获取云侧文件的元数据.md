...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cloudfoundation-storage-getmetadata`  |  **DocID**: `198e57aa7c494adf8c55a486cc53ae09`  |  **NodeID**: `000201775795649086191b52712348f3`
...
# 获取云侧文件的元数据
    ...
    文件上传至云侧后，开发者可以在下载文件前获取指定云侧文件的元数据，来决定是否下载此文件。
     ...
     调用[StorageBucket.getMetadata](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudstorage#getmetadata)获取指定云侧文件的元数据信息。
