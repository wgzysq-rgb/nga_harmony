...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cloudfoundation-storage-getdownloadurl`  |  **DocID**: `bafb23b506544bc09d2394410d3b4128`  |  **NodeID**: `00020177579564908613370c53703c82`
...
# 获取云侧文件下载地址
     ...
     调用[StorageBucket.getDownloadURL](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudstorage#getdownloadurl)接口获取云侧文件的下载地址。
