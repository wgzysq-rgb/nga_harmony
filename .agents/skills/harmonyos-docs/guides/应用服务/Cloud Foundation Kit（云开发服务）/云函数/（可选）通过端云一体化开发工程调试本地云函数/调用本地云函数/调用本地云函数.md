...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cloudfoundation-call-local-function`  |  **DocID**: `d7ed2c735502419d85dc143e9a808f9c`  |  **NodeID**: `000201775795649086347797ed269023`
...
# 调用本地云函数
     ...
     hdc rport tcp:18090 tcp:18090     其中，设备端口和主机端口即为Function URI中的端口。
...
```
             调用[call()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudfunction#call)方法设置函数，在方法中传入函数名称和本地启动的云函数地址，返回调用结果。
