...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cloudfoundation-call-function`  |  **DocID**: `b25f971ca1c1463aac0c6bd09049e228`  |  **NodeID**: `000201775795649086386e7e81b51cb3`
...
```
       ...
       let returnValue = value.result;       value为步骤2中调用call()方法返回的cloudFunction.FunctionResult对象，返回值为云函数body返回的值，以[测试函数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cloudfoundation-test-function)时返回的结果为例，value.result = {"simple":"example"}。
