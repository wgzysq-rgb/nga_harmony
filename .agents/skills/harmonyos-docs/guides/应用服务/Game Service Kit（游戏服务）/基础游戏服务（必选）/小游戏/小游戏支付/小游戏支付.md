...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `gameservice-gameplayer-minigame-pay`  |  **DocID**: `1c691584788247cbb33e48fb83ca2f02`  |  **NodeID**: `00020177579564908637537359886d82`
...
# 小游戏支付
       ...
       小游戏接入基础游戏服务的小游戏支付API后，支持在小游戏内提供付费商品，玩家可以在小游戏内进行购买。
             ...
             小游戏调用[miniGamePay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/gameservice-gameplayer#gameplayerminigamepay)向Game Service Kit发起支付请求。

             Game Service Kit向IAP Kit发送请求拉起收银台，IAP Kit处理支付请求，详情请参考[商品购买](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/iap-integrate-purchase)。

             IAP Kit处理完成后向Game Service Kit返回此次商品购买的结果等信息。

             Game Service Kit返回此次商品购买的结果等信息，开发者将接收到一个[CreatePurchaseResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/gameservice-gameplayer#createpurchaseresult)对象，对象内的purchaseData字段包括了此次购买的结果信息。
