...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `gameservice-nearbytransfer-config-agc`  |  **DocID**: `9c5d7248eddb4234bd117029987b64ac`  |  **NodeID**: `000201775795649086950ee662d2d7bf`
...
登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html#/)，点击“开发与服务”。在项目列表中找到项目，并点击选择需要申请权限的游戏。
