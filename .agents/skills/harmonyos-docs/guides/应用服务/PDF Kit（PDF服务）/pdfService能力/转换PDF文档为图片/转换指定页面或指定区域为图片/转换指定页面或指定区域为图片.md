...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pdf-get-img`  |  **DocID**: `dbbb72dc81fe443d8ef59a593bd43b20`  |  **NodeID**: `00020177579564908627826b43097bd4`
...
# 转换指定页面或指定区域为图片
     ...
     PDF文档页面转换为图片，或将页面的指定区域转换为图片时使用。
                  ...
                  #### 接口说明
                        ...
                        | 接口名          | 描述         
                               | [getPagePixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#getpagepixelmap)(): image.PixelMap          | 获取当前页的图片。         
                 | [getCustomPagePixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#getcustompagepixelmap)(matrix: PdfMatrix, isGray: boolean, drawAnnotations: boolean): image.PixelMap          | 获取指定PdfPage区域的图片内容。         
                 | [getAreaPixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#getareapixelmap)(matrix: PdfMatrix, bitmapwidth: number, bitmapHeight: number, isGray: boolean, drawAnnotations: boolean): image.PixelMap          | 获取指定PdfPage区域的图片内容，并指定图片的宽和高。         
                 | [getAreaPixelMapWithOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#getareapixelmapwithoptions)(matrix: PdfMatrix, bitmapwidth: number, bitmapHeight: number, options?: PixelOptions): image.PixelMap          | 获取指定PdfPage区域的图片内容，并指定图片的宽和高等参数。         
