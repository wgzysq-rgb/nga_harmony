...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pdf-add-bookmark`  |  **DocID**: `de098381ed6744a4870d0ec4596bbc7e`  |  **NodeID**: `00020177579564908614416592dbabd8`
...
# 添加、删除书签
     ...
     **删除书签**：
             ...
             调用getRootBookmark方法，获取文档的第一个根书签。

             调用removeBookmark方法，删除书签。
