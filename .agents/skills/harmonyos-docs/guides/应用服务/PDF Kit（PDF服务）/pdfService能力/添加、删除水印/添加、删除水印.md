...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pdf-add-watermark`  |  **DocID**: `b3b51b4cd2134301af71081d8e0a9904`  |  **NodeID**: `000201775795649086183efc5762dacd`
       ...
       对指定页面添加水印，包括文本水印或图片水印。
           ...
           图片水印可以设置缩放、旋转、透明度和位置等属性。
              ...
              #### 接口说明
                        ...
                        | 接口名          | 描述         
                               | [addWatermark](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#addwatermark)(info: WatermarkInfo, startIndex: number, endIndex: number, oddPages: boolean, evenPages: boolean): void          | 插入水印到PDF文档。如果插入的是图片，支持的图片格式参考[ImageFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#imageformat)，文本字符无限制。         
                 | [removeWatermark](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#removewatermark)(): boolean          | 删除PDF文档水印。         
             

                              [addWatermark](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#addwatermark)方法属于耗时业务，需要遍历每一页去添加水印，添加页面较多时建议放到线程里去处理。
