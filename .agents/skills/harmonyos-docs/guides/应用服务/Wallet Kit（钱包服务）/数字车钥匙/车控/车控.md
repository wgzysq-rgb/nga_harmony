...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `wallet-carkey-control`  |  **DocID**: `85d7afe254344f89ac364ad523188e0c`  |  **NodeID**: `000201775795649086080c56fe7eaba0`
...
# 车控
    ...
    典型的交互流程如下:
           ...
           通过[queryICCEConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#queryicceconnectionstate)接口检查车控蓝牙的连接状态，如果未连接则使用[startICCEConnection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#starticceconnection)主动连接。

           通过[registerICCEListener](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#registericcelistener)注册监听，接收华为钱包发送的消息。

           车主APP可以通过[sendICCERKEMessage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#sendiccerkemessage)接口发送车控指令。

           用户退出数字钥匙车控页面，通过[unregisterICCEListener](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#unregistericcelistener)接口取消监听。
...
```
             如果[queryICCEConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#queryicceconnectionstate)接口返回连接状态connectionState为未配对0时，需要调用[startICCEConnection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#starticceconnection)主动创建蓝牙链接。
...
```
             车主APP通过[registerICCEListener](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#registericcelistener)注册监听华为钱包发送的消息。
...
```
             车主APP通过[sendICCERKEMessage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#sendiccerkemessage)接口发送车控指令。
...
```
             用户退出数字钥匙车控页面，车主APP通过[unregisterICCEListener](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-walletpass#unregistericcelistener)接口取消监听。
