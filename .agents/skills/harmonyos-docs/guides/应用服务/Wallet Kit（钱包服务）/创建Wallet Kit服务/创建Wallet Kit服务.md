...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `wallet-preparations`  |  **DocID**: `a055bd6e0dbe4bb2a791df7da5ad3fce`  |  **NodeID**: `0002017757956490856542ec29876553`
...
| Wallet Kit服务参数名称  | 参数值  
 ...
 | 回调地址  开发者提供给Wallet Kit的地址，用于Wallet Kit回调开发者，用户领卡成功或删卡时回调开发者。
