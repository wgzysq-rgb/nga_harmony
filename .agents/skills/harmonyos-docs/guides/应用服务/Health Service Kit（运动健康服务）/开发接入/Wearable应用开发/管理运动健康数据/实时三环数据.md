...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `health-wearable-three-ring-read`  |  **DocID**: `1a0b833bc59b4e1688a77d5c121d23b6`  |  **NodeID**: `000201775795649086423ae55dbcd801`
...
```
             调用[readActivityReport](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-healthservice#workoutreadactivityreport)方法读取实时三环数据，并处理返回结果。
