...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `health-wearable-add-permissions`  |  **DocID**: `3c9c1bbdddfd4fd2b5282f0650e52ce3`  |  **NodeID**: `00020177579564908628549fc111e19b`
...
import { hilog } from '@kit.PerformanceAnalysisKit';
```
             调用[cancelAuthorizations](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-healthstore#healthstorecancelauthorizations)方法执行取消授权，并处理返回结果。
