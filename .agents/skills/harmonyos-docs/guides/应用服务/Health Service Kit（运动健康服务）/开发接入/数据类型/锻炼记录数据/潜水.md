...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `health-diving`  |  **DocID**: `02cade0edc804c3da2a78092a0d362ea`  |  **NodeID**: `000201775795649086437fdb20320763`
...
# 潜水
                 ...
                 #### 自由潜水
                  ...
                  #### [h2]自由潜水相关锻炼记录类型如下：
                        ...
                        | **锻炼记录子类型常量**          | **描述**          | 数据来源         
                               | [exerciseSequenceHelper.diving.EXERCISE_TYPE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-exercisedequencehelper#常量-8)          | 自由潜水          | 部分专业手表         
      ...
      - 字段定义：[exerciseSequenceHelper.diving.DetailFields](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-exercisedequencehelper#detailfields-7)
                 ...
                 | waterTemperature          | 水温详情          | [WaterTemperature](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-healthfields#watertemperature)[]          | O         
                  ...
                  #### [h2]水肺潜水相关锻炼记录类型如下：
                        ...
                        | **锻炼记录子类型常量**          | **描述**          | 数据来源         
                               | [exerciseSequenceHelper.scubaDiving.EXERCISE_TYPE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/health-api-exercisedequencehelper#常量-23)          | 水肺潜水          | 部分专业手表         
