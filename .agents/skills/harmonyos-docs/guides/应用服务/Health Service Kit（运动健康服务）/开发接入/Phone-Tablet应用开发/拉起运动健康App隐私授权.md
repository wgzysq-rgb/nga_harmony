...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `health-privacy-authorization`  |  **DocID**: `dcf4f447c777431ab16c8f210b937836`  |  **NodeID**: `000201775795649086291fc45e427b60`
...
```
             调用[canOpenLink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager#bundlemanagercanopenlink12)判断运动健康App是否安装。
