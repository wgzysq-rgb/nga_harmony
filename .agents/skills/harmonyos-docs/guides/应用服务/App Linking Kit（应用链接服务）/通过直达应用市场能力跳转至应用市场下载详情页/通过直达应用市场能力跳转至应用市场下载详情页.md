...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `applinking-direct-to-ag`  |  **DocID**: `f263a0ef5880491fafcb73ab6af7008a`  |  **NodeID**: `0002017757956490857003959a8f3e1f`
...
目标方应用已[配置App Linking应用链接](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-linking-startupapp)。
  ...
  目标方HarmonyOS应用必须已上架，具体可参见“[发布HarmonyOS应用](https://developer.huawei.com/consumer/cn/doc/app/agc-help-release-app-0000002271695230)”。
...
```
  ...
  在“entry/src/main/ets/pages/Index.ets”文件中，使用[UIAbilityContext.openLink()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext#openlink12)接口配置跳转链接。
