...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `applinking-deferredlink`  |  **DocID**: `c4b1d4d13b3b4e4294dfea7e3739bda8`  |  **NodeID**: `0002017757956490857451ec7ec52e90`
...
# 通过延迟链接跳转至应用详情页
     ...
     延迟链接只能获取一次，获取后，系统会从缓存中删除该链接；后续调用时，返回为空。
             ...
             目标方应用已[配置App Linking应用链接](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-linking-startupapp)。

             该能力目前仅适用于5.0.3(15)及以上版本的HarmonyOS应用。
        ...
        在入口类文件页面Index.ets中添加如下代码。当应用首次启动时，调用[deferredLink.popDeferredLink()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/applinking-deferredlink-api#popdeferredlink)接口，获取用户此前点击的该应用相关链接。         ```
