...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `payment-skill-introduction`  |  **DocID**: `8dff3320f1f649cba2df8676979e0423`  |  **NodeID**: `000201775795649085697b23ecec513d`
...
- 版权声明：本Skill文档的版权归属我方所有，开发者不得擅自篡改、传播、转售、出租本文档，不得用于与接入鸿蒙支付服务无关的其他用途。如开发者存在前述违规使用行为，我方有权追究法律责任。
