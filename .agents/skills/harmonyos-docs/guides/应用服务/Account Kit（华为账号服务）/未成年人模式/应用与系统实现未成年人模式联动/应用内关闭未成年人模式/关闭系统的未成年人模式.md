...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `account-system-turn-off-minorsprotection`  |  **DocID**: `e1f82c4180c54f1ab4d809a5c8847ca5`  |  **NodeID**: `000201775795649086412f16ccae5417`
...
# 关闭系统的未成年人模式
     ...
     流程说明：
             ...
             当系统未成年人模式已开启，且用户需要在应用内关闭未成年人模式时，应用可调用[leadToTurnOffMinorsMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection#leadtoturnoffminorsmode)引导关闭系统未成年人模式流程，关闭整个系统的未成年人模式。
     ...
     以下是关闭系统的未成年人模式相关接口说明，更多接口及使用方法请参见[API参考](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection)。
                 ...
                 [leadToTurnOffMinorsMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection#leadtoturnoffminorsmode)接口需在页面或自定义组件生命周期内调用。
...
```
             ...
             当系统未成年人模式已开启，且用户主动关闭应用内未成年人模式时，应用需要调用[leadToTurnOffMinorsMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection#leadtoturnoffminorsmode)引导用户关闭系统的未成年人模式。
