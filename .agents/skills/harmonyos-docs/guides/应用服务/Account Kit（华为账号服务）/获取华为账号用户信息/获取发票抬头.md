...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `account-select-invoice-title`  |  **DocID**: `4bf251d5a5844d79996bc94cb3190ea2`  |  **NodeID**: `0002017757956490861168a8f97e9dcc`
...
```
             调用[selectInvoiceTitle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-invoiceassistant#selectinvoicetitle)方法选择发票抬头页面。
