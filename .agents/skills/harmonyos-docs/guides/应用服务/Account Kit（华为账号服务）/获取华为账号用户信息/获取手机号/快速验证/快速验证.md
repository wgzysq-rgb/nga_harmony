...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `account-get-phonenumber`  |  **DocID**: `532e1c08390d47b1bb69c9b23690eb79`  |  **NodeID**: `000201775795649086337eeeaec39190`
...
```
             ...
             使用Access Token调用[获取用户信息接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-get-user-info-get-phone#接口原型)获取用户信息，从用户信息中获取用户手机号、UnionID、OpenID。
