...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `account-get-avatar-nickname`  |  **DocID**: `dc742fbd463543218935b6c2f8962b0d`  |  **NodeID**: `00020177579564908694960e44e1aad1`
...
```
     ...
     开发者根据业务需要选择是否进行服务端开发。
             ...
             使用Access Token调用[获取用户信息接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-get-user-info-get-nickname-and-avatar#接口原型)获取用户信息，从用户信息中获取用户头像昵称。
