...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `notification-update`  |  **DocID**: `2619670ce63545d298c03734d253e7d0`  |  **NodeID**: `000201775795649085761c1243655caf`
...
```
             通过[NotificationRequest](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationrequest#notificationrequest-1)接口携带updateOnly字段更新进度条通知。
