...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ion-subscriber-extension-ability-development-steps`  |  **DocID**: `56c3935ae45a419994433034998c2d5a`  |  **NodeID**: `00020177579564908697728f1360b151`
...
# 通知订阅扩展能力开发步骤
     ...
     申请[ohos.permission.SUBSCRIBE_NOTIFICATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionsubscribe_notification)权限。
