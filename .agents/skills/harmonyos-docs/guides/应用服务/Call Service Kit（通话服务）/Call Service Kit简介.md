...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `call-introduction`  |  **DocID**: `269a0acd992b468c93b02a731f571858`  |  **NodeID**: `000201775795649085643375f1acaac3`
...
当应用在后台时，如果有来电，需要[Push Kit（推送服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/push-kit-introduction)先拉起应用主进程，应用才能给Call Service Kit上报来电。
...
由于Call Service Kit依赖Push Kit，还需要参考[Push Kit的约束和限制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/push-kit-introduction#约束和限制)。
