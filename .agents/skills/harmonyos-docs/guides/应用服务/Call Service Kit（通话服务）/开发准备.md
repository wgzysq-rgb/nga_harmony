...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `call-preparations`  |  **DocID**: `a0e41a5957f94554970b30354d947936`  |  **NodeID**: `0002017757956490856611d2458a8b0d`
...
如[与相关Kit的关系](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/call-introduction#与相关kit的关系)所述，开发者在开通Call Service Kit之前，需要开通Push Kit（推送服务），开通方法详见[开通推送服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/push-config-setting)。
