...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `outgoing-calls`  |  **DocID**: `daaca975bf224a929b812940faef488a`  |  **NodeID**: `000201775795649085721da89c84a0d2`
...
```
             应用内部建立通话连接之后，需要向Call Service Kit上报去电，并携带通话信息，详见[VoipCallAttribute](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#voipcallattribute)。
...
```
                            ...
                            如果对端接听，应用需要向Call Service Kit上报通话状态[VOIP_CALL_STATE_ACTIVE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#voipcallstate)。系统会更新通话胶囊，开始展示通话计时。
