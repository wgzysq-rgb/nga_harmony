...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `iap-faq-21`  |  **DocID**: `aa206e5478d944deb9f0b831c88c6391`  |  **NodeID**: `000201775795649086247690f73d408e`
...
# developerPayload处理机制及使用建议
    ...
    **developerPayload使用建议：**
           ...
           请开发者使用应用帐号相关信息作为developerPayload。
