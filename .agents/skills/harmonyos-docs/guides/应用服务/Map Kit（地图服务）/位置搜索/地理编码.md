...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `map-site-geocode`  |  **DocID**: `d01c1e17dcb94dcaac5621428b6b0723`  |  **NodeID**: `000201775795649086979d9bd9739e18`
...
# 地理编码
     ...
     以下是地理编码相关接口，主要由[site](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-site)命名空间下的方法提供，更多接口及使用方法请参见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-site)。
                 ...
                 | [ReverseGeocodeResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-site#reversegeocoderesult)          | 逆地理编码的结果。         
