...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `map-introduction`  |  **DocID**: `617b705ddf674b6f9f8c2e457c24dec1`  |  **NodeID**: `00020177579564908563892f6d156de9`
...
[创建地图](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-presenting)：创建地图组件、设置地图属性、自定义地图等。

  [地图交互](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-controls-and-interaction)：控制地图的交互手势和交互按钮。

  [在地图上绘制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-marker)：添加位置标记、覆盖物以及各种形状等。

  [位置搜索](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-site-search)：多种查询POI信息的能力，提供正地理编码、逆地理编码的能力。

  [路径规划](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-navi-routes)：提供驾车、步行、骑行路径规划能力。

  [静态图](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-static-diagram)：获取一张地图图片。

  [地图Picker](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-location-details)：提供地点详情展示控件、地点选取控件、区划选择控件。
