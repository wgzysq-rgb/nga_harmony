...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `map-bubble`  |  **DocID**: `0fc7dc94881f4fe1918ba4f10d3742a8`  |  **NodeID**: `0002017757956490861622f114f3f50f`
...
# 气泡
     ...
     添加气泡功能主要由[BubbleParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#bubbleparams)、[addBubble](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addbubble)和[Bubble](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-bubble)提供，更多接口及使用方法请参见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-bubble)。
...
```
     ...
     [Bubble](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-bubble)调用[setAnimation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-basepriorityoverlay#setanimation)设置动画。

     [Bubble](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-bubble)调用[startAnimation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-basepriorityoverlay#startanimation)启动动画。
