...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `map-dyntrajectories`  |  **DocID**: `e635a657e2e54d778df2df7048aa37ca`  |  **NodeID**: `000201775795649086207cb24a6644ae`
...
# 动态轨迹
     ...
     绘制动态轨迹功能主要由[TraceOverlayParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#traceoverlayparams)、[addTraceOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addtraceoverlay)、[Marker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-marker)和[TraceOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-traceoverlay)提供，更多接口及使用方法请参见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-traceoverlay)。
