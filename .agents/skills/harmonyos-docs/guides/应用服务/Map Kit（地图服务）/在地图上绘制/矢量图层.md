...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `map-mvt-overlay`  |  **DocID**: `d8dde5efd7ea40cf81d68f2829b0b1f4`  |  **NodeID**: `00020177579564908623203231c33791`
...
# 矢量图层
     ...
     矢量图层功能主要由[MvtOverlayParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mvtoverlayparams)、[addMvtOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addmvtoverlay)和[MvtOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mvtoverlay)提供，更多接口及使用方法请参见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mvtoverlay)。

           
                        | 接口名          | 描述         
                               | [MvtOverlayParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mvtoverlayparams)          | 矢量图层的参数。         
                 | [addMvtOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addmvtoverlay)(params: [mapCommon.MvtOverlayParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mvtoverlayparams)): [MvtOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mvtoverlay)          | 添加矢量图层。         
...
```
       ...
       矢量图层支持的数据源类型为通用矢量瓦片格式（PBF/MVT）。[MvtOverlayParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mvtoverlayparams)类中的layers参数，其中sourceLayer、fillColor/fillOpacity默认值从矢量数据里获取，也可自己设置。
