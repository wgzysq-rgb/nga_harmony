...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `map-presenting`  |  **DocID**: `d5b3b293d56f47108586a3c36204b4d5`  |  **NodeID**: `0002017757956490868609438e87d4e6`
...
```
     ...
     [MapOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#mapoptions)包含以下属性。
                 ...
                 | scaleUnit          | 地图比例尺公英制单位，默认值：[ScaleUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#scaleunit).METRIC_UNIT（公制单位）。         
             

          
             设置mapType，[切换地图类型](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-type)章节中有详细讲解。
...
```
     方式二：创建地图后
             ...
             创建地图后，调用[MapComponentController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller)对象的[setLogoScale](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#setlogoscale)方法设置Logo缩放比例。

       this.mapController.setLogoScale(0.9);             获取Logo缩放比例。
