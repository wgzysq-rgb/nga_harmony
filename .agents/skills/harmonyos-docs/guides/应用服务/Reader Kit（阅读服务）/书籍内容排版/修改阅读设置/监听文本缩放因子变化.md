...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `reader-setting-scaled-density`  |  **DocID**: `f529b828d7ac4406acd4b726dadcc064`  |  **NodeID**: `000201775795649086389ef2e388cb65`
...
```
             通过[display.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display#displayonaddremovechange)接口监听文本缩放因子的变化。
...
```
             在阅读页的上级页面通过[@StorageLink](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-appstorage#storagelink)装饰器监听isDensityChange字段的变化。
