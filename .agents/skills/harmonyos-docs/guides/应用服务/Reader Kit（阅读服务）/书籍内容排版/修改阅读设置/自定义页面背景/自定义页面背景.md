...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `reader-setting-background`  |  **DocID**: `effc03fb828a4f59804ab5b22e66f33e`  |  **NodeID**: `0002017757956490863441944e75f6cd`
...
```
       ...
       this.readerComponentController.setPageConfig(this.readerSetting);             注册排版引擎资源请求接口，并返回相应的背景图资源。
