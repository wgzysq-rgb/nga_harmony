...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `reader-setting-font`  |  **DocID**: `8c975c94bcdf409997b3e9084fd612da`  |  **NodeID**: `000201775795649086276b59b4c41a64`
...
```
        ...
        - 若资源放在项目resources/rawfile/fonts文件夹下。         let filePath: string = 'fonts/SourceHanSerifCN-VF.ttf';
