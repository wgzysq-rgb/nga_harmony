...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `reader-introduction`  |  **DocID**: `973cfc1e38aa404183343cf38ca930d5`  |  **NodeID**: `000201775795649085622347b9b11579`
...
# Reader Kit简介
     ...
     Reader Kit提供的能力如下：
       ...
       书的背脊；平装书或精装书封面和封底的联结处。一般印有书名、作者名、出版单位名等。在Reader Kit中，spine(书脊)定义了书籍内容的阅读顺序，每一个[SpineItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/reader-book-parser#spineitem)表示一个可阅读的内容节点，标识着可阅读的一个内容资源。
