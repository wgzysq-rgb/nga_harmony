...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ads-publisher-service-splash`  |  **DocID**: `b4dd38145d604823abf9dfb634a42e61`  |  **NodeID**: `00020177579564908613875544011108`
...
```
       ...
       请求广告关键参数如下所示：
            ...
            - 如果仅调测广告，可使用测试广告位ID：testq6zq98hecj半屏开屏（图片）和testd7c5cewoj6全屏开屏（视频）。
