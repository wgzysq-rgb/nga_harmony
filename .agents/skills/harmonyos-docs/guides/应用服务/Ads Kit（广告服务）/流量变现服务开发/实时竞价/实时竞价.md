...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ads-real-time-bidding`  |  **DocID**: `5a0cb33af7014cf2bc5301fc7411f289`  |  **NodeID**: `000201775795649086180844e5522a65`
...
# 实时竞价
     ...
     实时竞价关键参数如下所示：
                 ...
                 | cur          | string          | 否                    竞价请求支持的币种，支持传多个，用英文逗号分隔。当前支持五种货币：
          ...
          不填默认是CNY。
                 ...
                 | bidFloorCur          | string          | 否                    竞价广告位底价使用的币种。如果bidFloor非空，则bidFloorCur也非空。当前只支持五种货币中的一种：
...
```
     ...
     实时竞价结果信息如下所示：
       ...
       宏说明如下：
                     ...
                     | AUCTION_LOSS                        竞价结果，如果没有走到参竞环节也需要回调，并替换具体过滤结果码。
