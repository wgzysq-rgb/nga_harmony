...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `enterprisespace-policy-push`  |  **DocID**: `aa15d5945c3e4cfaa69a25d08301a371`  |  **NodeID**: `000201775795649086036c620c489e17`
...
# 配置空间互传单双通策略
     ...
     详细接口说明可参考[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacedatatransfer#policypush)。
                        ...
                        | 接口名          | 描述         
                               | [policyPush](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacedatatransfer#policypush)(policyContext: string): void          | 配置空间互传单双通策略。         
       ...
       import { fileTransfer } from '@kit.EnterpriseSpaceKit';             调用[policyPush](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacedatatransfer#policypush)接口，配置空间互传单双通策略，并且查看打印信息。
