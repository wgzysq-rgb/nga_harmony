...
> **分区**: Guides  |  **Slug**: `enterprisespace-get-access-token`  |  **DocID**: `6ab16dd8825e4a18850d29d023f3cd51`  |  **NodeID**: `000201776839809741545a27c2ddc1f6`
...
# 获取企业应用访问令牌
     ...
     详细接口说明可参考[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#getaccesstoken)。
       ...
       import { spaceManager } from '@kit.EnterpriseSpaceKit';             调用[getAccessToken](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#getaccesstoken)接口，进行企业账号认证。
