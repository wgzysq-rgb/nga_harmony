...
> **分区**: Guides  |  **Slug**: `enterprisespace-authenticate`  |  **DocID**: `3f1cd460f7224ca899ae300f4c03ba79`  |  **NodeID**: `000201776839809741539e6ec0942d63`
...
# 企业账号认证
     ...
     详细接口说明可参考[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#authenticate)。
       ...
       import { spaceManager } from '@kit.EnterpriseSpaceKit';             调用[authenticate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#authenticate)接口，进行企业账号认证。
