...
> **分区**: Guides  |  **Slug**: `enterprisespace-set-workspace-local-name`  |  **DocID**: `7492b64488094ae28cfc2a9e3771f880`  |  **NodeID**: `000201776839809741552f6e0d6bd60f`
...
# 设置空间本地名称
     ...
     详细接口说明可参考[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setworkspacelocalname)。
       ...
       import { spaceManager } from '@kit.EnterpriseSpaceKit';             调用[setWorkspaceLocalName](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setworkspacelocalname)接口，设置工作空间本地名称，并且查看打印信息。
