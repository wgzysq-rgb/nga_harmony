...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `build-with-ndk-overview`  |  **DocID**: `a2d71a3e53744bda97ce4e0269484a39`  |  **NodeID**: `00020177579546012327965b9fd00021`
...
| 参数  | 类型  | 说明  
  | OHOS_STL  | c++_shared/c++_static  libc++的链接方式。默认为c++_shared。
