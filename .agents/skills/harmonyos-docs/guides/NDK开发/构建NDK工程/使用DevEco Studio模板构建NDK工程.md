...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `build-with-ndk-ide`  |  **DocID**: `34f6c151b0f34437beba935a84df9f46`  |  **NodeID**: `0002017757954601232830f257b26240`
...
| 配置项  | 类型  | 说明  
 ...
 | abiFilters  | array  本机的ABI编译环境，包括：
