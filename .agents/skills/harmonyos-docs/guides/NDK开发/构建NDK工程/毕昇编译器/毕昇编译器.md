...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `bisheng-compiler`  |  **DocID**: `c671c9685280492d937f9ea553c94520`  |  **NodeID**: `0002017757954601232953754928c964`
 ...
 **2. 采集阶段**
 ...
 启动完成后，找到native debug的lldb位置，需要在lldb中设���参数，保证业务正常运行，不会在debug模式下被一些信号影响数据采集（信号一般是程序本身发送），设置方法为：
