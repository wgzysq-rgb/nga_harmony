...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cpu-features`  |  **DocID**: `09ed985c519f4df0862791c6aabbbcc6`  |  **NodeID**: `000201775795460123290ac6c2914936`
...
在HarmonyOS系统C++工程中引入开源库，下载[cpu_features库](https://github.com/google/cpu_features)，解压到工程的cpp目录下，解压后的文件名改为cpu_features。如下以DevEco Studio C++模板示例应用举例：
...
```
  ...
  在代码中加入判断CPU特性支持能力语句，如下以支持ARM与AARCH64两种架构举例：
