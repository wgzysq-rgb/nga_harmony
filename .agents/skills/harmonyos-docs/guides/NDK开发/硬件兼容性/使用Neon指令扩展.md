...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `neon-guide`  |  **DocID**: `8ade6e19f48640bd83acc8cc78bd011d`  |  **NodeID**: `000201775795460123292af05205ea29`
...
使用Neon intrinsics需要在源码包含arm_neon.h头文件，由于该特性与CPU架构强相关，在包含该头文件时，推荐用cpu features等宏括起来。
