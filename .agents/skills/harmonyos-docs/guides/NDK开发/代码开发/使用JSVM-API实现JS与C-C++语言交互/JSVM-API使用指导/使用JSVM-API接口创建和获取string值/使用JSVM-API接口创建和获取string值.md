...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-jsvm-about-string`  |  **DocID**: `1068efe3ffec40b2a7e43ae62ec8cbef`  |  **NodeID**: `0002017757954601233844f9d65839dd`
...
```
 ...
 JSVM GetValueStringUtf8 success: aaBC+-$%^你好123 **注意事项**：getValueStringUtf8(arg)入参arg非字符串型数据时接口会调用失败。
...
```
 ...
 JSVM GetValueStringUtf16 success: ahello。 **注意事项**：getValueStringUtf16(arg)的参数arg必须是字符串，否则接口会调用失败。
