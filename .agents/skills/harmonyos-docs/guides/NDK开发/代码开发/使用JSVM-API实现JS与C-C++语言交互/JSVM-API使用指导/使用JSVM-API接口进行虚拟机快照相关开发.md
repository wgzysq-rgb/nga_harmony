...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-jsvm-create-snapshot`  |  **DocID**: `f89feba52066498fb5b9292a6a4fa504`  |  **NodeID**: `000201775795460123335844ca2a1a86`
...
```
 ...
 Test JSVM RunVMSnapshot read file blobSize = : 300064 多次点击屏幕,LOG中输出:
