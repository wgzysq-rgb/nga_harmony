...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-jsvm-life-cycle`  |  **DocID**: `97c098f6301849ae95a317b0552b9a93`  |  **NodeID**: `000201775795460123393255249363dc`
...
- 调用 OH_JSVM_CreateReference 为 JavaScript 变量创建一个引用，以延长其生命周期。
- 调用 OH_JSVM_GetReferenceValue 获取与引用关联的 JavaScript 变量。
- 调用 OH_JSVM_DeleteReference 删除传入的引用。
