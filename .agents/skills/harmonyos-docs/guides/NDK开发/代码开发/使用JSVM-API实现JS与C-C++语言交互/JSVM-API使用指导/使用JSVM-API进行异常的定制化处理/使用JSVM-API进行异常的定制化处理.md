...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-jsvm-trigger-exceptions`  |  **DocID**: `2cbc5dab2fca465f8803412195d19092`  |  **NodeID**: `000201775795460123396a69dc2bd02a`
 ...
 **样例测试JS**
 ...
 const char *srcCallNative = R"JS(triggerOOMError();)JS"; **执行结果**
 ...
 **样例测试JS**
 ...
 const char* srcCallNative = R"JS(triggerFatalError())JS"; **执行结果：**
 ...
 **样例测试JS**
 ...
 const char* srcCallNative = R"JS(triggerPromiseReject())JS"; **执行结果：**
