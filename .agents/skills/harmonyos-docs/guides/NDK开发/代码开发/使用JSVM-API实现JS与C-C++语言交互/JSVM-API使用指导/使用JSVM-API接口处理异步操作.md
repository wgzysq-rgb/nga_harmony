...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-jsvm-about-promise`  |  **DocID**: `df28d6c62759484d950fd63eb98fd541`  |  **NodeID**: `000201775795460123378bbd54fc4b55`
...
用于设置 Promise 解析或拒绝后的回调，等效于调用原生的 Promise.then() 或 Promise.catch()。
 ...
 以下仅对 cpp 部分代码进行展示，其余框架代码如 TestJSVM 函数参考 [使用JSVM-API接口进行任务队列相关开发](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/use-jsvm-execute_tasks) OH_JSVM_SetMicrotaskPolicy 段落中的实现。
