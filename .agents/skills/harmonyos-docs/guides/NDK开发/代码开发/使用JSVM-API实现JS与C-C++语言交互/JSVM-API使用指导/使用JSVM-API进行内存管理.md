...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-jsvm-memory-management`  |  **DocID**: `c58b7eee62b243c88d40e721565f8337`  |  **NodeID**: `0002017757954601233945485bef0b31`
...
```
 ...
 const char *srcCallNative = R"JS(adjustExternalMemory())JS"; 输出结果：
...
```
 ...
 const char *srcCallNative = R"JS(memoryPressureNotification())JS"; 输出结果：
