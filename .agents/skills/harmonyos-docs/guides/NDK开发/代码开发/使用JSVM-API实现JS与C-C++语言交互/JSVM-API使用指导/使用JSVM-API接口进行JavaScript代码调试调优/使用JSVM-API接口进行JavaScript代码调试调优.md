...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `m-heapstatistics-debugger-cpuprofiler-heapsnapshot`  |  **DocID**: `d89503796ac64d96af34eb8b985b3af9`  |  **NodeID**: `0002017757954601233904018a7a6fe0`
...
```
 ...
 const char *srcCallNative = R"JS(getVM())JS"; 预计的输出结果：
...
```
 ...
 const char *srcCallNative = R"JS(getHeapStatistics())JS"; 预计的输出结果（虚拟机堆的统计数据，会实时发生变化）：
