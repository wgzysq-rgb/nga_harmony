...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-thread-safety`  |  **DocID**: `376cf666c374444094e4c4c56b95b30b`  |  **NodeID**: `000201775795460123334e3b38e7e198`
...
```
       ...
       export const startThread: (a: () => Promise<string>) => void;       导入头文件
...
```
       ...
       export const startWithCallback: (input: string, callback: (msg: string) => void) => void;             ArkTS侧调用接口。
...
```
             ...
             native侧实现代码以及模块注册与“基于Worker实现的C++子线程与ArkTS子线程交互场景”一致，可直接复用。
