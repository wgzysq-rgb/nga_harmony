...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-call-threadsafe-function-with-priority`  |  **DocID**: `57fe05ecddcf4cf8904dbd37064a2ccc`  |  **NodeID**: `000201775795460123364c3d193e4bba`
...
```
  ...
  import testNapi from 'libentry.so';  ArkTS代码示例
