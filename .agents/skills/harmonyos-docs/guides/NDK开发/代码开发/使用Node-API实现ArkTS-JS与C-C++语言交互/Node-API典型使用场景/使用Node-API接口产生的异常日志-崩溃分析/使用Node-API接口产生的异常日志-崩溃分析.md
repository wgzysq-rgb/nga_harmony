...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-crash`  |  **DocID**: `193da363a8ed40908e5542d207274449`  |  **NodeID**: `00020177579546012337505e1312eb7f`
...
调用napi方法的入参napi_env与创建napi数据结构时所使用的napi_env不一致。

  **关键日志**

 param env not equal to its owner.

  调用napi方法的入参napi_env与创建napi数据结构时所使用的napi_env一致，但原始napi_env已释放。
