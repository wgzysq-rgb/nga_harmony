...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-sendable-reference`  |  **DocID**: `e9294929b4234700bb248b2e371e69c9`  |  **NodeID**: `000201775795460123383ef865303226`
...
```
      ...
      - 只能为[Sendable对象](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-sendable#sendable支持的数据类型)创建napi_sendable_ref。
