...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-class`  |  **DocID**: `01c7f0672ea24c9ca6d6f70bff6923a1`  |  **NodeID**: `000201775795460123357b7a849a171c`
...
```
 ...
 export const newInstance: (obj: Object, param: string) => Object; // napi_new_instance ArkTS侧示例代码
