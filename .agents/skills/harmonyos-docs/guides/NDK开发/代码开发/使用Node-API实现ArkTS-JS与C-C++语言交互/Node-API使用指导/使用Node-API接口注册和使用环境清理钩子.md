...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-cleanuphook`  |  **DocID**: `36524960165542ee8bacb3b0684c7917`  |  **NodeID**: `0002017757954601233628524837837b`
...
```
     ...
     export const napiEnvCleanUpHook: () => Object | undefined;     ArkTS侧示例代码
...
```
     ...
     export const napiAsyncCleanUpHook: () => boolean | undefined;     ArkTS侧示例代码
