...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-promise`  |  **DocID**: `68c1a913e0084e59a486306019367f3b`  |  **NodeID**: `000201775795460123387a8154dd236a`
...
```
 ...
 export const isPromise: <T>(value: T) => boolean; // napi_is_promise ArkTS侧示例代码
...
- 未处理异常时调用napi_create_promise会返回napi_pending_exception。
- 使用napi_create_promise后未判断返回值是否为napi_ok，之后使用了无效的deferred和promise会导致应用崩溃。
