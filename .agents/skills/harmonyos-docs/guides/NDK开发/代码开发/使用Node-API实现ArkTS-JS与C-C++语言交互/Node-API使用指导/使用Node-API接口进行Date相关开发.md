...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-date`  |  **DocID**: `35471fd617c340589e52a88585564476`  |  **NodeID**: `0002017757954601233652bb6ba295d5`
...
```
 ...
 export const createDate: () => Date; // napi_create_date ArkTS侧示例代码
...
```
 ...
 export const getDateValue: (date: Date) => number | undefined; // napi_get_date_value ArkTS侧示例代码
...
```
 ...
 export const isDate: <T>(date: T) => boolean | undefined; // napi_is_date ArkTS侧示例代码
