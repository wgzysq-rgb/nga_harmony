...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-arraybuffer`  |  **DocID**: `ed8462940cec4c3ea08e8e1a185b8563`  |  **NodeID**: `000201775795460123341e7fd0e1b29c`
...
```
 ...
 export const isArrayBuffer: <T>(arrayBuffer: T) => boolean | undefined; // napi_is_arraybuffer ArkTS侧示例代码
...
```
 ...
 export const createArrayBuffer: (size: number) => ArrayBuffer; // napi_create_arraybuffer ArkTS侧示例代码
...
- **生命周期和内存管理**：在使用Node-API处理ArrayBuffer时，需注意，void*类型的buffer数据段生命周期由引擎管理，[不允许用户自己delete，否则会double free](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/napi-guidelines#防止重复释放获取的buffer)。
