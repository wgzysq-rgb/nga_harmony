...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-environmental-life-cycle`  |  **DocID**: `2e4a4690190543e7ad6135b223c7c7db`  |  **NodeID**: `0002017757954601233699693ee5e47a`
...
```
 ...
 export const setInstanceData: (data: number) => boolean | undefined; // napi_set_instance_data ArkTS侧示例代码
...
```
 ...
 export const getInstanceData: () => number | undefined; // napi_get_instance_data ArkTS侧示例代码
