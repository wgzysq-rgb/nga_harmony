...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-string`  |  **DocID**: `9637e4900f0846f5b4d3eec8c367ff40`  |  **NodeID**: `000201775795460123391ab44b751351`
...
```
 ...
 export const getValueStringUtf8: (param: string | number) => string | undefined; ArkTS侧示例代码
...
```
 ...
 export const createStringUtf8: () => string | undefined; ArkTS侧示例代码
...
```
 ...
 export const getValueStringUtf16: (data: string) => string; ArkTS侧示例代码
...
```
 ...
 export const createStringUtf16: () => string | undefined; ArkTS侧示例代码
...
```
 ...
 export const getValueStringLatin1: (param: number | string) => string | undefined; ArkTS侧示例代码
...
```
 ...
 export const createStringLatin1: () => string | undefined; ArkTS侧示例代码
...
```
 ...
 export const CreateExternalStringUtf16: () => string | undefined; ArkTS侧示例代码
...
```
 ...
 export const CreateExternalStringAscii: () => string | undefined; ArkTS侧示例代码
