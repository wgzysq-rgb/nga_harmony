...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-primitive`  |  **DocID**: `d11a15dce7084b64a5c8f27dbbc9fe0e`  |  **NodeID**: `00020177579546012338578f3bdb490b`
...
```
 ...
 export const coerceToBool: <T>(data: T) => boolean; // napi_coerce_to_bool ArkTS侧示例代码
...
```
 ...
 export const coerceToNumber: <T>(data: T) => number; // napi_coerce_to_number ArkTS侧示例代码
...
```
 ...
 export const coerceToObject: <T>(data: T) => Object; // napi_coerce_to_object ArkTS侧示例代码
...
```
 ...
 export const coerceToString: <T>(data: T) => string; // napi_coerce_to_string ArkTS侧示例代码
...
```
 ...
 export const getBoolean: <T>(data: T, value: String) => boolean; // napi_get_boolean ArkTS侧示例代码
...
```
 ...
 export const getValueBool: (value: boolean | string) => boolean | undefined; // napi_get_value_bool ArkTS侧示例代码
...
```
 ...
 export const getGlobal: () => Object; // napi_get_global ArkTS侧示例代码
...
```
 ...
 export const getNull: () => null; // napi_get_null ArkTS侧示例代码
...
```
 ...
 export const getUndefined: (value: undefined) => boolean; // napi_get_undefined ArkTS侧示例代码
