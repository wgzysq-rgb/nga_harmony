...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-property`  |  **DocID**: `bfeb268f37d64297bb9b3585375034dc`  |  **NodeID**: `000201775795460123388460b8805dd7`
...
```
 ...
 export const getPropertyNames: (obj: Object) => Array<string> | undefined; // napi_get_property_names ArkTS侧示例代码
...
```
 ...
 export const setProperty: (obj: Object, key: String, value: string) => Object | undefined; // napi_set_property ArkTS侧示例代码
...
```
 ...
 export const getProperty: (obj: Object, key: string) => string | undefined; // napi_get_property ArkTS侧示例代码
...
```
 ...
 export const hasProperty: (obj: Object, key: number | string) => boolean | undefined; // napi_has_property ArkTS侧示例代码
...
```
 ...
 export const deleteProperty: (obj: Object, key: string) => boolean; // napi_delete_property ArkTS侧示例代码
...
```
 ...
 export const napiHasOwnProperty: (obj: Object, key: string) => boolean | undefined; // napi_has_own_property ArkTS侧示例代码
...
```
 ...
 export const napiSetNamedProperty: (key: string) => Object | undefined; // napi_set_named_property ArkTS侧示例代码
...
```
 ...
 export const napiHasNamedProperty: (obj: Object, key: string) => boolean | undefined; // napi_has_named_property ArkTS侧示例代码
...
```
 ...
 export const getAllPropertyNames: (obj: Object) => Array<string> | undefined; // napi_get_all_property_names ArkTS侧示例代码
