...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-bigint`  |  **DocID**: `eba1a0dcbb8349a5805f37677ead9c8e`  |  **NodeID**: `0002017757954601233469494a639271`
...
```
 ...
 export const createBigintInt64t: () => bigint; // napi_create_bigint_int64 ArkTS侧示例代码
...
```
 ...
 export const createBigintUint64t: () => bigint; // napi_create_bigint_uint64 ArkTS侧示例代码
...
```
 ...
 export const createBigintWords: () => bigint | undefined; // napi_create_bigint_words ArkTS侧示例代码
...
```
 ...
 export const getValueBigintInt64t: (bigInt64: bigint) => boolean | undefined; // napi_get_value_bigint_int64 ArkTS侧示例代码
...
```
 ...
 export const getValueBigintUint64t: (bigUint64: bigint) => boolean | undefined; // napi_get_value_bigint_uint64 ArkTS侧示例代码
...
static napi_value GetValueBigintWords(napi_env env, napi_callback_info info)
{
    ...
    // 调用napi_get_value_bigint_words接口获取传入bigInt相���信息，如：signBit传入bigInt正负信息
...
```
 ...
 export const getValueBigintWords: (bigIntWords: bigint) => bigint | undefined; // napi_get_value_bigint_words ArkTS侧示例代码
