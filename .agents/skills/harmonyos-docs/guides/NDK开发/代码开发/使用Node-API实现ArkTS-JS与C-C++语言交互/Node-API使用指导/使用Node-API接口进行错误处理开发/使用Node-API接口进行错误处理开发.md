...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-error`  |  **DocID**: `b7d79c7aaa094a7d8a69f35c67d3bfbd`  |  **NodeID**: `000201775795460123366a9017f4a9a2`
...
```
     ...
     export const getLastErrorInfo: (str: string) => string; // napi_get_last_error_info     ArkTS侧示例代码
...
```
     ...
     export const createTypeError: () => Error; // napi_create_type_error     ArkTS侧示例代码
...
```
     ...
     export const createRangeError: () => Error; // napi_create_range_error     ArkTS侧示例代码
...
```
     ...
     export const napiThrow: () => void; // napi_create_error and napi_throw     ArkTS侧示例代码
...
```
     ...
     export const napiIsError: <T>(obj: T) => boolean; // napi_is_error     ArkTS侧示例代码
...
```
     ...
     export const getAndClearLastException: () => Error | undefined; // napi_get_and_clear_last_exception     ArkTS侧示例代码
...
```
     ...
     export const isExceptionPending: () => Object | undefined; // napi_is_exception_pending     ArkTS侧示例代码
...
```
     ...
     export const fatalError: () => void; // napi_fatal_error     ArkTS侧示例代码
...
```
     ...
     export const fatalException: (err: Error) => void; // napi_fatal_exception     ArkTS侧示例代码
