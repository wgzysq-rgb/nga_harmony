...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-function`  |  **DocID**: `6c59ca87c524497f9bfd5c969fab844f`  |  **NodeID**: `000201775795460123373319819b37df`
...
```
 ...
 export const calculateArea: (width: number, height: number) => number; // napi_create_function ArkTS 侧示例代码
