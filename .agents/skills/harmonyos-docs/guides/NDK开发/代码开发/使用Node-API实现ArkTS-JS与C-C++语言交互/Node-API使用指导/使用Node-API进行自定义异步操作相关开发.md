...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-napi-about-custom-asynchronous-operations`  |  **DocID**: `8c926b82d21b49dc836f469e7ccfdd99`  |  **NodeID**: `0002017757954601233925c9f9286885`
...
Node-API接口开发流程参考[使用Node-API实现跨语言交互开发流程](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/use-napi-process)，本文仅对接口对应C++及ArkTS相关代码进行展示。
   ...
   #### [h2]napi_async_init、napi_async_destroy
...
在编写Node-API模块时，异步操作完成后需调用ArkTS回调函数。可使用napi_async_init创建异步资源上下文，再使用napi_make_callback执行ArkTS回调函数。
   ...
   #### [h2]napi_open_callback_scope、napi_close_callback_scope
...
```
 ...
 export const asynchronousWork: (object: Object, obj: Object, fun: Function, num: number) => number | undefined; ArkTS侧示例代码
