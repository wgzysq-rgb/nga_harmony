...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `qos-guidelines`  |  **DocID**: `5b19b4ff80eb414d9215dd4efd79eb8c`  |  **NodeID**: `000201775795460123303845aaf25373`
...
**声明**
 ...
 int OH_QoS_SetThreadQoS(QoS_Level level); **参数**
...
**声明**
 ...
 int OH_QoS_GetThreadQoS(QoS_Level *level); **参数**
