...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `purgeable-memory-guidelines`  |  **DocID**: `42076115309c4e55bb5baf6a078f46c1`  |  **NodeID**: `0002017757954601233089269ebb7d00`
...
以下步骤描述了在**HarmonyOS**中如何使用Purgeable Memory提供的NAPI接口，申请PurgeableMemory对象，并将内容写入PurgeableMemory对象后，对相应对象进行读写访问。

 
声明PurgeableMemory对象创建规则。
