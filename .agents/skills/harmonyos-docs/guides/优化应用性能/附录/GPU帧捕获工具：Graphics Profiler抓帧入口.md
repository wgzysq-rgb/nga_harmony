...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-graphics-profiler`  |  **DocID**: `a617645274e241ceb67daaa9ec822256`  |  **NodeID**: `00020177579015419833126cb35fe525`
...
- 在DevEco Studio顶部菜单栏中点击View > Tool Windows > Graphics Profiler进入帧捕获页面。
在帧捕获页面，可配置Ref All Resources和Verify Buffer Access两个参数，配置完成后点击Launch APP拉起应用。
...
在帧捕获界面拉起应用，成功建立连接后，Capture按钮点亮。设置抓帧数量，点击Capture按钮，等待帧捕获完成。
...
当抓帧完成，在下方显示界面中选择一条捕获帧，点击按钮，可自动打开Graphics Profiler工具解析捕获帧信息。
