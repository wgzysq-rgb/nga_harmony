...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `asset-store-kit-overview`  |  **DocID**: `0b3fcaad090644ecb44dc8635b795343`  |  **NodeID**: `000201775795852716840c45cced61ff`
...
# Asset Store Kit简介
     ...
     其中，关键资产的加/解密使用AES256-GCM算法，关键资产的访问控制分为以下几类。
       ...
       批量查询出的关键资产需要通过IPC通道传输给业务，受IPC缓冲区大小限制，建议对查询超过40条关键资产时，进行分批查询，且每次查询数量不超过40条。
        ...
        - 应用卸载时，会清除对应的数据。[IS_PERSISTENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-asset#tag)属性设置为true的数据将保留。         
