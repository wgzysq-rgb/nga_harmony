...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `asset-js-update`  |  **DocID**: `680665defd68412c99147324253ce828`  |  **NodeID**: `000201775795852716203f63b6eecd4a`
...
# 更新关键资产(ArkTS)
     ...
     在更新关键资产时，关键资产属性的内容（AssetMap）参数如下表所示：
       ...
       在更新前，需确保已有关键资产，可参考[指南文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-add)新增关键资产，否则将抛出NOT_FOUND错误（错误码24000002）。
