...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicesecurity-trustedauth-verifybypwd`  |  **DocID**: `60944002e21941529dc53f0ec70d47d4`  |  **NodeID**: `0002017757958527162420f2df6a01d2`
...
```
             发起交易认证前，需从服务器获取当前账号在[设置数字盾密码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/devicesecurity-trustedauth-setpwd)时获取的authID。
