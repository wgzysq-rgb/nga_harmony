...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicesecurity-securitymode`  |  **DocID**: `4cb72c16df9a450f93f49e69b6b4fffe`  |  **NodeID**: `00020177579585271600764028380b46`
...
在CMakeLists.txt中导入设备安全模式共享库，并链接该库。
...
```
  ...
  #include <DeviceSecurityKit/device_security_mode.h>  调用接口查询设备当前的安全模式。
