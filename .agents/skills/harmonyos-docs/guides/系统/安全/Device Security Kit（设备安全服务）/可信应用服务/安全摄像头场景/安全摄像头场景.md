...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicesecurity-taas-securecamera`  |  **DocID**: `6843e7f19fa54f128478464b88dbcb8a`  |  **NodeID**: `00020177579585271605618d93d4373e`
...
import { BusinessError } from '@kit.BasicServicesKit';
```
             参考[安全相机开发指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-secure-photo)，初始化安全相机。
...
```
             参考[安全相机开发指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-secure-photo)，完成安全相机会话的创建，配置输入、输出流，启动预览流和安全数据流。
