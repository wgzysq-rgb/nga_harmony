...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicesecurity-taas-securelocation`  |  **DocID**: `3385a76646a1464e8da8acec02eea3dc`  |  **NodeID**: `0002017757958527161712c25997881e`
...
```
       如果需要销毁证明密钥，请在结束证明会话后，调用[destroyAttestKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-taas-api#destroyattestkey)接口。
