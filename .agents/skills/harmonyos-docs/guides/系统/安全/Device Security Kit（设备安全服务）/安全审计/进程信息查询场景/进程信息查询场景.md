...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicesecurity-audit-queryproc-arkts`  |  **DocID**: `21ba164e123f443e9d4b05abc4cfb62c`  |  **NodeID**: `0002017757958527162529d7e78a7f84`
...
# 进程信息查询场景
     ...
     **流程说明：**
     ...
     接口如下表，更多接口及使用方法请参见[API参考](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-securityaudit-api#queryallprocesses)。
