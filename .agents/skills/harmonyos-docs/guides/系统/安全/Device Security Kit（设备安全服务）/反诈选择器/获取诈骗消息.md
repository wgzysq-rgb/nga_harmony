...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicesecurity-selectfraudmessage`  |  **DocID**: `981cd8d71b11422bb8e89ca42e64880c`  |  **NodeID**: `000201775795852716097cab5d72137e`
...
# 获取诈骗消息
     ...
     **流程说明：**
             ...
             开发者应用调用Device Security Kit的接口拉起诈骗消息选择器。

             用户在诈骗消息选择器中选择诈骗消息。

             Device Security Kit调用回调函数通知开发者应用，开发者应用根据诈骗消息进行业务处理。
