...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-import-key-in-plaintext-ndk`  |  **DocID**: `3bb6523ac7ce459db079837a039579c3`  |  **NodeID**: `000201775795852716596706e820dbf8`
...
```
        ...
        - 密钥材料须符合[HUKS密钥材料格式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-concepts#密钥材料格式)。
             ...
             调用[OH_Huks_ImportKeyItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-api-h#oh_huks_importkeyitem)，传入密钥别名和密钥属性集，导入密钥。
