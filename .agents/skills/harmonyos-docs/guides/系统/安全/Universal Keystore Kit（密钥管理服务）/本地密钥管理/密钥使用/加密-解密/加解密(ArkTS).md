...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-encryption-decryption-arkts`  |  **DocID**: `93132c204d774a6089c0f0352c46dca8`  |  **NodeID**: `000201775795852716590b111c36a0ed`
...
# 加解密(ArkTS)
     ...
     **加密**
             ...
             使用[HuksParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#huksparam)设置加密算法参数配置。
     ...
     **解密**
             ...
             使用[HuksParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#huksparam)设置解密算法参数配置。
