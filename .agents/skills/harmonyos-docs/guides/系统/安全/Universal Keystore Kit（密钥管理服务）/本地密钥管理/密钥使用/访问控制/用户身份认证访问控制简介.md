...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-identity-authentication-overview`  |  **DocID**: `283786bf34724f5696f5d38a39318f17`  |  **NodeID**: `000201775795852716571213f24fe59f`
...
- HUKS_USER_AUTH_TYPE_TUI_PIN，即数字盾密码。简写为TUI_PIN。数字盾密码请参考[数字盾服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/devicesecurity-trustedauth-service)。
...
| 用户身份认证  | 授权访问类型  | 说明  
 ...
 | TUI_PIN  | ALWAYS_VALID  | 当前仅支持数字盾密码进行身份认证，密钥永久有效。  
 | TUI_PIN | FACE  | ALWAYS_VALID  | 当前支持数字盾密码或人脸进行身份认证，密钥永久有效。  
 | TUI_PIN | FINGERPRINT  | ALWAYS_VALID  | 当前支持数字盾密码或指纹进行身份认证，密钥永久有效。  
 | TUI_PIN | FACE | FINGERPRINT  | ALWAYS_VALID  | 当前支持数字盾密码、人脸或指纹进行身份认证，密钥永久有效。
