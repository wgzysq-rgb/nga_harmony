...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-signing-signature-verification-ndk`  |  **DocID**: `84cedfaac6bc425f986592b5a9a18aaa`  |  **NodeID**: `0002017757958527166059251e7bc1ed`
...
```
     ...
     **签名**
             ...
             调用[OH_Huks_InitParamSet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-param-h#oh_huks_initparamset)指定算法参数配置。
