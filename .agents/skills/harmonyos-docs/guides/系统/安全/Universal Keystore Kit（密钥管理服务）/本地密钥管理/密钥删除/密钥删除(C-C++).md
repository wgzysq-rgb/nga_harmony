...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-delete-key-ndk`  |  **DocID**: `95228cb0ccdb4a259d44618f5150f1aa`  |  **NodeID**: `00020177579585271641059bf425546d`
...
```
     ...
     以删除ECC密钥为例。
             ...
             初始化密钥属性集。用于删除时指定密钥的属性，删除单个密钥或者非群组密钥，可传空。

             调用接口[OH_Huks_DeleteKeyItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-api-h#oh_huks_deletekeyitem)，删除密钥。
