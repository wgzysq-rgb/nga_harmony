...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-cmac-native`  |  **DocID**: `a590419e3239415fb4c7d1b426d6268c`  |  **NodeID**: `000201775795852716592225404f5b87`
...
# CMAC(C/C++)
     ...
     **生成密钥**
             ...
             调用[OH_Huks_GenerateKeyItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-api-h#oh_huks_generatekeyitem)生成密钥，支持的规格是128比特长度的密钥。
     ...
     **执行CMAC**
             ...
             调用[OH_Huks_InitParamSet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-param-h#oh_huks_initparamset)获取算法参数配置。
