...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `huks-check-key-arkts`  |  **DocID**: `0c85ab64c4064d9aa37c5eab91f5643e`  |  **NodeID**: `000201775795852716573485eeae66cf`
...
# 查询密钥是否存在(ArkTS)
    ...
    从API 23开始支持[群组密钥](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-group-key-overview)特性。
             ...
             调用接口[hasKeyItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#hukshaskeyitem11)，查询密钥是否存在。
