...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `obtain-auth-lock-state-capabilities`  |  **DocID**: `7d301ebd1663413c94aa149ed57fb433`  |  **NodeID**: `00020177579585271634768523db5171`
...
# 查询指定认证类型的认证冻结状态
     ...
     具体参数、返回值、错误码等描述，请参考对应的[userAuth.getAuthLockState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth#userauthgetauthlockstate22)。
             ...
             指定认证类型（[UserAuthType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth#userauthtype8)），并调用[getAuthLockState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth#userauthgetauthlockstate22)接口查询指定认证类型的认证冻结状态。
