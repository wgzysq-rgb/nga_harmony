...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `start-authentication`  |  **DocID**: `40a5ed30dd6d4d83869b3bfef41c72e4`  |  **NodeID**: `000201775795852716209e2ae8b2ca93`
...
# 发起认证
     ...
     当前支持使用认证控件的认证类型包括：
             ...
             调用[UserAuthInstance.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth#on10)接口订阅认证结果。
