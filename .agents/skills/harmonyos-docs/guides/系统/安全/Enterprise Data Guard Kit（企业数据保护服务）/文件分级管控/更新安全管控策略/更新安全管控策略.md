...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `fileguard-update-policy`  |  **DocID**: `30dcba3db80245378f8b82f21b63c08c`  |  **NodeID**: `000201775795852716332d89cda6236c`
...
# 更新安全管控策略
     ...
     详细接口说明可参考[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataguard-fileguard)。
                        ...
                        | 接口名          | 描述         
                               | [updatePolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataguard-fileguard#updatepolicy)(policy: string, callback: AsyncCallback<void>): void          | 使用Callback方式更新安全管控策略。         
                 | [updatePolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataguard-fileguard#updatepolicy-1)(policy: string): Promise<void>          | 使用Promise方式更新安全管控策略。         
...
```
             初始化[FileGuard](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataguard-fileguard#fileguard)对象guard，调用接口updatePolicy，更新安全管控策略。
