...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `certmanager-ca-certs-guidelines`  |  **DocID**: `1b603a9d64514d75b0f1ad5711f218ba`  |  **NodeID**: `000201775795852716220db08f52b333`
...
# CA证书开发指导
     ...
     以上场景涉及的常用接口如下表所示。
       ...
       import { certificateManager } from '@kit.DeviceCertificateKit';             安装用户CA证书、获取用户CA证书列表、获取用户证书详情、删除用户CA证书。
