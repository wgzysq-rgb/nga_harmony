...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `certmanager-private-credential-guidelines`  |  **DocID**: `2680eb6fb547424b8e3d6c55391cb487`  |  **NodeID**: `00020177579585271617659533c28933`
...
# 应用证书凭据开发指导
     ...
     以上场景涉及的常用接口如下表所示。
       ...
       import { certificateManager } from '@kit.DeviceCertificateKit';             安装应用证书凭据，获取应用证书凭据，并使用应用证书凭据进行签名、验签，最后删除应用证书凭据。
