...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `create-parse-verify-certextension-object`  |  **DocID**: `60bf045381f84edd81e964bef181ae49`  |  **NodeID**: `0002017757958527162190d08e27cf72`
...
# 证书扩展信息对象的创建、解析和校验
       ...
       import { cert } from '@kit.DeviceCertificateKit';             解析证书扩展域段数据，调用[cert.createCertExtension](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecertextension10)创建证书扩展域段对象。

             调用[CertExtension.getEntry](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#getentry10)获取指定OID证书扩展域段信息。比如，证书扩展域段对象标识符列表，根据对象标识符获取具体数据等。

             调用[CertExtension.checkCA](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#checkca10)判断证书是否为CA证书。
