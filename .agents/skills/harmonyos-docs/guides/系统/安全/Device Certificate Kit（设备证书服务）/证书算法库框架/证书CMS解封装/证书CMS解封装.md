...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `create-cms-decapsulation-object`  |  **DocID**: `77c098d5457440798fb3db3d0d3b28e9`  |  **NodeID**: `000201775795852716353e27082ad9fd`
...
# 证书CMS解封装
    ...
    目前仅支持CMS签名数据和封装数据。
       ...
       import { cert } from '@kit.DeviceCertificateKit';             调用[证书CMS封装](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-enveloped-object)进行CMS数据封装。

             调用[cert.createCmsParser](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecmsparser22)创建CmsParser对象。

             调用[cmsParser.setRawData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#setrawdata22)设置CMS数据。

             调用[cmsParser.decryptEnvelopedData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#decryptenvelopeddata22)解密封装数据。
