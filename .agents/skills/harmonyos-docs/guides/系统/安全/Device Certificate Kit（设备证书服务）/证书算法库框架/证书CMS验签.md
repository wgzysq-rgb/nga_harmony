...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `create-cms-verify-object`  |  **DocID**: `f60cb9d9012e46b6a1579b3c0fba3bca`  |  **NodeID**: `0002017757958527163526340aaf101c`
...
# 证书CMS验签
    ...
    目前仅支持CMS签名数据和封装数据。
       ...
       import { cert } from '@kit.DeviceCertificateKit';             签名的开发步骤查看[CMS签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-sign-object)。
             ...
             调用[cmsParser.verifySignedData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#verifysigneddata22)进行验签。
