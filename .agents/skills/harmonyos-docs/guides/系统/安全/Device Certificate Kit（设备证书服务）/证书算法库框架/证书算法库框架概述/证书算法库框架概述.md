...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `certificate-framework-overview`  |  **DocID**: `671b1e0870994d298113c925026f8c73`  |  **NodeID**: `00020177579585271610348279924899`
...
# 证书算法库框架概述
    ...
    开发者通过调用证书算法库框架接口，忽略底层不同三方算法库的差异，实现迅捷开发。
     ...
     证书算法库框架主要提供了以下类，开发者可以查阅对应API参考，了解以下接口：
                        ...
                        | 名称          | 类          | 功能         
                               | X509证书          | [X509Cert](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#x509cert)          | 提供X509证书的解析、序列化、X509证书签名验证、证书相关的信息查询等功能。         
                 | 证书扩展域段          | [CertExtension](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certextension10)          | 提供X509证书中扩展域段的获取，如是否CA，CRL分发点等字段。         
                 | X509证书吊销列表          | [X509CRL](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#x509crl11)          | 提供X509证书吊销列表的解析、序列化、信息查询等功能。         
                 | 证书链校验器          | [CertChainValidator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certchainvalidator)          | 提供证书链校验（不包括证书有效期的校验）、证书链算法名称查询的功能。         
                 | 证书和证书吊销列表集合          | [CertCRLCollection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcrlcollection11)          | 提供证书和证书吊销列表集合的查询功能。         
                 | X509证书链          | [X509CertChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#x509certchain11)          | 提供证书链校验、证书列表获取的功能。

---
*Updated: 2026-04-20 01:46:13*
