...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `create-cms-sign-object`  |  **DocID**: `94ed0a0dbb2745e78daab9f19f8adfff`  |  **NodeID**: `00020177579585271634951cbe9f555a`
...
# 证书CMS签名
    ...
    目前仅支持CMS签名数据和封装数据。
       ...
       import { cert } from '@kit.DeviceCertificateKit';             调用[cert.createCmsGenerator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecmsgenerator18)创建cmsGenerator对象。
             ...
             调用[cmsGenerator.addSigner](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#addsigner18)添加签名者信息。

             调用[cmsGenerator.addCert](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#addcert18)添加证书。

             调用[cmsGenerator.doFinal](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#dofinal18)获取Cms最终签名数据。
