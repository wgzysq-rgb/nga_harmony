...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `create-cms-enveloped-object`  |  **DocID**: `1d035ccea4da4909b2b316d59242952f`  |  **NodeID**: `00020177579585271635198aaf9ae9e8`
...
# 证书CMS封装
    ...
    目前仅支持CMS签名数据和封装数据。
       ...
       import { cert } from '@kit.DeviceCertificateKit';             调用[cert.createCmsGenerator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecmsgenerator18)创建cmsGenerator对象。

             调用[cmsGenerator.setRecipientEncryptionAlgorithm](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#setrecipientencryptionalgorithm22)设置加密算法。

             调用[cmsGenerator.addRecipientInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#addrecipientinfo22)添加接收者信息。

             调用[cmsGenerator.doFinal](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#dofinal18)获取CMS最终封装数据。

             调用[cmsGenerator.getEncryptedContentData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#getencryptedcontentdata22)获取CMS封装密文数据。
