...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-rsa-sign-sig-verify-pkcs1-ndk`  |  **DocID**: `1ab1f4eb2fe54ec9a951740b0afc30a0`  |  **NodeID**: `0002017757958527164338185cd1342b`
...
```
             ...
             调用[OH_CryptoVerify_Update](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoverify_update)，传入待验证的数据。
