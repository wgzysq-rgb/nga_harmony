...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-sm2-sign-data-format-conversion-ndk`  |  **DocID**: `08e9e5892fd24ad48f69c12fa584eed9`  |  **NodeID**: `0002017757958527165307a83cd76e4e`
...
# SM2签名数据格式转换 (C/C++)
    ...
    **指定密文参数，转换为DER格式**
           ...
           调用[OH_CryptoEccSignatureSpec_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoeccsignaturespec_create)，创建[OH_CryptoEccSignatureSpec](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-cryptosignatureapi-oh-cryptoeccsignaturespec)对象，用于设置SM2密文参数。

           调用[OH_CryptoEccSignatureSpec_SetRAndS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoeccsignaturespec_setrands)，将R、S设置到OH_CryptoEccSignatureSpec对象中。

           调用[OH_CryptoEccSignatureSpec_Encode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoeccsignaturespec_encode)得到转换后的DER格式的密文。

           调用[OH_CryptoEccSignatureSpec_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoeccsignaturespec_destroy)释放对象。
...
```
    **指定DER格式，转换为r、s格式**
           ...
           调用[OH_CryptoEccSignatureSpec_GetRAndS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoeccsignaturespec_getrands)拿到转换后的数据r、s。

           调用[OH_CryptoEccSignatureSpec_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoeccsignaturespec_destroy)释放内存。
