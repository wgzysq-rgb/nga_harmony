...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-rsa-sign-sig-verify-recover-pkcs1-ndk`  |  **DocID**: `58dfb0ec64a94aca99e5b03154ff6547`  |  **NodeID**: `00020177579585271646743f9a6d4559`
...
```
             ...
             调用[OH_CryptoVerify_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoverify_create)，指定字符串参数'RSA1024|PKCS1|SHA256|Recover'，与签名的Sign实例保持一致。创建Verify实例，用于完成验签操作。
             ...
             调用[OH_CryptoVerify_Recover](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoverify_recover)，对数据进行签名恢复。
