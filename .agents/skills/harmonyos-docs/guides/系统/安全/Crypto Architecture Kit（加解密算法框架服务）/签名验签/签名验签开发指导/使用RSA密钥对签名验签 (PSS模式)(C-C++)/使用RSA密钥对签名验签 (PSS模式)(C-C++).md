...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-rsa-sign-sig-verify-pss-ndk`  |  **DocID**: `ecabeccbb59346f3bfa3ea149829f17c`  |  **NodeID**: `000201775795852716510a7800a31169`
...
```
             ...
             调用[OH_CryptoVerify_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoverify_create)，指定字符串参数'RSA2048|PSS|SHA256|MGF1_SHA256'，创建非对称密钥类型为RSA2048、填充模式为PSS、摘要算法为SHA256、掩码算法为MGF1_SHA256的Verify实例，用于完成验签操作。

             调用[OH_CryptoVerify_SetParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-signature-h#oh_cryptoverify_setparam)，设置签名参数。需要与签名时设置的保持一致。
