...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-sm2-ciphertext-conversion-ndk`  |  **DocID**: `1e040c15dcad458cbc17e0d49dc84e2c`  |  **NodeID**: `000201775795852716558c9736702c34`
...
# 使用SM2密文格式转换(C/C++)
    ...
    **指定密文参数，生成标准ASN.1密文**
           ...
           调用[OH_CryptoSm2CiphertextSpec_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptosm2ciphertextspec_create)，创建空的SM2密文规格对象。

           调用[OH_CryptoSm2CiphertextSpec_SetItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptosm2ciphertextspec_setitem)，设置密文的各个参数（C1.x、C1.y、C2、C3）。

           调用[OH_CryptoSm2CiphertextSpec_Encode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptosm2ciphertextspec_encode)，生成ASN.1格式的密文（当前密文转换仅支持SM3，实现中只校验hash长度是否为32字节）。

           使用完毕后，调用[OH_CryptoSm2CiphertextSpec_Destroy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptosm2ciphertextspec_destroy)销毁SM2密文规格对象。
...
```
    **从标准ASN.1密文中获取密文参数**
           ...
           调用[OH_CryptoSm2CiphertextSpec_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptosm2ciphertextspec_create)，从ASN.1格式密文创建SM2密文规格对象。

           调用[OH_CryptoSm2CiphertextSpec_GetItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptosm2ciphertextspec_getitem)，获取密文中的各个参数（C1.x、C1.y、C2、C3）。
