...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-rsa-asym-encrypt-decrypt-by-segment-ndk`  |  **DocID**: `9a1b25c094c849a989be26fb546f8016`  |  **NodeID**: `0002017757958527165515a6e1d42bab`
...
# 使用RSA非对称密钥分段加解密(C/C++)
    ...
    **加密**
      ...
      如何生成RSA非对称密钥对，开发者可参考下文示例，并结合[非对称密钥生成和转换规格：RSA](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-asym-key-generation-conversion-spec#rsa)和[随机生成非对称密钥对](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-generate-asym-key-pair-randomly)理解。参考文档与当前示例可能存在入参差异，请在阅读时注意区分。
           ...
           多次调用[OH_CryptoAsymCipher_Final](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptoasymcipher_final)，传入明文，获取加密后的数据。
    ...
    **解密**
           ...
           多次调用[OH_CryptoAsymCipher_Final](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-asym-cipher-h#oh_cryptoasymcipher_final)，传入密文，获取解密后的数据。
