...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `crypto-compute-cmac-ndk`  |  **DocID**: `11137abc8fcd4ab59635834b1a277b7f`  |  **NodeID**: `0002017757958527162959d065ed6b92`
...
# 消息认证码计算CMAC(C/C++)
     ...
     下面分别提供两种方式的示例代码。
             ...
             调用[OH_CryptoMac_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-mac-h#oh_cryptomac_create)，指定字符串参数'CMAC'，创建MAC算法为CMAC的MAC生成器。

             调用[OH_CryptoMac_SetParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-mac-h#oh_cryptomac_setparam)，指定参数CRYPTO_MAC_CIPHER_NAME_STR，设置分组密码算法名称。
