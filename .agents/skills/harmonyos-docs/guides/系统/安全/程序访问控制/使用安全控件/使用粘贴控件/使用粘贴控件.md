...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pastebutton`  |  **DocID**: `a957deb6f3e44200bcea717b2ab0e05c`  |  **NodeID**: `0002017757958527161919e3c80a322e`
...
# 使用粘贴控件
    ...
    粘贴控件效果如图所示。
     ...
     以简化用户填写验证码为例，参考以下步骤：单击控件获取临时授权，将内容粘贴到文本框。效果图见上文。
       ...
       import { pasteboard } from '@kit.BasicServicesKit';             添加输入框和粘贴控件。
