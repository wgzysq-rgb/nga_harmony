...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `permissions-for-all`  |  **DocID**: `394705579c1e4920bfd58959a7443738`  |  **NodeID**: `000201775795852716369df5e7112a00`
...
以下权限的授权方式均为[system_grant](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-permission-mgmt-overview#system_grant系统授权)，申请方式请参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。
