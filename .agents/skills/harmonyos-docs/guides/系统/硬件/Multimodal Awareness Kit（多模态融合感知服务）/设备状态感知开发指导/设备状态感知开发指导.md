...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicestatus-guidelines`  |  **DocID**: `d101dd26d5614a7b82307aaf7ab9b76c`  |  **NodeID**: `000201775795852716927363c113e8e1`
...
# 设备状态感知开发指导
    ...
    详细的接口介绍请参考[@ohos.multimodalAwareness.deviceStatus (设备状态感知)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-awareness-devicestatus)。
     ...
     设备需要支持加速度计。
       ...
       import { deviceStatus } from '@kit.MultimodalAwarenessKit';             订阅设备静止姿态（支架态）感知事件。
