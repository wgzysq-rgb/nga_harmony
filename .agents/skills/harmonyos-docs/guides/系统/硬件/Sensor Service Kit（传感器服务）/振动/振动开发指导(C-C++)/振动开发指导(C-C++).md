...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `vibrator-guidelines-capi`  |  **DocID**: `382a100c840c4aac937f5bbe36c2729c`  |  **NodeID**: `00020177579585271623276b46450b3b`
...
# 振动开发指导(C/C++)
     ...
     自定义振动提供给用户设计自己所需振动效果的能力，用户可通过自定义振动配置文件，并遵循相应规则编排所需振动形式，使能更加开放的振感交互体验。
             ...
             控制设备上的振动器，需要申请权限ohos.permission.VIBRATE。具体配置方式请参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。
