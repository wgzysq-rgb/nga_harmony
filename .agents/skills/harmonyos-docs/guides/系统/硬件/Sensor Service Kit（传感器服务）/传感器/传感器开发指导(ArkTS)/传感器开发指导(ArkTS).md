...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `sensor-guidelines`  |  **DocID**: `1517c09576cb419ca69e77a43e59ad16`  |  **NodeID**: `0002017757958527161931944b30ce66`
...
```
       ...
       let TAG = 'sensor: ';             查询设备支持的所有传感器的参数，如果获取不到某个传感器则代表该传感器在此设备上不存在或不可用，如果订阅没查到的传感器时需要处理异常。
