...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hid-ddk-guidelines`  |  **DocID**: `827a2430b2d74a0783eb902a6c9b63d0`  |  **NodeID**: `000201775795852716158546721f07cc`
...
```
             向HID设备写入/发送报告（HID设备与主机之间交换的数据包）（可选）。
