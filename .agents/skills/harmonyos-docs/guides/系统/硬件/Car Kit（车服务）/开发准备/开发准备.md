...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `car-preparations`  |  **DocID**: `3f2b27a1b6204e4fb5b2212eac331514`  |  **NodeID**: `0002017757958527168686734607a773`
...
```
     ...
     metadata的name可选值：carHopCapability、hiCarCapability。
            ...
            3. CHANGE_THEME
                     ...
                     | updateNaviStatus                        适配地图状态和地图元数据，对应指令：
