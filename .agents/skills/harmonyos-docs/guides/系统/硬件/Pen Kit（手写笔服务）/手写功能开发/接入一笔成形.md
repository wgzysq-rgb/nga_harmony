...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pen-instant-shape`  |  **DocID**: `05cdfef0f063431aa09a2cad93f5f5b1`  |  **NodeID**: `0002017757958527162260fa37578855`
...
# 接入一笔成形
     ...
     在应用中实现一笔成形，效果如下：
       ...
       import { InstantShapeGenerator, ShapeInfo } from '@kit.Penkit';             构造包含一笔成形能力，下面以控件为例：
