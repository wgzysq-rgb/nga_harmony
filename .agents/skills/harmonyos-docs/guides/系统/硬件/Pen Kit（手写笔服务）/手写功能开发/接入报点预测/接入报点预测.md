...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pen-point-prediction`  |  **DocID**: `62ea280ab7564fd6bbd3dc6ee3d79d26`  |  **NodeID**: `000201775795852716167bb3a1766761`
...
# 接入报点预测
     ...
     在应用的自定义界面中，获取到界面的触摸事件，通过调用报点预测的接口，可以得到预测的下一个报点的位置信息。
       ...
       import { PointPredictor } from '@kit.Penkit';             获取当前界面的触摸事件信息，调用接口计算预测点信息。
