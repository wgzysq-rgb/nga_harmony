...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `deflate-and-inflate`  |  **DocID**: `98277976c8ca4235a9583d33217b0ae7`  |  **NodeID**: `000201775795852716033671e52e8cca`
...
```
                  #### [h2]未知大小缓冲区的压缩与解压（zlib格式）

     针对一个未知大小的缓冲区中的数据，使用接口[deflate()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-zlib#deflate12)将从一个原始输入流中读取的数据进行压缩，使用接口[inflate()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-zlib#inflate12)将从一个���缩输入流中读取的数据进行解压，示例代码如下。
