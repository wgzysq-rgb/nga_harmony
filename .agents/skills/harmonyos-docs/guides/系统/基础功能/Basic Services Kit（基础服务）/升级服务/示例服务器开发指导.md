...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `sample-server-guidelines`  |  **DocID**: `78fcf3c03335462bbc7193e17cfc7fec`  |  **NodeID**: `00020177579585271615317d6b8b4279`
...
生成SSL证书
  ...
  openssl req -newkey rsa:2048 -nodes -keyout serverKey.pem -x509 -days 365 -out serverCert.cer -subj "/C=CN/ST=GD/L=GZ/O=abc/OU=defg/CN=hijk/emailAddress=test.com"  修改bundle.json
