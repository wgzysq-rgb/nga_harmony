...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `isochronoustransfer`  |  **DocID**: `b80695b6d12549acb7d95fd6b31ae90b`  |  **NodeID**: `00020177579585271661195e10b22811`
...
```
      ...
      - 主机端通过USB接口连接支持实时传输的设备（USB耳机等）。
      - 执行上述代码。
      - log中搜索关键字transfer success，表示实时传输接口调用成功。
