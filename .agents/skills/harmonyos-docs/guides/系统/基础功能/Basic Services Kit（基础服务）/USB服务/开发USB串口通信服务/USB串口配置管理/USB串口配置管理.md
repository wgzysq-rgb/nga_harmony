...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `usbserial-configuration`  |  **DocID**: `f2a3ae21782e49d0b5891028f889b498`  |  **NodeID**: `000201775795852716428c2a7798fbc5`
...
- 在HarmonyOS设备上执行上述示例。
- 返回getAttribute usbSerial success和setAttribute usbSerial success表示相关接口调用成功，可以查看当前串口的配置。
