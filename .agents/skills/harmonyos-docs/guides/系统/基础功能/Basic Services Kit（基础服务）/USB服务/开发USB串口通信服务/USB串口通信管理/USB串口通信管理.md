...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `usbserial-communication`  |  **DocID**: `352170b2dde5414ab40c1d4e74cea513`  |  **NodeID**: `000201775795852716463df8ec347d08`
...
- 准备一根USB转串口线缆，线缆的USB接口连接到HarmonyOS设备USB端口（该端口需支持USB转串口），线缆的串口接口连接到目标设备的串口上。
- 在HarmonyOS设备上执行上述示例。
- 返回usbSerial success，表示相关接口调用成功，设备串口通信能力正常；返回usbSerial error，表示接口调用失败。
