...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `interrupttransfer`  |  **DocID**: `21b68f6a8ec8484cbf1df76d76f9aced`  |  **NodeID**: `000201775795852716597c8eca458f56`
...
```
      ...
      - 主机端通过USB接口连接支持中断传输的终端设备（鼠标、键盘等）。
      - 执行上述代码。
      - log中搜索关键字transfer success，表示中断传输接口调用成功。
