...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `itc-with-emitter`  |  **DocID**: `da724a7214a9444db241e58fcd137f10`  |  **NodeID**: `0002017757958527161358bec45b4181`
...
# 使用Emitter进行线程间通信
     ...
     使用Emitter实现事件订阅、事件发送以及事件删除，开发步骤如下。
       ...
       import { emitter, Callback } from '@kit.BasicServicesKit';             订阅事件。
