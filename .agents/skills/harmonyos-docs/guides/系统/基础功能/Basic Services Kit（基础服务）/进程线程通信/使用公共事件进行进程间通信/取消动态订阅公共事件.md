...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `common-event-unsubscription`  |  **DocID**: `f4bb9fd661124635a2f06f3a96537a3c`  |  **NodeID**: `00020177579585271644411af70b62ef`
...
```
             根据[动态订阅公共事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/common-event-subscription)章节的步骤来订阅某个事件。

             调用CommonEvent中的[unsubscribe()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-commoneventmanager#commoneventmanagerunsubscribe)方法取消订阅某事件。
