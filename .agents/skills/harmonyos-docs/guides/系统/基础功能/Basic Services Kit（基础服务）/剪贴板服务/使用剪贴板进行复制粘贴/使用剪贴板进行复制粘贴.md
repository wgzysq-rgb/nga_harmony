...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `use-pasteboard-to-copy-and-paste`  |  **DocID**: `8cd752712e5f4bebade639c5e27227a1`  |  **NodeID**: `00020177579585271613770abe68198c`
...
# 使用剪贴板进行复制粘贴
     ...
     **应用粘贴时通过剪贴板读取数据**
     ...
     使用剪贴板getData接口获取到uri类型数据之后，请使用文件管理的[fileIo.copy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocopy11)接口获取文件。
