...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `performance-analysis-kit-terminology`  |  **DocID**: `c119e547a6154d27a83b68117d1c9a03`  |  **NodeID**: `0002017757958527160180d6195ce9ae`
...
记录线程执行到当前现场（如崩溃、冻屏等）的函数调用顺序。具体说明请参见[调用栈帧内容说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cppcrash-guidelines#一般故障场景日志规格)和[JS混合栈帧内容说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cppcrash-guidelines#一般故障场景日志规格)。
