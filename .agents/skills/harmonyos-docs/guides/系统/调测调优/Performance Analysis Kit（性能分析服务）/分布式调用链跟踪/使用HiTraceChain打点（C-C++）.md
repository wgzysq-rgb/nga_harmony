...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hitracechain-guidelines-ndk`  |  **DocID**: `31af057433d543cb8dfec5a95f88f4d3`  |  **NodeID**: `000201775795852716236051e1398257`
...
# 使用HiTraceChain打点（C/C++）
     ...
     下表所示的接口提供基本的分布式跟踪功能，ArkTS中也有相应的接口。
          ...
          true：HiTraceId有效；false：HiTraceId无效。
                 ...
                 | bool OH_HiTrace_IsFlagEnabled(const HiTraceId *id, HiTrace_Flag flag)                    判断HiTraceId中指定的跟踪标志是否已启用。
...
```
             点击DevEco Studio界面中的运行按钮，运行应用工程。然后点击设备上“clickTime=0”按��，触发业务逻辑。
