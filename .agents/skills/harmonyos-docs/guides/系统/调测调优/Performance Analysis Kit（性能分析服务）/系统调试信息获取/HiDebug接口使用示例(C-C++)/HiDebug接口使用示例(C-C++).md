...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hidebug-guidelines-ndk`  |  **DocID**: `3cb32d44f8e34cc4a5a02e810a6145a2`  |  **NodeID**: `000201775795852716206edc8817b7c8`
...
```
  ...
  导入依赖：
    ...
    import testNapi from 'libentry.so';  定义测试方法：
