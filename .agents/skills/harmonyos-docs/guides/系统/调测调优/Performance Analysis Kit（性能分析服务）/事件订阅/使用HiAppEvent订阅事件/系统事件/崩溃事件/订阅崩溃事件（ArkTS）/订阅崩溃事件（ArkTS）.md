...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-crash-events-arkts`  |  **DocID**: `802265df238e46a48ce3cfd46da8322a`  |  **NodeID**: `000201775795852716640bdea7046e91`
...
```
         ...
         export const testNullptr: () => void;         编辑工程中的“entry > src > main > ets > pages > Index.ets”文件，添加按钮并在其onClick函数中构造崩溃场景，以触发崩溃事件。示例代码如下：
