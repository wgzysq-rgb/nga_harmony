...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-cpu-usage-high-arkts`  |  **DocID**: `e19587174ba0430fb099244d3b5dc115`  |  **NodeID**: `00020177579585271663653bda331b64`
...
新建一个ArkTS应用工程，编辑工程中的“entry > src > main > ets > entryability > EntryAbility.ets”文件，导入依赖模块，示例代码如下：
  ...
  import { hiAppEvent, hilog } from '@kit.PerformanceAnalysisKit';  编辑工程中的“entry > src > main > ets  > entryability > EntryAbility.ets”文件，可以在例如onCreate函数中添加系统事件的订阅，示例代码如下：
