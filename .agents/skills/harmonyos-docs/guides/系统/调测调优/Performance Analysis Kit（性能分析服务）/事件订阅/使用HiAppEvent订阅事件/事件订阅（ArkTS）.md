...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-app-events-arkts`  |  **DocID**: `16f8759fff354045aea1f1c718af1589`  |  **NodeID**: `0002017757958527164161b31951f4e9`
...
# 事件订阅（ArkTS）
     ...
     API接口使用说明，包括参数使用限制和具体取值范围。请参考[@ohos.hiviewdfx.hiAppEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hiviewdfx-hiappevent)。
     ...
     **订阅接口功能介绍**：
     ...
     以订阅崩溃事件（系统事件）和按钮点击事件（应用事件）为例，说明开发步骤。
       ...
       import { hiAppEvent, hilog } from '@kit.PerformanceAnalysisKit';             编辑工程中的“entry > src > main > ets > entryability > EntryAbility.ets” 文件，在onCreate函数中添加对崩溃事件、按钮点击事件的订阅。
