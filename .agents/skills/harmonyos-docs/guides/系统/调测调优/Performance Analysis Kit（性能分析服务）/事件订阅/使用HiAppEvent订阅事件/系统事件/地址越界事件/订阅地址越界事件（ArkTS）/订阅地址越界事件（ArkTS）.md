...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-address-sanitizer-events-arkts`  |  **DocID**: `c57ba18ba9294b69803ae69edafdc050`  |  **NodeID**: `000201775795852716638c897872073f`
...
```
       ...
       export const test: () => void;             编辑工程中的“entry > src > main > ets > pages > Index.ets”文件，新增按钮触发地址越界事件：
