...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-mainthreadjank-events-ndk`  |  **DocID**: `0628e9bc7004413db285219ab160a72a`  |  **NodeID**: `000201775795852716652f8dbd97d8ce`
...
```
       ...
       export const registerWatcher: () => void;             编辑工程中的“entry > src > main > ets > entryability> EntryAbility.ets”文件，在onCreate()函数中新增接口调用。
