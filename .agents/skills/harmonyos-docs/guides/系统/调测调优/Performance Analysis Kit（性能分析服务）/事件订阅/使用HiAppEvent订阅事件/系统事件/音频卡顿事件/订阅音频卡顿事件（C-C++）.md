...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-audio-jank-event-c`  |  **DocID**: `85861294f31a45779272d52187f1770f`  |  **NodeID**: `000201775795852716645056ec084251`
...
```
  ...
  export const registerWatcher: () => void;  在“EntryAbility.ets”文件的onCreate()函数中添加接口调用。
