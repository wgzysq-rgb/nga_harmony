...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-freeze-events-ndk`  |  **DocID**: `2dd47518f6ca45fdaaf8f9dc250fae65`  |  **NodeID**: `000201775795852716647b1d1db5a1e0`
...
```
       ...
       export const registerWatcher: () => void;             编辑“EntryAbility.ets”文件，在onCreate()函数中新增接口调用。
