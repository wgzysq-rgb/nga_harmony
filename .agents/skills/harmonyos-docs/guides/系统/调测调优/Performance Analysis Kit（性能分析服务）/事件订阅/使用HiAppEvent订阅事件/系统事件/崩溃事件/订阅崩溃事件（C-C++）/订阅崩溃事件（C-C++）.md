...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `hiappevent-watcher-crash-events-ndk`  |  **DocID**: `edb07679be1544eb90c513bee0ab527f`  |  **NodeID**: `00020177579585271665109e46bd66c6`
...
```
             点击运行按钮，启动应用工程。在应用界面中点击“JsError”按钮，触发崩溃事件。系统生成相应的崩溃日志并进行回调。
