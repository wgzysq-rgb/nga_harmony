...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `unpacking-tool`  |  **DocID**: `2ee1afeef36642c2ad7c027c3c06aace`  |  **NodeID**: `00020177579585271614357ed6d6297d`
...
# 拆包工具
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode hap --hap-path <path> --out-path <path> [--force true]     **参数含义及规范**
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode app --app-path <path> --out-path <path> [--force true]     **参数含义及规范**
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode hap --rpcid true --hap-path <path> --out-path <path> [--force true]     **参数含义及规范**
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode hap --hap-path <path> --out-path <path> [--force true] [--libs true] [--cpu-abis option]     **参数含义及规范**
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode hsp --hsp-path <path> --out-path <path> [--force true]     **参数含义及规范**
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode hsp --hsp-path <path> --out-path <path> [--force true] [--libs true] [--cpu-abis option]     **参数含义及规范**
     ...
     **示例**
     ...
     java -jar app_unpacking_tool.jar --mode appqf --appqf-path <path> --out-path <path> [--force true]     **参数含义及规范**
     ...
     包解析接口仅用于应用市场对打好的HAP、HSP、App等包进行解析，获取其中配置文件等信息。
                  ...
                  #### [h2]接口目录
                        ...
                        | 类名          | 接口原型          | 类型          | 接口详细描述         
                               | UncompressEntrance          | UncompressResult parseApp(String appPath, ParseAppMode parseMode, String hapName)          | Java接口                    接口功能：根据参数解析app包的pack.info信息。
          ...
          返回值：UncompressResult。
                 ...
                 | UncompressEntrance          | UncompressResult parseApp(InputStream input, ParseAppMode parseMode, String hapName)          | Java接口                    接口功能：根据参数解析app包的pack.info信息。
          ...
          返回值：UncompressResult。
                 ...
                 | UncompressEntrance          | UncompressResult parseHap(String hapPath)          | Java接口                    接口功能：根据参数解析app包的json配置文件。
          ...
          返回值：UncompressResult。
                 ...
                 | UncompressEntrance          | UncompressResult parseHap(InputStream input)          | Java接口                    接口功能：根据参数解析app包的json配置文件。
         ...
         | NA         
                 ...
                 | providerAbility          | String                    卡片的提供方所在的Ability或者extension名称。
