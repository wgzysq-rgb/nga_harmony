...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `edm-tool`  |  **DocID**: `80a9b3ebf61943a7b8eb6d54cc688bf7`  |  **NodeID**: `0002017757958527169981dc3c874afd`
...
| 命令  | 描述  
 ...
 | enable-admin  | 激活命令，用于激活企业设备管理拓展能力，目标组件必须为[enterpriseAdmin类型的ExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/mdm-kit-admin)。  
...
| 参数  | 参数说明  
 ...
 | -t/--admin-type  可选参数，adminType。

 取值如下：

 super - 表示激活为超级设备管理应用。

 byod - 表示激活为BYOD（自带设备办公）设备管理应用。
 ...
 **处理步骤**
 ...
 请补充-a <ability-name>。
   ...
   #### [h2]9200003 error: the administrator ability component is invalid
 ...
 **处理步骤**
 ...
 查询应用的bundleName和enterpriseAdmin类型的ExtensionAbility的abilityName，并将其传入到参数中。
   ...
   #### [h2]9200004 error: failed to enable the administrator application of the device
 ...
 **处理步骤**
 ...
 2、请使用未被管控的设备进行调试。
   ...
   #### [h2]9200005 error: failed to disable the administrator application of the device
