...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `uinput`  |  **DocID**: `1b131daf6f8242c89c47b95fcc279fcc`  |  **NodeID**: `000201775795852716029e5f2190af38`
...
# uinput
     ...
     **用法**
     ...
     uinput <option> <command> <arg> ...     **支持能力**
                 ...
                 | enable_key_status          | enable_key_status          | [控制注入的修饰键状态](#控制注入的修饰键状态)。         
                              ...
                              命令中与坐标相关的参数，单位均为[px(屏幕物理像素单位)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-pixel-units)。
...
```
     ...
     模拟鼠标抬起按键，建议与鼠标按键按下事件搭配使��，确保事件闭环。buttonId：[鼠标按键](#鼠标按键)。
