...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `devicedebug-tool`  |  **DocID**: `d9a757b874c94a588b21bfa966759b21`  |  **NodeID**: `00020177579585271622138f6f6cce6c`
...
devicedebug kill 用于向debug类型的应用进程发送signal（1-64）信号，应用进程接收到信号后终止对应pid进程。
