...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `binary-sign-tool`  |  **DocID**: `65e7f58417ad4ce6886898adc9a39cf4`  |  **NodeID**: `00020177579585271603189873e9d1bf`
...
支持运行在Linux平台的工具：下载最新的[Command Line Tools](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/command-line-tools-overview)，可以在SDK库openHarmony/toolchains/lib中找到，文件名为binary-sign-tool。
...
- 粘贴命令时，多粘贴了一段内容，导致出现COMMAND_PARAM_ERROR错误。
- 填写命令时，如果最后一个参数的value值未填写，将导致COMMAND_PARAM_ERROR错误。

 **处理步骤**

 检查并修正命令中的多余或错误部分。

   #### [h2]KEY_PASSWORD_ERROR
