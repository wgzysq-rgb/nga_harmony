...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `scan-development-guide`  |  **DocID**: `52675df48f954cb6b3ff6fd669454f3d`  |  **NodeID**: `00020177579585271627661e869c5f3f`
...
```
     ...
     触发场景描述：
      ...
      - 设备亮屏且与Wi-Fi未连接：静止场景扫描周期从20s开始倍增，最大300s；非静止场景扫描周期从20s开始，最大160s。
     ...
     以下是一些常见的管控方式和应用场景：
      ...
      - 扫描结果获取真实bssid，需要申请ohos.permission.GET_WIFI_PEERS_MAC权限。
