...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `p2p-development-guide`  |  **DocID**: `753990f5e972420fa5869fbe35bfba36`  |  **NodeID**: `000201775795852716166352fdbf0035`
...
# P2P模式开发指南
     ...
     具体接口说明如下表。
       ...
       import { wifiManager } from '@kit.ConnectivityKit';             开启设备的Wi-Fi。
...
```
             错误码请参见[WIFI错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wifi)。
...
```
      ...
      - 开启设备的Wi-Fi。
      - 需要SystemCapability.Communication.WiFi.P2P系统能力。
      - 通过[wifiP2pLinkedInfo.connectState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#p2pconnectstate)获取P2P连接状态，确保连接状态为CONNECTED。
      - 通过[wifiP2pGroupInfo.goIpAddress](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifip2pgroupinfo)获取群组IP地址，以便Socket通信。
      - Socket通信请参考[使用Socket访问网络](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/socket-connection)。
