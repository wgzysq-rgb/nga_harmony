...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `br-pair-device-development-guide`  |  **DocID**: `314de8458e02496e8c2876bb11f73e99`  |  **NodeID**: `00020177579585271642540873d96516`
...
```
     ...
     通过订阅配对状态变化事件，可以获取实时的配对状态。在整个配对过程中，涉及多种状态的跃迁，其中[BOND_STATE_BONDED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-connection#bondstate)表示已配对。
...
```
     ...
     若目标设备的配对状态是[BOND_STATE_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-connection#bondstate)，则可以主动配对目标设备。
