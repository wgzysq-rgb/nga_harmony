...
> **分区**: Guides  |  **Slug**: `networkboost-netmultipath-recommendcallback-c`  |  **DocID**: `39b01822281b4aa08be31c1706db346c`  |  **NodeID**: `0002017768400160616255295a4e975a`
...
```
       ...
       libnetwork_boost.so             调用HMS_NetworkBoost_RegisterMultiPathRecommendationCallback接口，获取多网建议变化信息。
