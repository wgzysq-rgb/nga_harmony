...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-netmultipath-statechangecallback`  |  **DocID**: `45797b95cecf49a18463a3e100ec0cfd`  |  **NodeID**: `0002017757958527162284e71836f058`
...
# 多网状态监听
     ...
     具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/networkboost-nethandover#nethandoveronmultipathstatechange)。
