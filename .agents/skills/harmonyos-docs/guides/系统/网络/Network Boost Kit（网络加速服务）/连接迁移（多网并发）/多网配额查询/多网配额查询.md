...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-netmultipath-getmultipathquota`  |  **DocID**: `6f6de936f1744788bde3ca235d995e86`  |  **NodeID**: `000201775795852716296984303fd2ad`
...
# 多网配额查询
     ...
     具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/networkboost-nethandover#nethandovergetmultipathquotastats)。
