...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-preparations`  |  **DocID**: `e604fad64faf4ca4a99ab857a6554706`  |  **NodeID**: `000201775795852716893d489ac5a07a`
...
[申请调试Profile](https://developer.huawei.com/consumer/cn/doc/app/agc-help-add-debugprofile-0000001914423102)和[发布Profile文件](https://developer.huawei.com/consumer/cn/doc/app/agc-help-add-releaseprofile-0000001914714796)中第4步“申请权限”是必须的，选中“受限ACL权限”后再点击“选择”。
  ...
  选择权限后点击“添加”生成新的Profile文件，下载后按[手动签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-signing#section297715173233)替换profile文件。
