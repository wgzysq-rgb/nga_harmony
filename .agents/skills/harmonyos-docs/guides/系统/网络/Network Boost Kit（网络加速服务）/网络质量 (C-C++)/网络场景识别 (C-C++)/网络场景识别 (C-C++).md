...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-scenecallback-c`  |  **DocID**: `9bd42c03ad4342cf9a662aec654af290`  |  **NodeID**: `0002017757958527161738002db8ee9e`
...
```
       ...
       libnetwork_boost.so             通过注册回调的方式监听网络场景识别信息。
