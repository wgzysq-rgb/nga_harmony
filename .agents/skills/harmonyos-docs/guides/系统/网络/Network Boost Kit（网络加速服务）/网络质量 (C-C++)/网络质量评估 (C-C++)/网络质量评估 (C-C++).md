...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-qoscallback-c`  |  **DocID**: `8fa483664bae4d749885c1d6ec9009c2`  |  **NodeID**: `00020177579585271611786d6689767d`
...
```
       ...
       libnetwork_boost.so             通过注册回调的方式监听网络质量评估信息。
