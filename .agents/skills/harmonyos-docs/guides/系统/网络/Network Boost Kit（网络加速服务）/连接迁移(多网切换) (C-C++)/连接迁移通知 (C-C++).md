...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-nethandovercallback-c`  |  **DocID**: `f6a317ddcb8948f3b8a169ead5f1f14d`  |  **NodeID**: `0002017757958527160794877bd1528a`
...
```
       ...
       libnetwork_boost.so             通过注册回调的方式获取连接迁移信息。
