...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-appreportqoe`  |  **DocID**: `e07ad4ed305a45c68331653bf108cfd0`  |  **NodeID**: `00020177579585271623351eefbe5720`
...
# 应用传输体验反馈
     ...
     具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/networkboost-netquality#netqualityreportqoe)。
