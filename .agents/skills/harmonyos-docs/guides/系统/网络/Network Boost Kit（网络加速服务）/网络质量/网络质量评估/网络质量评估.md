...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `networkboost-qoscallback`  |  **DocID**: `fa4f85557e5e4fec95ce0daeb7fefe07`  |  **NodeID**: `0002017757958527160637dfd771a4f7`
...
# 网络质量评估
     ...
     具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/networkboost-netquality#netqualityon-netqoschange)。
