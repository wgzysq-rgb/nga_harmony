...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `telephony-call`  |  **DocID**: `f1fbe75f2a76472ea2c46967605755f5`  |  **NodeID**: `000201775795852716892c830cbac49f`
     ...
     开发者可以通过以下方式实现拨打电话的功能：
      ...
      - 设备需插入可用的SIM卡。
                  ...
                  #### 接口说明
                        ...
                        | 接口名          | 描述         
                               | hasVoiceCapability(): boolean;                    判断是否具有语音功能，默认false。
