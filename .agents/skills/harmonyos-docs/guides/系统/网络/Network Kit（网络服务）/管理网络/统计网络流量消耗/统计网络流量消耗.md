...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `net-statistics`  |  **DocID**: `87ac9a7e8e5e4c7b8320aaacc72c2b3a`  |  **NodeID**: `000201775795852716095306332ecd0f`
...
# 统计网络流量消耗
     ...
     流量管理主要实现功能有：
      ...
      - 支持基于网卡/UID 的流量变化订阅。
             ...
             导入[statistics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-net-statistics)、[socket](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-socket)以及错误码模块。
