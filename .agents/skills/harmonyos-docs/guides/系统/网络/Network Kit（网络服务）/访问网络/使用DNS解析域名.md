...
> **分区**: Guides  |  **Slug**: `net-dns`  |  **DocID**: `f74cad597f944c109e2fab485337128c`  |  **NodeID**: `00020177684001606174087b4ccc4730`
...
```
       ...
       this.getAddressName(false);             将中文域名转换为对应ASCII编码后获取对应IP。

       this.getAddressName(true);             将转换后的ASCII编码转成原中文域名。
...
```
       ...
       @State hostName: string = 'www.example.com';             使用当前默认网络解析主机名以获取所有IP地址。
