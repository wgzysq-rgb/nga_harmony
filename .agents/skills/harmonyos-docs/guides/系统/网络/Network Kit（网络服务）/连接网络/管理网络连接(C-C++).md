...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-netmanager-guidelines`  |  **DocID**: `461cfe6839bb47ffbb9b84ed5f7bb336`  |  **NodeID**: `000201775795852716146e9a8ed4e975`
...
# 管理网络连接(C/C++)
     ...
     NetConnection常用接口如下表所示，详细的接口说明请参考[net_connection.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-h)。
          ...
          **替代：** 推荐使用OH_NetConn_RegisterDnsResolver。
                 ...
                 | OHOS_NetConn_UnregisterDnsResolver(void)                    取消注册自定义DNS解析器。
