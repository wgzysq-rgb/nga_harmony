...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `linkenhance_development-guide`  |  **DocID**: `1202c463dce04196aa48d7acab8429df`  |  **NodeID**: `000201775795852716138bf1ed70125f`
...
# 增强连接开发指导
     ...
     打开客户端和服务端设备的蓝牙开关。
      ...
      - 在PC上安装[DevEco Studio](https://developer.huawei.com/consumer/cn/download/deveco-studio)，版本要求在4.1及以上。
      - 将public-SDK更新到API 20或以上。
...
```
      创建connection对象，订阅连接结果通知变化的事件，连接服务端。       ```
const TAG = "testDemo";
// client端主动连接时调用
