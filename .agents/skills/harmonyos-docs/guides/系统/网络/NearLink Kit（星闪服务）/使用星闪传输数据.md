...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `nearlink-start-data-transfer`  |  **DocID**: `a49295f507ca477d807fde5609ef1835`  |  **NodeID**: `0002017757958527169971cfece3da47`
...
# 使用星闪传输数据
     ...
     星闪设备间已建立起逻辑链路基础上，支持应用基于Nearlink技术进行设备间的数据传输。
                 ...
                 数据传输通道不保证链路加密。如需加密数传，需先进行配对流程，通过[startPairing](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-remote-device#startpairing)接口发起。

                 链路是否加密可通过[getAcbState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-remote-device#getacbstate)接口查询，ENCRYPTED状态表示链路已加密。
