...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `remote-communication-netcancle-arkts`  |  **DocID**: `9e1dfc0979d74dbd896b52a6652702f6`  |  **NodeID**: `000201775795852716404f34943b9d56`
...
# 取消网络请求（ArkTS）
     ...
     具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-rcp#cancel)。
                        ...
                        | 接口名          | 描述         
                               | cancel(requestToCancel?: [Request](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-rcp#request)| [Request](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-rcp#request)[]): void                    - 取消指定网络请求：传入需要取消的请求，返回值为空。
