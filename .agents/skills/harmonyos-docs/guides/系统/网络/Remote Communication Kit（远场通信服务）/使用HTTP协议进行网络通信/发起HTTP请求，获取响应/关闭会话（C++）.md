...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `remote-communication-netclose-c`  |  **DocID**: `22d8d47d85184d65b97134cc16addf21`  |  **NodeID**: `000201775795852716494d118fa6115f`
...
```
       ...
       librcp_c.so             创建会话，会话发起请求后关闭会话。“http://www.example.com”请根据实际情况替换为想要请求的URL地址。等待响应返回后，销毁request并关闭session。
