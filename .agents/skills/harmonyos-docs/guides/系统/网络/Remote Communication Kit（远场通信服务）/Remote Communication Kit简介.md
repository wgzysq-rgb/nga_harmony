...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `remote-communication-introduction`  |  **DocID**: `11468b866f94438ba2f006fb32e770ea`  |  **NodeID**: `0002017757958527168623205f4aec9c`
...
HTTP请求能力。Remote Communication Kit构建了一种场景化HTTP通信能力。和Network Kit提供的标准HTTP能力不同的是，Remote Communication Kit构建了场景化API，强调易用性，详见[支持的HTTP网络请求场景](#支持的http网络请求场景)。开发者可根据需要选择合适的Kit。
