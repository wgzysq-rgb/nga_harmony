...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `intents-local-rec-access-programme`  |  **DocID**: `b7927ceb69c146f39eb15b1329e754e9`  |  **NodeID**: `0002017757954498003382504d11f285`
...
继承InsightIntentExecutor；
  ...
  通过意图名称，识别查看旅游攻略意图(ViewTravelGuides)，在对应的方法中传递意图参数（param），并拉起对应落地页（点击推荐卡片跳转的界面，如旅游攻略落地页）。
