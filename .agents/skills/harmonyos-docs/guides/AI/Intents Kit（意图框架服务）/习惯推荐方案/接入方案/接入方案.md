...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `intents-habit-rec-access-programme`  |  **DocID**: `b48a836c4c9e49659a7103a2c765aeb7`  |  **NodeID**: `000201775795449800346b2d78ce71d4`
...
```
     ...
     构建意图对象，并且调用[shareIntent()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-arkts-api-insightintent#insightintentshareintent-1)，实现意图共享。可同时构建多个PlayMusic或PlayMusicList的意图对象。
