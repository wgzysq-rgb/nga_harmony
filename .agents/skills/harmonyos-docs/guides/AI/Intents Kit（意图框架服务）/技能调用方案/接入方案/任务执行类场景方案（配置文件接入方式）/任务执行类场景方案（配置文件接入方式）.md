...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `intents-skill-all-rec-configuration`  |  **DocID**: `dca7e07a4be84b7c93b3a8069753fc98`  |  **NodeID**: `000201775795449800372f254eaaaf03`
...
继承InsightIntentExecutor。
  ...
  通过意图名称，识别查看旅游攻略意图（ViewTravelGuides），在对应的方法中传递意图参数（param），并拉起对应落地页（点击推荐卡片跳转的界面，如旅游攻略页面）。
