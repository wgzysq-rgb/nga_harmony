...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `intents-skill-all-rec-content-search`  |  **DocID**: `c8f5d334699e4743928628b71d781d60`  |  **NodeID**: `000201775795449800373560ea4515ba`
...
```
     ...
     构建意图对象，并且调用[insightIntent.shareIntent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-arkts-api-insightintent#insightintentshareintent-1)，实现意图共享。可同时构建多个PlayMusic或PlayMusicList的意图对象。
