...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `intents-event-rec-access-programme`  |  **DocID**: `7a4361a1e428498aadd1bb1d2de4771c`  |  **NodeID**: `0002017757954498003426fd5008e945`
...
```
                  #### 获取SID
                         ...
                         API文档参见：[意图框架API参考 > getSid](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-arkts-api-insightintent#insightintentgetsid)。
