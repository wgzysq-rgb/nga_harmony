...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `vision-documentscanner`  |  **DocID**: `6eeba4a6facb48f08ba0fa8ce8c84e14`  |  **NodeID**: `000201775795449800285e8c2a9e3a1d`
...
# 文档扫描
     ...
     **图1** 文档扫描示意图
     ...
     以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-document-scanner)。
                        ...
                        | 接口名          | 描述         
                               | [DocumentScanner](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-document-scanner#documentscanner)          | 文档扫描控件         
                 | [DocumentScannerResultCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-document-scanner#documentscannerresultcallback)          | 文档扫描结果         
