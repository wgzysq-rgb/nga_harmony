...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `vision-cardrecognition`  |  **DocID**: `ef38c866bece42248bdad75f1d11aaa5`  |  **NodeID**: `000201775795449800274aa7b4ed4a62`
...
# 卡证识别
     ...
     **图1** 银行卡识别示意图
     ...
     以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-card-recognition)。
       ...
       import { CardRecognition, CardRecognitionResult, CardType, CardSide, CardRecognitionConfig, ShootingMode, CardContentConfig, BankCardConfig } from "@kit.VisionKit";             配置页面的布局，选择需要识别的卡证类型和需要识别的卡证页面，配置对应设置项，在回调中获取结果返回值。
