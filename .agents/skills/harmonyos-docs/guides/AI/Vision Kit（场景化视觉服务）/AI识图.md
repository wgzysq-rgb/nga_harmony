...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `vision-imageanalyzer`  |  **DocID**: `04d6608e107848bf92654cefc406a098`  |  **NodeID**: `0002017757954498002885449fcd4257`
...
```
             初始化[VisionImageAnalyzerController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-image-analyzer#visionimageanalyzercontroller)对象。
...
```
             绑定[VisionImageAnalyzerController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-image-analyzer#visionimageanalyzercontroller)对象，可以控制识图相关的交互。
