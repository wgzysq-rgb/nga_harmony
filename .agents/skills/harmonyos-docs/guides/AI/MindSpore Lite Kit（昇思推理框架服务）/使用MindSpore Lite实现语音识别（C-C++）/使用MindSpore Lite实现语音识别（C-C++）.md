...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `mindspore-asr-based-native`  |  **DocID**: `3a51888700594d8d930badb87f1a4c43`  |  **NodeID**: `00020177579544980029488a2c36f7a5`
...
```
       ...
       export const runDemo: (a: Object) => string;             在 oh-package.json5 文件，将API与so相关联，成为一个完整的ArkTS模块：
