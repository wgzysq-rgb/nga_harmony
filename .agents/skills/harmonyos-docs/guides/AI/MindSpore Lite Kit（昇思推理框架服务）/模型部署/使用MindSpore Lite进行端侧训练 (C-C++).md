...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `mindspore-lite-train-guidelines`  |  **DocID**: `aa8008ed50fe4626bb4d05523a31aec9`  |  **NodeID**: `000201775795449800329c928fdffcdf`
...
# 使用MindSpore Lite进行端侧训练 (C/C++)
     ...
     此处给出使用MindSpore Lite进行模型训练相关的部分接口，具体请见下方表格。更多接口及详细内容，请见[MindSpore](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-mindspore)。
...
```
       ...
       ./train_demo ./lenet_train.ms export_train_model export_infer_model       得到如下输出：
