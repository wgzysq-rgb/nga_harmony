...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `mindspore-guidelines-based-native`  |  **DocID**: `40a7f60af5414004b3e49ab6a7e8bbea`  |  **NodeID**: `000201775795449800289edb36154669`
...
```
       ...
       export const runDemo: (a: number[], b:Object) => Array<number>;             在 oh-package.json5 文件，将API与so相关联，成为一个完整的ArkTS模块：
