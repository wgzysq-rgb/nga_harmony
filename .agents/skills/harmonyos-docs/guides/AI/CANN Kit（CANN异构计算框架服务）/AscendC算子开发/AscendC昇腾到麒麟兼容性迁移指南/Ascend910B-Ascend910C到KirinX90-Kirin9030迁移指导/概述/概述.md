...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-migration-guidance-overview`  |  **DocID**: `08df0ad9ff8a452f854118956e11587f`  |  **NodeID**: `00020177579544980040773b67542a88`

---

# 概述

 Ascend910B/Ascend910C和KirinX90/Kirin9030之间的ASC API详细能力差异，见[《Ascend C算子接口》](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-ascend-c-apis)。本节当前重点描述主要的差异和兼容适配方案，其它情况可类比参考。
...
| 处理器型号  | NPU_ARCH  
 ...
 | Kirin9030  | 3113  
  ...
  由于AI处理器架构版本区别，Ascend910B/Ascend910C和KirinX90/Kirin9030 主要差异请参见下表。具体影响的API，详见[基础API迁移指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-basic-l2cache)和[高阶API迁移指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-adv-api)。
