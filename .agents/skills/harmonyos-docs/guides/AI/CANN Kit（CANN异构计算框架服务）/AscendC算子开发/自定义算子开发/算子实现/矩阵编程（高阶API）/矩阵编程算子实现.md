...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-matrix-programming-operator`  |  **DocID**: `0cb6f05e8341482189618d40a1bde9e7`  |  **NodeID**: `000201775795449800477eac57a2eced`
...
```
  ...
  cubeTiling.SetBufferSpace(-1, -1, -1);  按需设置其他参数，比如设置bias参与计算。

  cubeTiling.SetBias(true);  获取Tiling参数。
...
```
  ...
  mm.Init(&tiling.cubeTilingData, &pipe); // 初始化  设置左矩阵A、右矩阵B、Bias。
