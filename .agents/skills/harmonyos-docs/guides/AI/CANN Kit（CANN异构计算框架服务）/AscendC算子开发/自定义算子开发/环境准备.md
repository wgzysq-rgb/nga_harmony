...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-environment-preparation`  |  **DocID**: `b24c1dc35b8d46b9a20cafba1cb6a6cd`  |  **NodeID**: `0002017757954498003718add3873ae1`
...
```
  ...
  source  /usr/local/ddk/tools/tools_ascendc/set_ascendc_env.sh  python软件依赖，执行步骤3的安装脚本install.sh时会自动安装。若执行ascendebug时提示无对应模块，可执行下表中的命令手动安装。
