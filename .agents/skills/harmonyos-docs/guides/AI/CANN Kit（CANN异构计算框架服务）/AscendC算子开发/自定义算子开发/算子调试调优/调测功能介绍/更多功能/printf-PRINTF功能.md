...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-commissioning-function-printf`  |  **DocID**: `ef5f8d8d284f4ca490ee55069f46165f`  |  **NodeID**: `000201775795449800618179eef451a9`
...
```
  ...
  ascendebug kernel --backend simulator --dump-mode normal ... {其他simulator调测参数}  --dump-mode取normal，开启通用打印Scalar模式，其他参数参考[NPU调测参数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-cli-parameters#npu调测参数)按需配置。
