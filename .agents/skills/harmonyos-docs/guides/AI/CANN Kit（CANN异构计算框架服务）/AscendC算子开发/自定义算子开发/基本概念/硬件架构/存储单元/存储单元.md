...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-storage-unit`  |  **DocID**: `7b4c1dd63c2a4376bcf88b9b1fb014ea`  |  **NodeID**: `000201775795449800484b3c3864fa80`
...
| 搬运单元  | 描述  
 ...
 | FixPipe  只有分离架构支持，负责如下通路的数据搬运，搬运过程中可以完成随路数据格式/类型转换：
