...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-double-buffer`  |  **DocID**: `d411cf5544f94fc2ae752997b42e68c8`  |  **NodeID**: `0002017757954498004127dad8b23c2a`
 ...
 **图1** 数据搬运与Vector计算过程
 ...
 pipe.InitBuffer(inQueueX, 2, 256); **图2** double buffer机制
