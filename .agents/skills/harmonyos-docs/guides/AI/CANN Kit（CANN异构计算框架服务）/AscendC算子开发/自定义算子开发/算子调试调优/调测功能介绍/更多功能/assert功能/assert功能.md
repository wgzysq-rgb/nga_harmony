...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-commissioning-function-assert`  |  **DocID**: `16adea1f76d2452abee75fad7ba2a56b`  |  **NodeID**: `000201775795449800744a39f12aa56b`
...
```
  ...
  ascendebug kernel --backend simulator --dump-mode normal ... {其他simulator调测参数}  --dump-mode取normal，开启通用打印Scalar模式，其他参数参考[NPU调测参数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-cli-parameters#npu调测参数)根据需要进行配置。
