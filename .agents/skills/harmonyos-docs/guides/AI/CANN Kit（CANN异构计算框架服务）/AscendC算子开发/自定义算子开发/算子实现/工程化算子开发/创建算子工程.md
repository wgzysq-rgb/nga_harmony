...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-creating-an-operator-project`  |  **DocID**: `32d2366939214d5c9726361a65eae5b3`  |  **NodeID**: `000201775795449800465140dc3234bc`
 ...
 **简要说明：**
 ...
 source ddk/tools/tools_ascendc/set_ascendc_env.sh 使用msOpGen工具创建算子开发工程的步骤如下。
...
```
  使用msOpGen工具生成算子的开发工程。以生成AddCustom的算子工程为例，下文仅针对关键参数进行解释，详细参数说明请参见[算子工程创建工具参数说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-creating-operator-project-msopgen)。
