...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-operator-prototype-definition`  |  **DocID**: `db35ff334b5443a2a83188f705a1a5df`  |  **NodeID**: `000201775795449800612aabacfe0e73`
...
| 原型定义  | 参数  | 具体描述  
  | Input/Output  | ParamType  参数类型，Option取值为：OPTIONAL（可选）、REQUIRED（必选）、DYNAMIC（动态输入）。
...
| 原型定义  | 注册方式  | 具体描述  
 ...
 | Attr  | Bool/Float/Int...  | 设置算子属性数据类型为Bool/Float/Int...。具体说明请参考[OpAttrDef](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-opattrdef)。  
