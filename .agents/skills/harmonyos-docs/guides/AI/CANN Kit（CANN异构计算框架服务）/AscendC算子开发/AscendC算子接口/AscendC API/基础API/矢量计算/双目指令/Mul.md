...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-binocular-mul`  |  **DocID**: `c48e00068f0748d582ad74b33955d9ed`  |  **NodeID**: `0002017757954498011236d1001b1461`
...
| 参数名  | 输入/输出  | 描述  
 ...
 前n个tensor：int16_t、int32_t、half、float32_t
...
本样例中只展示Compute流程中的部分代码。如果开发者需要运行样例代码，请将该代码段拷贝并替换双目指令样例模板[更多样例](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkitvectorcalculation-binocularinstructions)中的Compute函数即可。
 ...
 AscendC::Mul(dstLocal, src0Local, src1Local, 512); 结果示例如下。
