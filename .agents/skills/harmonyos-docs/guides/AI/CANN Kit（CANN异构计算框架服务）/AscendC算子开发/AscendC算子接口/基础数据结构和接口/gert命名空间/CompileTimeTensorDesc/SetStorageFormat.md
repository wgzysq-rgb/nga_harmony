...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-compiletimetensordesc-setstorageformat`  |  **DocID**: `631a5978bdac4a6c843c944987829fc6`  |  **NodeID**: `000201775795449800877fc32d813881`
...
| 参数  | 输入/输出  | 说明  
  | format  | 输入  需要设置的运行时数据排布格式信息。

 关于ge::Format的定义，请参见[Format](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-ge-format)。
