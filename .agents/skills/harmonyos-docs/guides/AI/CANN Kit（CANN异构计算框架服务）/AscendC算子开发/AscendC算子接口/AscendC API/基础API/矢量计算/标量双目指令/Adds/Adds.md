...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-scalar-binocular-adds`  |  **DocID**: `ee8c119f617d4aada5b253c8b85acf17`  |  **NodeID**: `00020177579544980109154a233f17a9`
...
| **参数名称**  | **类型**  | **说明**  
 ...
 Kirin9020训练系列产品，支持的数据类型为：Tensor（int16_t/int32_t/half/float）

 KirinX90系列处理器,支持的数据类型为：Tensor（int16_t/int32_t/half/float）
