...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-not`  |  **DocID**: `7da55d2879fe43f88921b79f6096da04`  |  **NodeID**: `000201775795449801159888c4c1a0f9`
...
本样例中只展示Compute流程中的部分代码。本样例的srcLocal和dstLocal均为int16_t类型，占16位bit。
 ...
 AscendC::Not(dstLocal, srcLocal, 512); 结果示例如下。
