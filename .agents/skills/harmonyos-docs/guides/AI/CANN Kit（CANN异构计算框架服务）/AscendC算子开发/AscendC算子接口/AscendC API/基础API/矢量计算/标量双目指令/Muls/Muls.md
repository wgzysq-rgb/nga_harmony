...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-scalar-binocular-muls`  |  **DocID**: `bc7ed7b7289343689a774e05a39de918`  |  **NodeID**: `0002017757954498010946f1ce529380`
...
| **参数名称**  | **类型**  | **说明**  
 ...
 前n个tensor、mask连续模式支持：int16_t、int32_t、half、float32_t
