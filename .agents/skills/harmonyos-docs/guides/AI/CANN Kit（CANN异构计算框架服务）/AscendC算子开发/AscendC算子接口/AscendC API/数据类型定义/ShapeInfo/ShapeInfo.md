...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-shapeinfo`  |  **DocID**: `b344b8aed062425d89f6bc9b29f42ed4`  |  **NodeID**: `000201775795449800490736151ef916`
...
| 参数名称  | 类型  | 描述  
 ...
 | dataFormat  | DataFormat  数据排布格式。NCHW 取值为 0，NHWC取值为1。
