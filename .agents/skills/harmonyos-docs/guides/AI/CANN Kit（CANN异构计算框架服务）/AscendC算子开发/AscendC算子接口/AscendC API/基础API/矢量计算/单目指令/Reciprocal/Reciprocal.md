...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-reciprocal`  |  **DocID**: `b0a6d6b126e545caa3b8f2962711cba6`  |  **NodeID**: `000201775795449801129750e075bd3d`
...
本样例中只展示Compute流程中的部分代码。本样例的srcLocal和dstLocal均为half类型，占16位bit。
 ...
 AscendC::Reciprocal(dstLocal, srcLocal, 512); 结果示例如下。
