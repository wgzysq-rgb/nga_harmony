...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-exp`  |  **DocID**: `a27f686a3cec49528c17c58e3b8d2f8e`  |  **NodeID**: `0002017757954498010935601f2fc257`
...
本样例中只展示Compute流程中的部分代码。本样例的srcLocal和dstLocal均为half类型，占16位bit。
 ...
 AscendC::Exp(dstLocal, srcLocal, 512); 结果示例如下。
