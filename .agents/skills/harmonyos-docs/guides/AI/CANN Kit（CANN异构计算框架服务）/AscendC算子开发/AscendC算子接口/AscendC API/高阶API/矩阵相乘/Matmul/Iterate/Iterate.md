...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-iterate`  |  **DocID**: `3240db5474aa43778897d38852b7f3f8`  |  **NodeID**: `000201775795449801160c7a29dc3e3c`
...
| 参数名  | 描述  
  | sync  | 迭代获取C矩阵分片的过程分为同步和异步两种模式。通过该参数设置同步或者异步模式：同步模式设置为true，异步模式设置为false。默认为同步模式，具体模式的介绍和使用方法请参考[GetTensorC](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-gettensorc)。  
