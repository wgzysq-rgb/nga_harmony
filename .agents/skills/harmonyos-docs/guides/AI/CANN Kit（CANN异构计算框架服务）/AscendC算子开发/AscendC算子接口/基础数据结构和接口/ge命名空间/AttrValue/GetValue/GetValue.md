...
> **分区**: Guides  |  **Slug**: `cannkit-getvalue`  |  **DocID**: `bafca028f3eb4bdda75908305999aedc`
...
```
 ...
 参数名 输入/输出 描述   val 输出 DT类型的参数。       #### 返回值

 类型 描述   graphStatus 数据类型转换成功，返回GRAPH_SUCCESS， 否则，返回GRAPH_FAILED。       #### 异常处理
