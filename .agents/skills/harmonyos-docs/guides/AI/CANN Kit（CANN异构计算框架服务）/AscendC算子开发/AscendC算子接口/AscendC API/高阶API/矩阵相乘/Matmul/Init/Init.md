...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-matmul-init`  |  **DocID**: `237c84d9d859405db3af9012dceaec52`  |  **NodeID**: `0002017757954498011333d066b88516`
...
| 参数名  | 输入/输出  | 描述  
  | cubeTiling  | 输入  Matmul tiling参数，TCubeTiling结构体定义请参见[TCubeTiling结构体](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-tcubetiling-structure)表1。
