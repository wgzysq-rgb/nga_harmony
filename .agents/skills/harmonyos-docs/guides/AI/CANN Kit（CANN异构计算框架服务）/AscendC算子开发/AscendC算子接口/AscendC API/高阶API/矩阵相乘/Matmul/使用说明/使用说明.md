...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-matmul-usage-description`  |  **DocID**: `fe6c5bcf3a074c3396760c098df93d9b`  |  **NodeID**: `000201775795449801084961ed1dda34`
...
| 参数  | 说明  
 ...
 NONE：默认值，表示不使用BatchMatmul，其他选项表示使用BatchMatmul。
  ...
  REGIST_MATMUL_OBJ(&pipe, GetSysWorkSpacePtr(), mm, &tiling);  设置左矩阵A、右矩阵B、Bias。
