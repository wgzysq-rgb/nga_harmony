...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-automappingfndynamic`  |  **DocID**: `2462dbd3f2e74fb89f554c3096414c34`  |  **NodeID**: `00020177579544980105317a9c77a047`
...
| 参数  | 输入/输出  | 说明  
 ...
 | op  | 输入  | 适配AI处理器的算子。  
 | dynamic_name_attr_value  | 输入  描述动态输入输出实际个数，key表示动态端口是输入还是输出，key的取值：
