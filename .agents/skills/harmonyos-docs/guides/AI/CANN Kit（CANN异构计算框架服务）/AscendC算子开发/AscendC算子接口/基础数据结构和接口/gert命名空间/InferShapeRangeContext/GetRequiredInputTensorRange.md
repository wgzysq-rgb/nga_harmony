...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-getrequiredinputtensorrange`  |  **DocID**: `43602c4aac0c4d59982a062bbb5cba4e`  |  **NodeID**: `000201775795449800886e1c69b7fecf`
...
TensorRange类型指针，定义如下。
 ...
 using TensorRange = Range<Tensor>; ir_index非法时，返回空指针。
