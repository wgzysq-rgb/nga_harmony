...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-scalar-binocular-shiftright`  |  **DocID**: `18ed8efc627c447d9b9659e424793d3e`  |  **NodeID**: `000201775795449801146aa545f52d3b`
...
| **参数名称**  | **类型**  | **说明**  
 ...
 前n个tensor、mask连续模式支持：uint16_t、int16_t、uint32_t、int32_t
