...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-releaseeventid`  |  **DocID**: `16578bec4fd04b0f8256a7b28f540032`  |  **NodeID**: `000201775795449801154d6bc9e6bfc9`
...
| 参数名称  | 输入/输出  | 含义  
  | id  | 输入  | TEventID类型，调用[AllocEventID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-alloceventid)申请获得的TEventID。  
