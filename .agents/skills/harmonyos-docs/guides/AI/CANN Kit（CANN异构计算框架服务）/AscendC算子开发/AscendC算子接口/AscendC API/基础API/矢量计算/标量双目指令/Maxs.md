...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-scalar-binocular-maxs`  |  **DocID**: `93686b1625d4419687aefca074307a22`  |  **NodeID**: `000201775795449801117bff6d552b40`
...
| **参数名称**  | **类型**  | **说明**  
 ...
 Kirin9020系列处理器，支持的数据类型为：Tensor（int16_t/int32_t/half/float）。
