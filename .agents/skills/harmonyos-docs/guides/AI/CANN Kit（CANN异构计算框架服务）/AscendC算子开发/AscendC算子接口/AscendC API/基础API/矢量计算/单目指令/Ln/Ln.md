...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-lnln`  |  **DocID**: `24d5866d0a39428eb747ada43457a6e4`  |  **NodeID**: `0002017757954498010963ed2a006471`
...
本样例中只展示Compute流程中的部分代码。本样例的srcLocal和dstLocal均为half类型，占16位bit。
 ...
 AscendC::Ln(dstLocal, srcLocal, 512); 结果示例如下。
