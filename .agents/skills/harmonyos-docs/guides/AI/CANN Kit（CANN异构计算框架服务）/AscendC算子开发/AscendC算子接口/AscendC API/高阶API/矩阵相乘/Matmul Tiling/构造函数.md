...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-matmul-tiling-constructor`  |  **DocID**: `1679f86cadb3415d9c21bb8175fdbadb`  |  **NodeID**: `000201775795449801097d7e0ffec001`
...
| 参数名  | 输入/输出  | 描述  
 ...
 | platform  | 输入  传入硬件版本以及AI Core中各个硬件单元提供的内存大小。PlatformInfo构造时通过[PlatformAscendC类简介](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-platformascendc-introduction)获取。
