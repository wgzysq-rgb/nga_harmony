...
> **分区**: Guides  |  **Slug**: `cannkit-updatedynamicoutputdesc`  |  **DocID**: `7a45df00a75f474290375b6f03593285`
...
```
 ...
 参数名 输入/输出 描述   name 输入 算子动态Output的名称。  index 输入 算子动态Output编号。  tensor_desc 输入 TensorDesc对象。       #### 返回值

 类型 描述   graphStatus 更新动态Output成功，返回GRAPH_SUCCESS， 否则，返回GRAPH_FAILED。       #### 异常处理
