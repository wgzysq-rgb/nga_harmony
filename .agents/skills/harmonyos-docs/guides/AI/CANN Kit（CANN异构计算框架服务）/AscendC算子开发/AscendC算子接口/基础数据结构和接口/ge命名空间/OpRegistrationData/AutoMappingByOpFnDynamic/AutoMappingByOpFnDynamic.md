...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-automappingbyopfndynamic`  |  **DocID**: `6b416854fa37492eb0c2216234158e0d`  |  **NodeID**: `000201775795449801056c783162e614`
...
| 参数  | 输入/输出  | 说明  
 ...
 | dynamic_name_attr_value  | 输入  | 描述动态输入输出实际个数，**DynamicInputOutputInfo**数据结构请参见[DynamicInputOutputInfo数据结构说明](#dynamicinputoutputinfo数据结构说明)。  
