...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-tpipe-initbufpool`  |  **DocID**: `462895c8d42345b78234edb25152cccf`  |  **NodeID**: `0002017757954498011758e73c232f94`
...
TPipe::InitBufPool的重载接口指定与其他TBufPool子资源池复用。
 ...
 关于TBufPool的具体介绍及资源划分图示请参考[TBufPool](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-tbufpool-overview)。
...
新划分的资源池与被复用资源池的硬件属性需要一致，两者共享起始地址及长度。
  ...
  其他泛用约束参考[TBufPool](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-tbufpool-overview)。
