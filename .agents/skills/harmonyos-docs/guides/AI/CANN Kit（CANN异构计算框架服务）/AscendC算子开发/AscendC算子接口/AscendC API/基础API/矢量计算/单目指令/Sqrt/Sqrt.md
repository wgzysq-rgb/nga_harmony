...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-sqrt`  |  **DocID**: `90c4d3c832ec47a3868282b56f1d4d12`  |  **NodeID**: `000201775795449801142ae92a90f228`
...
本样例中只展示Compute流程中的部分代码。本样例的srcLocal和dstLocal均为half类型，占16位bit。
 ...
 AscendC::Sqrt(dstLocal, srcLocal, 512); 结果示例如下。
