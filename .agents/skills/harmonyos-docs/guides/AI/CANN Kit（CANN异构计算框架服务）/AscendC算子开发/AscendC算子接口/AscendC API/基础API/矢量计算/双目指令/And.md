...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-binocular-and`  |  **DocID**: `65b5a740363a451294b7b2c362c166a9`  |  **NodeID**: `0002017757954498011572ad59da3b9b`
...
本样例中只展示Compute流程中的部分代码。如果开发者需要运行样例代码，请将该代码段拷贝并替换双目指令样例模板[更多样例](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkitvectorcalculation-binocularinstructions)中的Compute函数即可。
 ...
 AscendC::And(dstLocal, src0Local, src1Local, 512); 结果示例如下。
