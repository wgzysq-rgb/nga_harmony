...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-calctschblockdim`  |  **DocID**: `17b4ba3ce4824aebbce3787bca9e3e86`  |  **NodeID**: `0002017757954498008130e11f188832`
...
| 参数  | 输入/输出  | 说明  
  | sliceNum  | 输入  | 数据切分的份数。  
 | aicCoreNum  | 输入  | 如果算子实现使用了矩阵计算API，请传入[GetCoreNumAic](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-getcorenumaic)返回的数量，否则传入0。  
 | aivCoreNum  | 输入  | 如果算子实现使用了矢量计算API，请传入[GetCoreNumAiv](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-getcorenumaiv)返回的数量，否则传入0。  
