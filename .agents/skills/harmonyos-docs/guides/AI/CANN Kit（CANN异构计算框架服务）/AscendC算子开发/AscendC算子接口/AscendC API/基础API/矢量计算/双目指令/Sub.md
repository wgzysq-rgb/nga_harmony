...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-cannkit-sub`  |  **DocID**: `2a51a5316542402ea8892f869236d577`  |  **NodeID**: `00020177579544980111179ce1310c5c`
...
| 参数名  | 输入/输出  | 描述  
 ...
 Kirin9020系列处理器支持的数据类型为：half/int16_t/float/int32_t

 KirinX90系列处理器支持的数据类型为：half/int16_t/float/int32_t
...
本样例中只展示Compute流程中的部分代码。如果开发者需要运行样例代码，请将该代码段拷贝并替换双目指令样例模板[更多样例](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkitvectorcalculation-binocularinstructions)中的Compute函数即可。
 ...
 AscendC::Sub(dstLocal, src0Local, src1Local, 512); 结果示例如下。
