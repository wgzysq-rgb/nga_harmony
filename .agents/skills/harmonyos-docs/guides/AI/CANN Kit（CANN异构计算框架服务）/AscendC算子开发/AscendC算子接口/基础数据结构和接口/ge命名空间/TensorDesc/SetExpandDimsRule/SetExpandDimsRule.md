...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-setexpanddimsrule`  |  **DocID**: `44bca0880861448eb7297e9c871722cf`  |  **NodeID**: `000201775795449800990eae89b42b0f`
...
| 参数名  | 输入/输出  | 描述  
  | expand_dims_rule  | 输入  需设置的补维规则。AscendString类型。
