...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `cannkit-vector-calculation-abs`  |  **DocID**: `cd1300e8f88e4e9f83ef40548c418930`  |  **NodeID**: `000201775795449801122168f1d052e0`
...
本样例中只展示Compute流程中的部分代码。本样例的srcLocal和dstLocal均为half类型，占16位bit。
 ...
 AscendC::Abs(dstLocal, srcLocal, 512); 结果示例如下。
