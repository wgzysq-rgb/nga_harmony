...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `cannkit-model-zoo`  |  **DocID**: `34c16c7dc275499aa33e87df3106facf`  |  **NodeID**: `000201775795449800312b55f380c002`
...
| IR算子  | 性能使用指导  | 推荐使用指数  
 ...
 | ConvTranspose  - 当Cin和Cout都是16的倍数时性能最优。
