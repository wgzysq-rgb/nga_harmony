...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `natural-language-getentity`  |  **DocID**: `99cae7b2417f4b02b0283833e1f1471e`  |  **NodeID**: `00020177579544980028068da9efa366`
...
# 实体抽取
     ...
     该能力当前不支持模拟器。
       ...
       import { textProcessing, EntityType } from '@kit.NaturalLanguageKit';             配置输入文本框。
...
```
             配置按钮，调用实体抽取[textProcessing.getEntity](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api#textprocessinggetentity)接口。
