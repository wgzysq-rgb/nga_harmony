...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `core-vision-face-detector`  |  **DocID**: `10ba8edea66345c6a63a64f96ab8ac3e`  |  **NodeID**: `000201775795449800278d67c703b12b`
...
```
             实例化[VisionInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-face-detector-api#visioninfo)对象，并传入待检测图片的[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)，实现人脸检测功能。
