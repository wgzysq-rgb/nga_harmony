...
> **分区**: 指南  |  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  |  **Slug**: `core-vision-skeleton-detection`  |  **DocID**: `dc0249ad28474d7685240213b1d91a6b`  |  **NodeID**: `000201775795449800301d5badd8f17d`
...
```
  实例化Request对象，并传入待检测图片的[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)，实现骨骼点检测功能。
