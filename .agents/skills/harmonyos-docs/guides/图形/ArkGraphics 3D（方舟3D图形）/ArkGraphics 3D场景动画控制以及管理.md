...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkgraphics3d-animation`  |  **DocID**: `0b03046694de42d488d9388ab963735f`  |  **NodeID**: `0002017757954919759070a7d63fcc77`
...
导入相关模块。
  ...
  在页面脚本中导入ArkGraphics 3D提供的核心类型，用于创建和控制3D场景、相机以及动画资源。
    ...
    import { Animation, Camera, Scene, SceneResourceFactory } from '@kit.ArkGraphics3D';  加载场景资源。
