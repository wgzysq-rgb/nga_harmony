...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arkgraphics3d-shader-resource`  |  **DocID**: `a38e0f781d5c478e8a37ed257e376fcb`  |  **NodeID**: `0002017757954919759672c78ab4986a`
...
- 说明：指定渲染材质的元数据。MaterialMetadata对象包含材质名称name及��定义属性customProperties。
