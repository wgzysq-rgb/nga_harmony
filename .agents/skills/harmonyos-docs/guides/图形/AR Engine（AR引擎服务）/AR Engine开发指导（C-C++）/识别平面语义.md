...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `arengine-c-get-semantics`  |  **DocID**: `042fb83c5b514f2f9338e2505b794fd5`  |  **NodeID**: `000201775795491975969dd9258d1a43`
...
```
     ...
     AREngine_ARSemanticPlaneLabel label = ARENGINE_PLANE_UNKNOWN;     平面语义标签定义为枚举类型，包括12种枚举值（1种未知类型+11种平面类型）。
