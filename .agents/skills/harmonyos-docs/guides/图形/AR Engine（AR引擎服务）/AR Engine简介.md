...
> **分区**: Guides  |  **Slug**: `arengine-overview`  |  **DocID**: `fc61da2298254b9ebe97f3f06b0813af`  |  **NodeID**: `000201776839647035791491d523c147`
...
# AR Engine简介
     ...
     **图14** AGP世界坐标系示意图
             ...
             在调用AR Engine能力前，需要先通过[Syscap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/syscap#判断-api-是否可以使用)查询您的目标设备是否支持SystemCapability.AREngine.Core系统能力。
