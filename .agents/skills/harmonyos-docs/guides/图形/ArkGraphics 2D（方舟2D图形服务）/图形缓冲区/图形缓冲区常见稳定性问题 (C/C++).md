...
> **分区**: Guides  |  **Slug**: `native-common-mistakes`  |  **DocID**: `1c10de2375f44c46929c044eb25a1595`  |  **NodeID**: `000201776839666534246ee671acdcbc`
...
典型卡死日志如下：
 ...
 /system/lib64/chipset-sdk-sp/libsurface.z.so(RequestBufferLocked()) 可能原因如下：
