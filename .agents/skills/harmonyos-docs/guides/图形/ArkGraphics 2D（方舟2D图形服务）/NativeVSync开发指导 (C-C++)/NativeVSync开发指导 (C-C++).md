...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `native-vsync-guidelines`  |  **DocID**: `d344bdfb06a64ed7aac6acde90c53bfe`  |  **NodeID**: `0002017757954919759236414fb330cb`
...
# NativeVSync开发指导 (C/C++)
     ...
     NativeVSync模块用于获取系统VSync信号，提供OH_NativeVSync实例的创建、销毁及设置VSync回调函数的功能。VSync信号触发时，将调用已设置的回调函数。
          ...
          详细的接口说明请参考[native_vsync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-nativevsync)。
