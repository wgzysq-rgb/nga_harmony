...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `canvas-get-result-draw-arkts`  |  **DocID**: `87fa19f6939243279220b8a0d5d5ffe5`  |  **NodeID**: `000201775795491975990051dee442f3`
...
```
             ...
             在MyNodeController的aboutToAppear()函数中创建PixelMap。

             重写自定义RenderNode的[draw()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-rendernode#draw)函数，在其中获取离屏Canvas进行绘制：
