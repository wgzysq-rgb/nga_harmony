...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `pixelmap-drawing-c`  |  **DocID**: `92e877386647419a90d37076aac4a991`  |  **NodeID**: `000201775795491975049843ca723f31`
...
```
      ...
      #include <multimedia/image_framework/image/pixelmap_native.h>           创建OH_PixelmapNative像素图对象。
...
```
      ...
      OH_Drawing_PixelMap *pixelMap = OH_Drawing_PixelMapGetFromOhPixelMapNative(pixelMapNative);           绘制PixelMap。
