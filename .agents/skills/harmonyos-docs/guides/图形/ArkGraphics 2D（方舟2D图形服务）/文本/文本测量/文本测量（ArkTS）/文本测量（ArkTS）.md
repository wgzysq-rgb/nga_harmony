...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `text-measure-arkts`  |  **DocID**: `0758cfd4bf4a446f84f5f085aba05be7`  |  **NodeID**: `0002017757954919759950f5a1290fbd`
...
# 文本测量（ArkTS）
     ...
     文本测量中常用接口如下表所示，详细接口说明参考[@ohos.graphics.text (文本模块)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#paragraph)。
       ...
       import { text } from '@kit.ArkGraphics2D';             创建段落样式，并使用构造段落生成器ParagraphBuilder生成段落实例。
