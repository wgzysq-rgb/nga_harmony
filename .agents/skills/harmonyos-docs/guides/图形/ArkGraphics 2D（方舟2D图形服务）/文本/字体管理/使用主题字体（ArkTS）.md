...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `theme-font-arkts`  |  **DocID**: `f4d799238aae423ab4372b676b7ced3c`  |  **NodeID**: `0002017757954919759971ad1f2101b4`
...
# 使用主题字体（ArkTS）
     ...
     **图1** 主题字体的切换和使用
     ...
     注册使用主题字体的常用接口如下表所示，详细接口说明请见[@ohos.graphics.text (文本模块)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text)。
       ...
       import { text } from '@kit.ArkGraphics2D';             使用getGlobalInstance()接口获取全局字体集对象，系统框架在注册主题字体过程中仅会将主题字体信息传入全局字体集对象中。
