...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `system-font-arkts`  |  **DocID**: `1aa6bc0e49c945139ab254e4be980e8f`  |  **NodeID**: `00020177579549197502111a07ba88d4`
...
# 系统字体的信息获取和使用（ArkTS）
     ...
     **使用系统字体**的情况通常是在应用未注册自定义字体，或在没有显式指定文本样式时，系统会使用默认的系统字体。另外，系统字体有多种，开发者可以先获取系统字体的配置信息，并根据信息中的字体家族名来进行系统字体的切换和使用。
     ...
     以下是系统字体相关的常用接口和结构体，ArkTS侧对外接口由ArkUI提供，详细接口说明请见[@ohos.font](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-font)。
       ...
       import { font } from '@kit.ArkUI'             获取系统字体信息。

       let fontConfig = font.getUIFontConfig();             在获取系统字体信息之后通过日志打印字体信息。
...
```
     ...
     如果不指定使用任何字体时，会使用系统默认字体“HarmonyOS Sans”显示文本。
       ...
       import { text } from '@kit.ArkGraphics2D';             创建textStyle1，指定fontFamilies为“HarmonyOS Sans SC”，默认中文字体为“HarmonyOS Sans SC”。
