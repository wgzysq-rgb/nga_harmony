...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `custom-font-arkts`  |  **DocID**: `b40714157fa24724b4b947ad1e4335b2`  |  **NodeID**: `00020177579549197500891876c64bef`
...
```
             创建段落样式，并使用字体管理器实例构造段落生成器ParagraphBuilder实例。
