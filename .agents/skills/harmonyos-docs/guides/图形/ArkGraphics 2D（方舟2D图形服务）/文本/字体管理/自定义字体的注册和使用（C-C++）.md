...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `custom-font-c`  |  **DocID**: `4165457c65964262abc42131759db6e4`  |  **NodeID**: `000201775795491975036a56a9901917`
...
```
             创建字体管理器，建议优先使用OH_Drawing_CreateSharedFontCollection()创建可共享的字体集对象。
                      ...
                      OH_Drawing_FontCollection *fontCollection = OH_Drawing_CreateSharedFontCollection();             设置自定义字体的字体家族名和字体文件所在的沙箱路径。
