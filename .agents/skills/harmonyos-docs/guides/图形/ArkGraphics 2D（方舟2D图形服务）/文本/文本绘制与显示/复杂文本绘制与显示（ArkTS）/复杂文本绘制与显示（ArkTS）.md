...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `complex-text-arkts`  |  **DocID**: `a7c53f2527af4f9892a9efcc3c6b831f`  |  **NodeID**: `000201775795491975009631ead82fa5`
...
```
                 ...
                 | 文本对齐方式为text.TextAlign.LEFT，最大行数为10，断词策略为text.WordBreak.BREAK_ALL。          |          
                           文本对齐方式为text.TextAlign.LEFT，最大行数为10，断词策略为text.WordBreak.BREAK_HYPHEN，
