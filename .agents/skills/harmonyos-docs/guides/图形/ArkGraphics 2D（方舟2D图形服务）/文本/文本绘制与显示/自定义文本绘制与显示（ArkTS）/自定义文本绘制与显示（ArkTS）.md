...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `text-custom-arkts`  |  **DocID**: `9d2700e722fa49369cac0c994f9e3327`  |  **NodeID**: `000201775795491975020899b125dc00`
...
```
       ...
       paragraphBuilder.addText('Hello World');             创建行对象。获取行中所有文字的塑形结果。
