...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `simple-text-c`  |  **DocID**: `d884252fc167414bb7d8ba9db4759085`  |  **NodeID**: `0002017757954919750324392f58efbe`
...
创建Canvas画布对象，画布Canvas对象创建方法具体可见[画布的获取与绘制结果的显示](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/canvas-get-result-draw-c)。

  初始化段落样式，设置文本对齐方式为居中对齐。
