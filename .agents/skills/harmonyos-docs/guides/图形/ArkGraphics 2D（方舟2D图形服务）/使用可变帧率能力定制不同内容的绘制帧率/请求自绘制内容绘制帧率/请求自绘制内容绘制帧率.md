...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `displaysync-xcomponent`  |  **DocID**: `c83c97a46b864e578bcc551b743a99b4`  |  **NodeID**: `000201775795491975973176f4dc97c9`
...
# 请求自绘制内容绘制帧率
       ...
       target_link_libraries(entry PUBLIC libace_napi.z.so libnative_drawing.so libnative_window.so libace_ndk.z.so)       导入依赖的相关头文件。
...
```
       #include <native_drawing/drawing_text_typography.h>             定义ArkTS接口文件XComponentContext.ts，用来对接Native层。
