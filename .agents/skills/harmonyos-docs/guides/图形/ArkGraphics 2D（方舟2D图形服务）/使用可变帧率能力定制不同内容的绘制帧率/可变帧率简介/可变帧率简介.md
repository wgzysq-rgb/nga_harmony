...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `displaysync-overview`  |  **DocID**: `f58effba4b924542a5952db8bb78ab44`  |  **NodeID**: `00020177579549197593867e980ea37e`
...
- 通过NativeVsync在Native侧申请独立的绘制帧率，用于非UI线程的绘制，具体可见[NativeDisplaySoloist开发指导 (C/C++)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/displaysoloist-native-guidelines)。
