...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `effectkit-filter-c`  |  **DocID**: `63b07c1703d341cab174e1e3b98b28e6`  |  **NodeID**: `000201775795491975930f20537d2122`
...
```
             基于上文生成的OH_PixelmapNative像素图对象，使用OH_Filter_CreateEffect()接口初始化OH_Filter对象。
...
```
         ...
         EffectErrorCode errCodeEffect = OH_Filter_GrayScale(filter);                 可使用OH_Filter_Invert()接口在滤镜中添加反色效果。
...
```
       ...
       EffectErrorCode errCodeRelease = OH_Filter_Release(filter);       绘制效果如下：
