...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `spatial-recon-introduction`  |  **DocID**: `86b4ac5b31cb457a873861bc12623dc5`  |  **NodeID**: `000201775795491975885a6b4cfdaad6`
...
Spatial Recon Kit提供了和空间重建有关的能力，帮助开发者实现三维重建（如3DGS）相关的功能。具体如下：

 
3DGS模型加载：加载不同格式的三维模型（MP4、PLY、GLB）。
