...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-apply-generated-icon`  |  **DocID**: `5626e84042eb429bad886a983e909a6b`  |  **NodeID**: `0002017757900665339808c715cbf27e`
...
在工程中选中模块或文件，右键单击**New > Image Asset**，进入图标配置页面。
...
点击**Next**，确认图标的存储路径和相应的尺寸信息，图标将默认存放在**resources **目录下。点击**Finish**完成图标生成。
...
如需配置桌面或设置页面出现的应用图标，可将module.json5文件中icon字段修改为新生成的图标名称；如需修改启动页的icon图标，可将module.json5文件中startWindowIcon字段修改为新生成的图标名称。
