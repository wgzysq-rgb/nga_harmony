...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `agc-harmonyos-clouddev-faq`  |  **DocID**: `566554a00c0a4a6cbc1af72eb0acee42`  |  **NodeID**: `000201775790066533009168e6e266b7`
...
- 参考[AuthProvider](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#authprovider)获取用户凭据
