...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-har`  |  **DocID**: `36d2a08cbc094b6b850c88665d7881b1`  |  **NodeID**: `000201775790066533993adb520cfab3`
...
# 开发静态共享包
    ...
    从DevEco Studio 6.0.1 Beta1开始，创建HAR模块时支持选择C++版本。
      ...
      - 鼠标移到工程目录顶部，单击右键，选择**New > Module**，在工程中添加模块。
      在**Choose Your Ability Template**界面中，选择**Static Library**，并单击**Next**。       

       

       

      在**Configure New Module**界面中，设置新添加的模块信息，设置完成后，单击**Finish**完成创建。从DevEco Studio 6.0.1 Beta1开始，支持选择C++版本。       
