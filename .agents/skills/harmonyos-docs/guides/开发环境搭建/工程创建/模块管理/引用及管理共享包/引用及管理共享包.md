...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-har-import`  |  **DocID**: `b5d97db4bb5b4d548c50b18541fe0b58`  |  **NodeID**: `00020177579006653398468d53c8ddb4`
...
```
      ...
      - 在菜单栏点击**Tools > ****OHPM Index**，进入OpenHarmony开源中心仓。
      在左侧搜索框可查询三方包名称，或点击目录树，根据分类查看不同分类下推荐的依赖包信息。选定所需要安装的三方包，点击右上角蓝色按钮**Install**进行安装。       
      ...
      点击页面左上角图标，展示当前已安装的三方包信息。若当前三方包非最新版本，可以点击右上角**Update**按钮，更新至最新版本；点击**Delete**按钮，可以删除当前已安装的三方包。       
