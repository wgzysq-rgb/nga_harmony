...
> **分区**: 指南  |  |  **API级别**: API 23 (HarmonyOS 6.0)  |  **Slug**: `ide-insight-intent`  |  **DocID**: `f5b970ddf3be4bce828d846f66471847`  |  **NodeID**: `00020177579006653399164a97db0877`
...
选中模块或模块下的文件，右键单击**New > Insight Intent**，进入意图框架配置界面。
...
点击**Finish**，完成意图框架创建。此时将在**entry > src > main > ets > insightintents**目录下生成入口代码文件；在**entry > src > main > resource > base > profile**中，生成**i****nsight_intent.json**文件，可在该文件查看当前意图框架配置的相关信息。
