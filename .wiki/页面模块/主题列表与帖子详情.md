...
| `AiChatPage` | `pages/ai/AiChatPage.ets` | 通用 AI 对话页，统一替代原 PostSummaryPage（帖子 AI 摘要）和 AgentAnalysisPage（用户分析），支持流式输出与多轮连续对话 |
| `AiSettingsPanel` | `pages/ai/AiSettingsPanel.ets` | AI 配置管理面板（多服务商支持、预设选择、连接测试、模型列表获取） |
